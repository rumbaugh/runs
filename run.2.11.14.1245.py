...
if lens != '1938': 
    sampler = emcee.EnsembleSampler(nwalkers,ndim,delaylnprob,args=[Bflux[g],Aflux[g],Berr[g],Aerr[g],ltime[g],mu_init,mintime,maxtime,True,True,True,'boxcar'])
else:
    sampler = emcee.EnsembleSampler(nwalkers,ndim,delaylnprob,args=[Bflux,Cflux,Berr,Cerr,ltime,mu_init,mintime,maxtime,True,True,True,'boxcar'])
