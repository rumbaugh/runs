...
BC_delay_d2,BCmud2,BCdispd2 = calc_disp_delay(Cflux,Bflux,ltime,ltime,Cerr,Berr,maxtimestep,timestep,minmu,maxmu,mustep,'D_2b',output=2,simplemuerr=True)
t2 = time.time()
print "66%% Done. Elapsed Time: %f seconds"%(t2-st1)
BD_delay_d2,BDmud2,BDdispd2 = calc_disp_delay(Dflux,Bflux,ltime,ltime,Derr,Berr,maxtimestep,timestep,minmu,maxmu,mustep,'D_2b',output=2,simplemuerr=True)
if not justone:
