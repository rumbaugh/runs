...
for SN in S82_SNfields:
    FILE=open('/home/rumbaugh/runs/run.7.7.17.1455_%s.py'%SN,'w')
    ...
    FILE.write('\n')
    FILE.write("np.savetxt('/home/rumbaugh/Eric_LC_all_%s.csv'%SN,outcr,fmt='%i,%f,%f,%f,%f,%f,%4s,%i')")
    FILE.close()
