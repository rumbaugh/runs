...
blue_exp_nums = np.array([2028,2029,2030,2021,2032,2036,2037,2038,2043,2044,2045,2049,2050,2051,2052,2053])
...
FILESci=np.open('%s/science_list_8.15.15.2010.txt'%defdir,'w')
FILESky=np.open('%s/sky_list_8.15.15.2010.txt'%defdir,'w')
FILEout=np.open('%s/skysub_output_list_8.15.15.2010.txt'%defdir,'w')
