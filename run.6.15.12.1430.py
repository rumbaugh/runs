...
pylab.savefig('/home/rumbaugh/LxT.plot.bol.6.15.12.png')
pylab.close('all')
...
pylab.yticks([1,5],['1','5'])
pylab.savefig('/home/rumbaugh/sigLx.plot.6.15.12.png')
pylab.close('all')
print '\nsig-Lx\n'
...
pylab.xticks([1,5],['1','5'])
pylab.savefig('/home/rumbaugh/sigT.plot_test.6.15.12.png')
pylab.close('all')
