...
for i in range(0,len(names)):
    ...
    print '%12s:\n1-par: A: %f %f +%f \n2-par, fix. bkg: A: %f %f +%f r0: %f %f +%f\n2-par, fix. cnts: A: %f %f +%f r0: %f %f +%f\n2-par, fc2: A: %f %f +%f r0: %f %f +%f\nchisq 1par: %f 2par, fix. bkg: %f 2par, fix. cnts: %f 2par, fc2: %f\n step: %4.1f r0: %f\n'%(names[i],Afit1par,Aerr1parl,Aerr1paru,Afit2par,Aerr2parl,Aerr2paru,r0fit,r0fiterrl,r0fiterru,Afit3par,Aerr3parl,Aerr3paru,r0fit2,r0fit2errl,r0fit2erru,Afit4par,Aerr4parl,Aerr4paru,r0fit3,r0fit3errl,r0fit3erru,chisq1par,chisq2par,chisq3par,chisq4par,ann_step,r0)
    ...
    savefig('/home/rumbaugh/fitted.DE_counts_profile.%s.10.16.12.png'%names[i])
    close()
FILEfit.close()
