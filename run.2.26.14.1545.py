...
progress_doc = '/home/rumbaugh/sim_ltcurve_testing/progress_run.2.26.14.1545.dat'

FILE = open('/home/rumbaugh/sim_ltcurve_testing/results/VLA_MCMC_interp_nocovmat_%s.dat'%date,'w')
FILE.write('#pair tau tau_lowbnd tau_upbnd ### maxseasonfrac = %4.2f\n'%maxseasonfrac)
FILE.close()
FILE = open('/home/rumbaugh/sim_ltcurve_testing/results/VLA_MCMC_interp_nocovmat_noNeff_%s.dat'%date,'w')
FILE.write('#pair tau tau_lowbnd tau_upbnd ### maxseasonfrac = %4.2f\n'%maxseasonfrac)
FILE.close()
FILE = open('/home/rumbaugh/sim_ltcurve_testing/results/VLA_MCMC_interp_wcovmat_Neff_%s.dat'%date,'w')
FILE.write('#pair tau tau_lowbnd tau_upbnd ### maxseasonfrac = %4.2f\n'%maxseasonfrac)
FILE.close()
