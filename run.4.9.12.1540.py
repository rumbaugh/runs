...
FILE4 = open('/home/rumbaugh/veldisp.results_wo_rounding.4.9.12.dat','w')
for i in range(0,len(names)):
    ...
    gRGP2 = gRGP2[0]
    FILEz = open('/home/rumbaugh/rostat/rin%s.4.9.12.dat'%(names[i]),'w')
    ...
    FILEz = open('/home/rumbaugh/rostat/redshifts.%s.rostat_input.4.9.12.dat'%(names[i]),'w')
