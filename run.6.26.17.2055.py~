...
FILEall=open('/home/rumbaugh/Chandra/CMD_info_all.1.29.17.dat','w')
FILEall.write('# Mag Color RA Dec Redshift RSO Field\n')
for field in targets[np.argsort(zlist)]:
    ...
    for n in range(0,len(i)): FILEall.write('%f %f %f %f %f %f %s\n'%(i[n],r[n]-i[n],crs['ra'][gCMD[n]],crs['dec'][gCMD[n]],redshift[n],rso_all[n],field))
