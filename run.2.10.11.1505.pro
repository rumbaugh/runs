...
YFL = alog10(yflum[g])+42
g = where((oflum gt 0) and (oIC gt 0.5))
OFL = alog10(oflum[g])+42
...
YSL = alog10(yslum[g])+42
oplot,alog10(yslum[g])+42,yHR[g],PSYM=4,THICK=2,color=250
g = where((oslum gt 0) and (oIC gt 0.5))
OSL = alog10(oslum[g])+42
...
YHL = alog10(yhlum[g])+42
oplot,alog10(yhlum[g])+42,yHR[g],PSYM=4,THICK=2,color=250
g = where((ohlum gt 0) and (oIC gt 0.5))
OHL = alog10(ohlum[g])+42
