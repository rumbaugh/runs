...
plt.hist(crs[drop>1].flatten(),range=(0.001,0.02),bins=20,lw=2,color='r',edgecolor='r',facecolor='None',normed=True)
plt.xlim(0,0.02)
plt.xlabel('Spread')
...
plt.hist(crs[drop>1].flatten(),range=(0.001,0.02),bins=20,lw=2,color='r',edgecolor='r',facecolor='None')
plt.xlim(0.001,0.02)
plt.xlabel('Spread')
plt.ylabel('Normalized Number of Objects')
