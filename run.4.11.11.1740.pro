...
device,file="/home/rumbaugh/paperstuff/RSoffset.hist.RSwid.4.11.11.ps",/color
...
HISTOPLOT,o_RSO,BINSIZE=0.25,MININPUT=-3.5,MAXINPUT=1,xstyle=1,ystyle=1,/LINE_FILL,polycolor='Indian Red',spacing=0.2,orientation=45,THICK=1.5,/oplot
