...
set_plot,'PS'
loadct,'13'
device,file="/home/rumbaugh/XrayLums.6.6.11.ps",/color
totalslum = []
totalhlum = []
yslum = []
yhlum = []
...
;legend,['Cl1604,Cl0023','Cl1324,NEP5281,NEP200'],color=['255','70']
Histoplot,yflum,BINSIZE=0.25,MININPUT=41,MAXINPUT=45,TITLE="Comparison - Full Band",datacolorname='Navy Blue',/LINE_FILL,THICK=4,POLYCOLOR='Navy Blue',ORIENTATION=45,spacing=0.25,LINESTYLE=2,/oplot
Histoplot,oflum,BINSIZE=0.25,MININPUT=41,MAXINPUT=45,TITLE="Comparison - Full Band",THICK=8,datacolorname='Red',/oplot
