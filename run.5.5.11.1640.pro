...
loadct,13
set_plot,'PS'
device,file="/home/rumbaugh/paperstuff/logNlogSplot.overdensities.soft.5.5.11.ps",/color
...
plot,src_flux_sort,overdenseC,/xlog,xrange=[6E-16,2E-14],/xsty,/ysty,YRANGE=[-1,1],XTITLE="S (erg s!E-1!N cm!E-2!N)",YTITLE="Fractional Overdensity",TITLE="Cumulative Source Count Residuals - Soft Band",THICK=2,XTHICK=4,YTHICK=4,CHARSIZE=1.3,CHARTHICK=4
oplot,pzX,plotzero,LINESTYLE=2,THICK=4
...
oplot,limitingX,limitingY,LINESTYLE=1,THICK=3
