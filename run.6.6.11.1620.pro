...
set_plot,'PS'
loadct,'13'
device,file="/home/rumbaugh/XrayLums_RS.6.6.11.ps",/color
totalslum = []
totalhlum = []
yslum = []
yhlum = []
...
;legend,['Cl1604,Cl0023','Cl1324,NEP5281,NEP200'],color=['255','70']
Histoplot,nrsflum,BINSIZE=0.25,MININPUT=41,MAXINPUT=45,TITLE="Comparison - Full Band",/LINE_FILL,datacolorname='Navy Blue',POLYCOLOR='Navy Blue',ORIENTATION=45,spacing=0.25,THICK=4,/oplot
Histoplot,rsflum,BINSIZE=0.25,MININPUT=41,MAXINPUT=45,TITLE="Comparison - Full Band",THICK=8,datacolorname='Red',/oplot
legend,['On RS','Not on RS'],color=['255','50'],PSYM=[6,6],SYMSIZE=[0.8,0.8],CHARTHICK=4,CHARSIZE=1,THICK=18,/right
end
