...
FILEstat = open("/home/rumbaugh/status.run.5.9.12.2135.txt",'w')
FILEstat.close()
FILE1 = open("/home/rumbaugh/baselines.test.5.9.12.dat",'w')
for i in range(5,6):
    baseline = np.zeros(2)
    for j in range(0,2):
...
FILE1.close()
FILE2 = open("/home/rumbaugh/baselines.5.9.12.dat",'w')
for i in range(5,7):
