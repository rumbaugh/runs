...
for mask in ['miki04.f','miki04_B','miki04_A','miki03_B','miki03_A','miki21D.','miki16B.','bc3.file','bc3B.fil','miki21C.']:
    outdir = slit_name_dict[mask]['redux_dir']
    for side in ['top','bottom']:
        for color in ['blue','red']:
            for slit in slit_name_dict[mask][color][side]:
                if not ((mask == 'miki21.f') & ((slit in ['28709','29598','30933','30684','30884']) | (side == 'top'))):
                    if color == 'blue':
