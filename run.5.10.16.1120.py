import numpy as np
import pyfits as py
execfile('/home/rumbaugh/git/ORELSE/python/Catalog Matching/ConcaveHull.py')
...
for field in targets:
    ...
    crxy=np.loadtxt('/home/rumbaugh/Chandra/ImperialPipeline/ORELSE/%s/proc/%s/%s_XY_speccoords.dat'%(field,field,field))
    sHull,sEdges=ConcaveHull(crxy,alpha)
    ...
    np.savetxt('/home/rumbaugh/Chandra/ImperialPipeline/ORELSE/%s/proc/%s/%s_flatSlim.5.3.16.dat'%(field,field,field),fluxes,fmt='%E %E %E')
