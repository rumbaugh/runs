...
MatchCat(catin,refcat,outcat,outreg,raaim,decaim,ref_load_dict=refdict,minsrch=0.1,radius_opt_cen=3600*5,useConcaveHull=True,reps=10000,repsSecondPass=100000)
