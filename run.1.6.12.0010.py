...
for i in range(0,len(A1err)):
    A1nerr[i],B1nerr[i],C1nerr[i],C2nerr[i] = A1nflux[i]*m.sqrt((A1err[i]/A1flux[i])**2+(A1avgerr/np.average(A1flux))**2),B1nflux[i]*m.sqrt((B1err[i]/B1flux[i])**2+(B1avgerr/np.average(B1flux))**2),C1nflux[i]*m.sqrt((C1err[i]/C1flux[i])**2+(C1avgerr/np.average(C1flux))**2),C2nflux[i]*m.sqrt((C2err[i]/C2flux[i])**2+(C2avgerr/np.average(C2flux))**2)
