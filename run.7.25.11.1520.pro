...
loadct,13
set_plot,'PS'
device,file="/home/rumbaugh/paperstuff/logNlogSplot.overdensities.soft.7.25.11.ps",/color
usersymdash,thick=4
...
ploterror, src_flux_sort, N,Nerr, /xlog, /ylog, psym=4,xrange=[6E-16,3E-14],yrange=[30,2000],XTITLE="S (erg s!E-1!N cm!E-2!N)",TITLE="Cl0023 - Soft Band", YTITLE = "N(>S) (deg!E-2!N)", /ysty,/xsty,SYMSIZE=0.7,THICK=2,XTHICK=2,YTHICK=2,CHARSIZE=1.6,CHARTHICK=2
...
plot,src_flux_sort,overdense1,/xlog,xrange=[6E-16,2E-14],/xsty,/ysty,YRANGE=[-1.5,4.1],XTITLE="S (erg s!E-1!N cm!E-2!N)",YTITLE="Overdensity (sigma)",TITLE="Cl0023 - Soft Band",THICK=2,XTHICK=2,YTHICK=2,CHARSIZE=1.6,CHARTHICK=2
...
ploterror, src_flux_sort, N,Nerr, /xlog, /ylog, psym=4,xrange=[6E-16,3E-14],yrange=[30,2000],XTITLE="S (erg s!E-1!N cm!E-2!N)",TITLE="Cl1324 - Soft Band", YTITLE = "N(>S) (deg!E-2!N)", /ysty,/xsty,SYMSIZE=0.7,THICK=2,XTHICK=2,YTHICK=2,CHARSIZE=1.6,CHARTHICK=2
oplot,CDFflux,CDFN,LINESTYLE=1
oplot, COSMOS_S2, COSMOS_N, PSYM=0,LINESTYLE=5
sfs2 = src_flux_sort
plot,src_flux_sort,overdense2,/xlog,xrange=[6E-16,2E-14],/xsty,/ysty,YRANGE=[-1.5,4.1],XTITLE="S (erg s!E-1!N cm!E-2!N)",YTITLE="Overdensity (sigma)",TITLE="Cl1324 - Soft Band",THICK=2,XTHICK=2,YTHICK=2,CHARSIZE=1.6,CHARTHICK=2
oplot,pzX,plotzero,LINESTYLE=1
...
r95aN = interpol(perc95_radius, arcsec_offset, thetaN3)
...
r95aS = interpol(perc95_radius, arcsec_offset, thetaS3)
...
ploterror, src_flux_sort, N,Nerr, /xlog, /ylog, psym=4,xrange=[6E-16,3E-14],yrange=[30,2000],XTITLE="S (erg s!E-1!N cm!E-2!N)",TITLE="Cl1604 - Soft Band", YTITLE = "N(>S) (deg!E-2!N)", /ysty,/xsty,SYMSIZE=0.7,THICK=2,XTHICK=2,YTHICK=2,CHARSIZE=1.6,CHARTHICK=2
oplot,CDFflux,CDFN,LINESTYLE=1
oplot, COSMOS_S2, COSMOS_N, PSYM=0,LINESTYLE=5
sfs3 = src_flux_sort
plot,src_flux_sort,overdense3,/xlog,xrange=[6E-16,2E-14],/xsty,/ysty,YRANGE=[-1.5,4.1],XTITLE="S (erg s!E-1!N cm!E-2!N)",YTITLE="Overdensity (sigma)",TITLE="Cl1604 - Soft Band",THICK=2,XTHICK=2,YTHICK=2,CHARSIZE=1.6,CHARTHICK=2
oplot,pzX,plotzero,LINESTYLE=1
...
ploterror, src_flux_sort, N,Nerr, /xlog, /ylog, psym=4,xrange=[6E-16,3E-14],yrange=[30,2000],XTITLE="S (erg s!E-1!N cm!E-2!N)",TITLE="NEP5281 - Soft Band", YTITLE = "N(>S) (deg!E-2!N)", /ysty,/xsty,SYMSIZE=0.7,THICK=2,XTHICK=2,YTHICK=2,CHARSIZE=1.6,CHARTHICK=2
oplot,CDFflux,CDFN,LINESTYLE=1
oplot, COSMOS_S2, COSMOS_N, PSYM=0,LINESTYLE=5
sfs4 = src_flux_sort
plot,src_flux_sort,overdense4,/xlog,xrange=[6E-16,2E-14],/xsty,/ysty,YRANGE=[-1.5,4.1],XTITLE="S (erg s!E-1!N cm!E-2!N)",YTITLE="Overdensity (sigma)",TITLE="NEP5281 - Soft Band",THICK=2,XTHICK=2,YTHICK=2,CHARSIZE=1.6,CHARTHICK=2
oplot,pzX,plotzero,LINESTYLE=1
...
ploterror, src_flux_sort, N,Nerr, /xlog, /ylog, psym=4,xrange=[6E-16,3E-14],yrange=[30,2000],XTITLE="S (erg s!E-1!N cm!E-2!N)",TITLE="NEP200 - Soft Band", YTITLE = "N(>S) (deg!E-2!N)", /ysty,/xsty,SYMSIZE=0.7,THICK=2,XTHICK=2,YTHICK=2,CHARSIZE=1.6,CHARTHICK=2
oplot,CDFflux,CDFN,LINESTYLE=1
oplot, COSMOS_S2, COSMOS_N, PSYM=0,LINESTYLE=5
sfs5 = src_flux_sort
plot,src_flux_sort,overdense5,/xlog,xrange=[6E-16,2E-14],/xsty,/ysty,YRANGE=[-1.5,4.1],XTITLE="S (erg s!E-1!N cm!E-2!N)",YTITLE="Overdensity (sigma)",TITLE="NEP200 - Soft Band",THICK=2,XTHICK=2,YTHICK=2,CHARSIZE=1.6,CHARTHICK=2
oplot,pzX,plotzero,LINESTYLE=1
...
NerrUp = N+3*Nerr
NerrDown = N-3*Nerr
plot,[0-1],[0-1],/nodata, /xlog, /ylog, xrange=[6E-16,3E-14],yrange=[30,2000],XTITLE="S (erg s!E-1!N cm!E-2!N)", YTITLE = "N(>S) (deg!E-2!N)", /ysty,/xsty,XTHICK=2,YTHICK=2,CHARSIZE=1.6,CHARTHICK=2
...
sfsC = src_flux_sort
plot,src_flux_sort,overdenseC,/xlog,xrange=[6E-16,2E-14],/xsty,/ysty,YRANGE=[-1.5,6.5],XTITLE="S (erg s!E-1!N cm!E-2!N)",YTITLE="Overdensity (sigma)",TITLE="Composite - Soft Band",THICK=2,XTHICK=2,YTHICK=2,CHARSIZE=1.6,CHARTHICK=2
oplot,pzX,plotzero,LINESTYLE=1

plot,src_flux_sort,overdenseC,/xlog,xrange=[6E-16,2E-14],/xsty,/ysty,YRANGE=[-1,1],XTITLE="S (erg s!E-1!N cm!E-2!N)",YTITLE="Fractional Overdensity",TITLE="Cumulative Source Count Residuals - Soft Band",THICK=4,XTHICK=6,YTHICK=6,CHARSIZE=1.3,CHARTHICK=5
...
legend,['Composite','Cl0023','Cl1604','Cl1324','RXJ1757','RXJ5281'],PSYM=[8,7,4,2,6,5],color=[0,15,255,60,180,90],THICK=[4,4,4,4,4,4],SYMSIZE=[1.0,0.8,0.8,0.8,0.8,0.8],CHARSIZE=1.3,CHARTHICK=4,/bottom,box=0
