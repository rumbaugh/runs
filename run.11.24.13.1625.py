...
infile = '/mnt/data2/rumbaugh/TDC/tdc1sample_for_test/rung2/tdc1_rung2_double_pair502'
for tdcfile in ref_dict:
    infile = '/mnt/data2/rumbaugh/TDC/tdc1sample_for_test/rung2/%s.txt'%tdcfile
    outfile = '/mnt/data2/rumbaugh/TDC/tdc1sample_for_test/rung2/output/%s.BA.dat'%tdcfile
...
infile = '/mnt/data2/rumbaugh/TDC/tdc1sample_for_test/rung3/tdc1_rung3_double_pair502'
for tdcfile in ref_dict:
    infile = '/mnt/data2/rumbaugh/TDC/tdc1sample_for_test/rung3/%s.txt'%tdcfile
    outfile = '/mnt/data2/rumbaugh/TDC/tdc1sample_for_test/rung3/output/%s.BA.dat'%tdcfile
    mintime = ref_dict[tdcfile]['range'][0]
    maxtime = ref_dict[tdcfile]['range'][1]
    cr = np.loadtxt(infile)
    ltime,A,Aerr,B,Berr = cr[:,0],cr[:,1],cr[:,2],cr[:,3],cr[:,4]
...
infile = '/mnt/data2/rumbaugh/TDC/tdc1sample_for_test/rung4/tdc1_rung4_double_pair502'
for tdcfile in ref_dict:
    infile = '/mnt/data2/rumbaugh/TDC/tdc1sample_for_test/rung4/%s.txt'%tdcfile
    outfile = '/mnt/data2/rumbaugh/TDC/tdc1sample_for_test/rung4/output/%s.BA.dat'%tdcfile
    mintime = ref_dict[tdcfile]['range'][0]
    maxtime = ref_dict[tdcfile]['range'][1]
    cr = np.loadtxt(infile)
    ltime,A,Aerr,B,Berr = cr[:,0],cr[:,1],cr[:,2],cr[:,3],cr[:,4]
