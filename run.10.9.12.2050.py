...
FILE=open('/home/rumbaugh/scalingrelation.offsets_sigma.10.9.12.dat','w')
...
lums = copy_colvals(crl,'col2')/10.0
lumes = copy_colvals(crl,'col3')/10.0

crl = read_file('/home/rumbaugh/paperstuff/clus.lums.bol.10.19.12.dat')
lumbolt = copy_colvals(crl,'col1')
lumbol = lumbolt/cpercs
...
pylab.legend(['$L_x\propto\ T^{\ 2.64}$'],loc=2,frameon=False)
...
pylab.savefig('/home/rumbaugh/LxT.plot.bol.10.9.12.png')
pylab.close('all')
...
for i in range(0,len(Temps)): 
    if i == 0: 
        ...
        pylab.text(sigma[i]-149,lumbol[i]+0.11,names[i],color='black',fontsize=16,weight='extra bold')
    elif i == 6:
        pylab.text(sigma[i]-122,lumbol[i]+0.022,names[i],color='black',fontsize=16,weight='extra bold')
    elif i == 7:
        pylab.text(sigma[i]-83,lumbol[i]+0.09,names[i],color='black',fontsize=16,weight='extra bold')
    elif i == 8:
...
pylab.yticks([1,5],['1','5'])
pylab.savefig('/home/rumbaugh/sigLx.plot.10.9.12.png')
pylab.close('all')
print '\nsig-Lx\n'
...
pylab.xticks([1,5],['1','5'])
pylab.savefig('/home/rumbaugh/sigT.plot.10.9.12.png')
pylab.close('all')
