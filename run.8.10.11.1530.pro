...
plot,[0-1],[0-1],/nodata,XTITLE=['RS Offset (RS Widths)'],YTITLE=['Log Rest-fram 0.5-8.0 keV Luminosity'],XRANGE=[-7.5,2],YRANGE=[41.75,44.25],/xsty,/ysty,XTHICK=4,YTHICK=4,CHARSIZE=1.3,CHARTHICK=4
yt = [30,43.7]
xt = [-1,-1]
