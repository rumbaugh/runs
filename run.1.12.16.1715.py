...
targets=np.array(["rcs0224","cl0849","rxj0910","rxj1221","cl1350","rxj1757","cl1604","cl0023","cl1324","rxj1821","cl1137","rxj1053","rxj1716","cl1324_north","cl1324_south"])
...
for target in targets:
    ...
    outfile='%s/%s_xray_phot.%s.dat'%(curdir,target,date)
    hdu=py.open(infile)
    data=hdu[1].data
