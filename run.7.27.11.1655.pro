...
plot, src_flux_sort, N, /xlog, /ylog,xrange=[3E-15,5E-14],yrange=[30,2000],XTITLE="S (erg s!E-1!N cm!E-2!N)", YTITLE = "N(>S) (deg!E-2!N)",TITLE="Cl0023 - Hard Band", /ysty,/xsty,THICK=1,XTHICK=2,YTHICK=2,CHARSIZE=1.6,CHARTHICK=2
;oplot,CDFflux,CDFN,LINESTYLE=1
kti = 0
kta[kti] = interpol(N,src_flux_sort,1e-14)
kti = kti + 1
...
;oplot,src_flux_sort,overdense1,/xlog,xrange=[3E-15,5E-14],/xsty,/ysty,YRANGE=[-3.5,3],XTITLE="S (erg s!E-1!N cm!E-2!N)",YTITLE="Overdensity (sigma)",TITLE="Cl0023 - Hard Band",THICK=2,XTHICK=2,YTHICK=2,CHARSIZE=1.6,CHARTHICK=2
;oplot,pzX,plotzero,LINESTYLE=1

;; Set counts to flux conversion

k2 = 0.5*(0.0000000000278290277327+0.000000000027821073278)
k22 = 0.5*(0.0000000000222057351496+0.0000000000221993880176)
kS2 = 0.0000000000278290277327
kN2 = 0.000000000027821073278
kS22 = 0.0000000000222057351496
kN22 = 0.0000000000221993880176
...
;kN3 = 0.0000000000278030236628
;kS3 = 0.0000000000278166819506
;kN32 = 0.0000000000221849856109
;kS32 = 0.0000000000221956802628
;k3 = 0.5*(kS3+kN3)
;k32 = 0.5*(kS32+kN32)
kN32 = k32
kN3 = k3
...
for i=1L, n_elements(sky_cov)-1 do begin  &$
    farr[i] = farr[i-1] + df  &$
    Nf = n_elements(where(flux_finiteN3 le farr[i])) + n_elements(where(flux_finiteS3 le farr[i]))  &$
...
;print,kta[kti]/275.0
kti = kti + 1
;for jjj=0,n_elements(N)-1 do ;print,src_flux_sort[jjj],N[jjj]
;oplot,CDFflux,CDFN,LINESTYLE=1
;oplot, COSMOS_S2, COSMOS_N, PSYM=0,LINESTYLE=5
...
oplot,src_flux_sort, N,THICK=3,color=60
;for jj=0,n_elements(N)-1 do print,src_flux_sort[jj],N[jj]
...
plot,src_flux_sort,overdenseC,/xlog,xrange=[3E-15,5E-14],YRANGE=[-1,1],XTITLE="S (erg s!E-1!N cm!E-2!N)",YTITLE="Fractional Overdensity",TITLE="Scaled Cumulative Source Count - Hard Band",THICK=4,XTHICK=6,YTHICK=6,CHARSIZE=1.3,CHARTHICK=5,xstyle=1,ystyle=1
...
oplot,sfs1,overdense1,THICK=1,color=15;255
oplot,sfs2,overdense2,THICK=1,color=60;190
oplot,sfs3,overdense3,THICK=1,color=255;15
oplot,sfs4,overdense4,THICK=1,color=90;60
oplot,sfs5,overdense5,THICK=1,color=180;125
