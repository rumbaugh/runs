...
sampler = emcee.EnsembleSampler(nwalkers,ndim,delaylnprob,args=[Bflux[g],Aflux[g],Berr[g],Aerr[g],ltime[g],mu_init,mintime,maxtime,False,True,False,'interpolate'])
