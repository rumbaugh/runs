...
for i in range(0,ntrials):
    ...
    ttmp,mtmp,BA_disp_mat[i] = calc_disp_delay(fluxB[g2]+rB[g2],fluxA[g]+rA[g],ltime,ltime,Berr[g2],Aerr[g],maxtimestep,timestep,minmu,maxmu,mustep,'D_4_2b',delta,output=2,verbose=False)
    FILE.write('%E %f\n'%(BA_disp_mat[i],mtmp))
    if i == 0: 
        t0 = time.time()
