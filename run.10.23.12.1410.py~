...
crf = read_file("/home/rumbaugh/SBfits.10.19.12.dat")
NC = copy_colvals(crf,'col12')
NCerr = copy_colvals(crf,'col13')
r500cnts = copy_colvals(crf,'col14')
r500cntserr = copy_colvals(crf,'col15')
TC = copy_colvals(crf,'col16')
TCerr = copy_colvals(crf,'col17')
...
#FILE.close()
FILE=open('/home/rumbaugh/paperstuff/clus.lums.soft.10.19.12.dat','w')
