...
loadct,13
set_plot,'PS'
device,file="/home/rumbaugh/paperstuff/logNlogSplot.overdensities.soft.7.29.11.ps",/color
...
sfsC = src_flux_sort
plot,src_flux_sort,overdenseC,/xlog,xrange=[6E-16,3E-14],/xsty,/ysty,YRANGE=[-1.5,6.5],XTITLE="S (erg s!E-1!N cm!E-2!N)",YTITLE="Overdensity (sigma)",TITLE="Composite - Soft Band",THICK=2,XTHICK=2,YTHICK=2,CHARSIZE=1.6,CHARTHICK=2
;oploy,pzX,plotzero,LINESTYLE=1
