...
plt.scatter(medr[cr['flag']==0]-medi[cr['flag']==0],medu[cr['flag']==0]-medg[cr['flag']==0],color='green',s=clqsize)
plt.scatter(medr[(cr['flag']==0)&(np.abs(cr['drop'])>1.5)]-medi[(cr['flag']==0)&(np.abs(cr['drop'])>1.5)],medu[(cr['flag']==0)&(np.abs(cr['drop'])>1.5)]-medg[(cr['flag']==0)&(np.abs(cr['drop'])>1.5)],color='magenta',s=clqsize+2)
plt.scatter(medr[(cr['flag']==0)&(np.abs(cr['drop'])>2)]-medi[(cr['flag']==0)&(np.abs(cr['drop'])>2)],medu[(cr['flag']==0)&(np.abs(cr['drop'])>2)]-medg[(cr['flag']==0)&(np.abs(cr['drop'])>2)],color='red',s=clqsize+4)
plt.xlabel('r-i')
plt.ylabel('u-g')
plt.xlim(-0.5,1.2)
plt.ylim(-0.5,6)
