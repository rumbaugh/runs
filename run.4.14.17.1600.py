...
cr=cr[gdr]
crd=np.loadtxt('/home/rumbaugh/var_database/Y3A1/DR7_full_magdiffs.4.1.17.tab',dtype={'names':('RA','DEC','z','mjdlo','glo','siglo','mjdhi','ghi','sighi'),'formats':('f8','f8','f8','f8','f8','f8','f8','f8','f8')})
try:
