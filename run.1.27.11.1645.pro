...
device,file="/home/rumbaugh/LFC/analysis/RSoffset.hist.r-i.1.27.11.ps",/color
...
HISTOPLOT,y_RSO,BINSIZE=0.125,MININPUT=-1.5,MAXINPUT=0.5,xstyle=1,ystyle=1,/LINE_FILL,polycolor='Indian Red',spacing=0.02,orientation=-45,locations=loc1,PROBABILITY=cum1
