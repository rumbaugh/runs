...
set_plot,'PS'
loadct,'13'
device,file="/home/rumbaugh/XrayLums.8.12.11.ps",/color
totalslum = []
totalhlum = []
yslum = []
yhlum = []
...
!p.position = square()
plot,[0,1],[0,1],/nodata,XTITLE='Log Rest-frame 0.5-8.0 keV Luminosity',YTITLE='Num. of AGN',XRANGE=[41.5,44.5],YRANGE=[0,5.2],XSTYLE=1,YSTYLE=1,XTHICK=4,YTHICK=4,CHARSIZE=1.3,CHARTHICK=4
...
legend,['Cl1324,RXJ1821,RXJ1757','Cl1604,Cl0023'],color=['255','50'],PSYM=[6,8],SYMSIZE=[1.5,1.5],CHARTHICK=4,CHARSIZE=1,THICK=[10,2],/top,/left
end
