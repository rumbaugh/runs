...
set_plot,'PS'
loadct,13
device,file='/home/rumbaugh/paperstuff/RS.hists.full.8.1.11.ps',XSIZE=30,YSIZE=10.5,SCALE_FACTOR=1.0,/color
...
for i=0,4 do begin &$
   ...
   plot,[0-1],[0-1],/nodata,title=names2[i],xtitle='Redshift',ytitle='Num. of Galaxies',xrange=[zlb[i],zub[i]],yrange=[0,ymax[i]],xstyle=1,ystyle=1,XTHICK=3,YTHICK=3,CHARSIZE=1.3,CHARTHICK=4 &$
