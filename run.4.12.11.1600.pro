...
device,file="/home/rumbaugh/paperstuff/RSoffset.hist.LFC.4.12.11.ps",/color
...
HISTOPLOT,o_RSO,BINSIZE=0.125,MININPUT=-1.375,MAXINPUT=0.5,xstyle=1,ystyle=1,/LINE_FILL,polycolor='Indian Red',spacing=0.2,orientation=45,THICK=1.5,datacolorname='Indian Red',/oplot
...
HISTOPLOT,y_RSO2,BINSIZE=0.125,MININPUT=-1.375,MAXINPUT=0.5,xstyle=1,ystyle=1,/LINE_FILL,polycolor='Charcoal',datacolorname='Charcoal',spacing=0.1,orientation=-45,THICK=2,/oplot
