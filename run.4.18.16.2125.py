...
plt.xlim(-9,1.05)
plt.ylim(42,44.5)
plt.savefig('/home/rumbaugh/Chandra/plots/RSoffset_vs_Lum.4.18.16.png')
...
plt.tick_params(which='major',length=8,width=2,labelsize=14)
plt.tick_params(which='minor',length=4,width=1.5,labelsize=14)
plt.scatter(crRS['SCmagRed'][gnot1604],np.log10(crn['lum_full'][gAGN[np.arange(len(gnot1604))]]),color=carr[jf%len(carr)],marker=marr[jf%len(marr)],label=field,s=64)
plt.xlabel('Supercolor Red Magnitude')
plt.ylabel('X-ray Luminosity')
plt.axhline(43.3,lw=2,ls='--',color='k')
plt.legend(loc='lower left')
#plt.xlim(-9,1.05)
plt.ylim(42,44.5)
plt.savefig('/home/rumbaugh/Chandra/plots/SCRed_vs_Lum.4.18.16.png')
...
plt.tick_params(which='major',length=8,width=2,labelsize=14)
plt.tick_params(which='minor',length=4,width=1.5,labelsize=14)
plt.scatter(crRS['SCmagBlue'][gnot1604],np.log10(crn['lum_full'][gAGN[np.arange(len(gnot1604))]]),color=carr[jf%len(carr)],marker=marr[jf%len(marr)],label=field,s=64)
plt.xlabel('Supercolor Blue Magnitude')
plt.ylabel('X-ray Luminosity')
plt.axhline(43.3,lw=2,ls='--',color='k')
#plt.legend(loc='lower left')
#plt.xlim(-9,1.05)
plt.ylim(42,44.5)
plt.savefig('/home/rumbaugh/Chandra/plots/SCBlue_vs_Lum.4.18.16.png')
