...
np.savetxt('/home/rumbaugh/Eric_LC_Y3A1.tab',outcr,header='COADD_OBJECT_ID RA DEC MJD MAG_PSF MAG_PSF_ERROR MAG_AUTO MAG_AUTO_ERROR BAND SN_FIELD FLAGS',comments='')
for SN in SNfields:
    ...
    outcr['SN_FIELD']=SN
    f=open('/home/rumbaugh/Eric_LC_Y3A1.tab','ab')
    np.savetxt('/home/rumbaugh/Eric_LC_Y3A1.tab',outcr,fmt='%i %f %f %f %f %f %f %f %4s %2s %i')
    f.close()
