...
plot,[0,1],[0,1],/nodata,XRANGE=[0,1.5],YRANGE=[0.5,2.5],xstyle=1,ystyle=1,XTITLE="z",YTITLE="k/k!Dref",TITLE="Interpolated from data (No fit)",CHARTHICK=5,CHARSIZE=1.4,XTHICK=4,YTHICK=4
