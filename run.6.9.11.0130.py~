...
#    print 'Estimated total NRS members: %i'%(int(totalNRS))
    print 'Estimated NRS fraction (2masks): %5.3f'%(grid2masks[i][1]*1.0/(grid2masks[i][1]+grid2masks[i][0]))
