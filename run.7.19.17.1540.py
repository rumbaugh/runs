...
for ind in np.arange(len(data['COADD_OBJECT_ID'])):
    ...
    try:
        DRWsample=pickle.load(open('/home/rumbaugh/CARpickles/SN_fields/S2/%i.DRWsample_AUTO_OR.pickle'%DBID,'rb'))
    except:
        continue
...
outdf.to_csv('/home/rumbaugh/SN_fields.S2.cen_{}.AUTO_RMS.csv'.format(ri),index=False)
