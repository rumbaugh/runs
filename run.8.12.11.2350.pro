...
set_plot,'PS'
loadct,'13'
device,file="/home/rumbaugh/LumvsRSplot.8.12.11.ps",/color
totalslum = []
totalhlum = []
yslum = []
yhlum = []
...
for i=0,4 do begin &$
   mfile = 'matched.' + ids[i] + '.Xray_opt_spec.bothmatches_serendips.8.9.11.cat' &$
   readcol,mfile,Xray_ID,Xray_RA,Xray_Dec,poserr,ncnts_soft,ncnts_hard,ncnts_full,flux_soft,flux_hard,flux_full,sig_soft,sig_hard,sig_full,num_opt_matches,opt_ID,mask,slit,opt_RA,opt_Dec,q,z,format='I,D,D,D,D,D,D,D,D,D,D,D,D,I,A,A,A,D,D,I,D',/silent &$
...
plot,[0-1],[0-1],/nodata,XTITLE=['RS Offset (RS Widths)'],YTITLE=['Log Rest-frame 0.5-8.0 keV Luminosity'],XRANGE=[-7.5,2],YRANGE=[42.0,44.5],/xsty,/ysty,XTHICK=4,YTHICK=4,CHARSIZE=1.3,CHARTHICK=4
yt = [30,43.7]
xt = [-1,-1]
