...
def reviewresults(ms,dasht=16,ntrials=10000,ldate='5.26.15',cbase='/home/rumbaugh/Fermi/TimeBombs/output/',showresults=True,showfullsample=False,T='ACFT'):
    ...
    PPMC(T,posteriorFile,DataFile,ntrials,plotfile='/home/rumbaugh/Fermi/TimeBombs/plots/PPMC_Td_%s_0218.t%i.ms_%i.%s.png'%(T,dasht,ms,date),plotfile2='/home/rumbaugh/Fermi/TimeBombs/plots/PPMC_Td_vs_tau_%s_0218.t%i.ms_%i.%s.png'%(T,dasht,ms,date),figN=7,testplot=False,errstd=1.,errtype='Poisson')
