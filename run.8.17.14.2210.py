...
#for lens in ['1030']:
    ...
    cr = np.loadtxt('/home/rumbaugh/EVLA/light_curves/Dispersions/%s.emcee_output_full_chain_interp_bs.1.25Xerr.%s.dat'%(lens,ldate))
    tau,mu = cr[:,0],cr[:,1]
    #plt.figure(1)
    plt.clf()
    ...
    plt.savefig('/home/rumbaugh/EVLA/light_curves/plots/%s.chisq_conplot.interp.1.25Xerr.plot.%s.png'%(lens,date))
