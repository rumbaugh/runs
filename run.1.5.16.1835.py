...
'cl1350': {'file': 'FINAL.spectroscopic.autocompile.blemaux.1350.dec2015.nodups.cat', 'loaddict': '','z':0.804}, \
...
'rxj1221': {'file': 'FINAL.spectroscopic.autocompile.blemaux.RXJ1221.dec2015.nodups.cat', 'loaddict': '','z':0.700}, \
...
'rxj1053': {'file': 'FINAL.spectroscopic.autocompile.blemaux.RXJ1053.dec2015.BCDXtargetsonly.nodups.cat', 'loaddict': '','z':1.140}}
...
for i in targets: 
    strname=targets[i]
    matchcat='/home/rumbaugh/Chandra/ImperialPipeline/ORELSE/%s/proc/%s/%s_optmatch.%s.dat'%(strname,strname,strname,date)
    crm=np.loadtxt(matchcat,dtype=optmatchloaddict)
    crs=np.loadtxt(spec_dict[strname]['file'],dtype=specloaddict)
    crxp=np.loadtxt('/home/rumbaugh/Chandra/ImperialPipeline/ORELSE/%s/proc/%s/%s_xray_phot.dat'%(strname,strname,strname))
    numX=len(crm['indX'])
