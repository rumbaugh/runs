...
outcr=np.zeros((len(spreadhi),2))
outcr[:,0],outcr[:,1]=spreadlo,spreadhi
np.savetxt('/home/rumbaugh/var_database/Y3A1/DR7.evq_spreads.4.30.17.dat',outcr,fmt='%f %f',header='spread_lo spread_hi')
