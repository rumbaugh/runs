...
FILE = open('/home/rumbaugh/sim_ltcurve_testing/progress_run.2.23.14.1420_dat','w')
FILE.write('# Starting...\n')
FILE.close()
...
for pair in range(1,101):
    ...
    for kernel in ['interp','boxcar']:
        ...
        for use_cov_matrix in [True,False]:
            if kernel == 'boxcar': Neffstr = '_Neff'
            for use_Neff in [True,False]:
                if ((kernel != 'interp') | use_Neff):
                    ...
                    if not use_cov_matrix: Neffstr = '_Neff'
                if kernel == 'boxcar': Neffstr = '_noNeff'
            cmstr = 'nocovmat'
