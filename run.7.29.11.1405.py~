...
#        FILEA.write('%s & %2i & %2i\\ %2i\\ %4.1f & +%2i\\ %2i\\ %2i & %5.3f\\\\ \n'%(names[i],argcnt,rahA[jj],ramA[jj],rasA[jj],decdA[jj],decmA[jj],decsA[jj],zA[jj]))
    ...
    FILE.close()
    pylab.scatter(msRA[gmsq[gmsz]],msDec[gmsq[gmsz]],marker = 'd',s=60,c='red')
    ...
    savfile = '/home/rumbaugh/paperstuff/AGN.spatmap.color.%s.7.15.11.png'%(names[i])
