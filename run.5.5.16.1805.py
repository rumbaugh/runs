...
FILEl=open('/home/rumbaugh/Chandra/fluxes_newphotoz_adam.5.5.16.dat','w')
...
for field in reffile_dict.keys():
    ...
    zdummy=np.linspace(fzl,fzu,100)
    ...
    for ix in gxray:
        print crpz['l99'][gnew0][gnew][ix],crpz['u99'][gnew0][gnew][ix],np.sum(P_inclus[gnew0][gnew][ix])
    ...
    plt.savefig('/home/rumbaugh/Chandra/plots/test_CMD.adam_RF_colors.%s.5.5.16.png'%field)
