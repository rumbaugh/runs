...
FILE=open('/home/rumbaugh/Chandra/AGN_CKP_stat.dat','w')
FILE.write('# field num_AGN_CKP num_AGN num_all AGN_CKP_frac all_CKP_frac \n')
...
for i in range(0,4):
    ...
    numAGN_CKP,numAGN,numall=CKPgrouparr[i][1],CKPgrouparr[i][2],CKPgrouparr[i][4]
    ...
    FILE.write('%15s %i %2i %3i %.4f %.4f\n'%(group,numAGN_CKP,numAGN,numall,CKPgrouparr[i][3]/100.,CKPgrouparr[i][4]/100.))
FILE.close()
