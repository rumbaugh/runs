...
names = np.array(['419+1629','423+424','427+3461','7757+363','9515+10576'])
...
for i in range(0,len(names)):
    ...
    FILE.write('%10s %5.3f %f\n'%(names[i],conflvl,lim))
    print '%10s - %2i percent confidence limit - %6.2f'%(names[i],int(conflvl*100),lim)
FILE.close()
