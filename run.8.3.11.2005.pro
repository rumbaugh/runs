...
ymax = [20,40,10,10,20]
device,file="/home/rumbaugh/paperstuff/testclus.RSwid.8.2.11.ps",/color
...
g = where((zub[i] ge z) and (z ge zlb[i])) &$
h = where(q[g] gt 2.1) &$
ls = where(Sig[g[h]] lt 3.0) &$
rsfit = rsfitb[i]-rsfitm[i]*iB &$
rsoffset = (rB-iB-rsfit) &$
if i lt 0.1 then y_RSO = [y_RSO,rsoffset[g[h]]] &$
if i gt 0.1 then o_RSO = [o_RSO,rsoffset[g[h]]] &$
print,LFCid[g[h[ls]]],mask[g[h[ls]]],slit[g[h[ls]]],raopt[g[h[ls]]],decopt[g[h[ls]]],z[g[h[ls]]],q[g[h[ls]]],Sig[g[h[ls]]] &$
endfor
...
h = where((F606W lt 90) and (F606W gt 0.1) and (F814W gt 0.1) and (F814W lt 90))
g = where((z[h] le 0.96) and (z[h] ge 0.84))
ls = where(Sig[h[g]] lt 3.0)
rsfit = 3.182-0.063*F814W
rsoffset = (F606W-F814W-rsfit)
y_RSO2 = rsoffset[h[g]]
print,LFCid[h[g[ls]]],mask[h[g[ls]]],slit[h[g[ls]]],raopt[h[g[ls]]],decopt[h[g[ls]]],z[h[g[ls]]],q[h[g[ls]]],Sig[h[g[ls]]]
