...
ldate = '8.19.14'
for lens in ['B0712']:
    cr = np.loadtxt('/home/rumbaugh/EVLA/light_curves/Dispersions/%s_jointfit_difmus.emcee_output_full_chain_%s_bs.%s.dat'%(lens,kernel,ldate))
    tau,mu,mu2 = cr[:,0],cr[:,1],cr[:,2]
    #plt.figure(1)
    plt.clf()
    ...
    plt.savefig('/home/rumbaugh/EVLA/light_curves/plots/%s_jointfit_difmus.chisq_conplot.%s.triangle_mod_plot.%s.png'%(lens,kernel,date))
