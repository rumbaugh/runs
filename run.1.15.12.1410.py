...
#rB = f606
    ...
    print '%s\nOverall Opt. Center: (%i %i %4.1f,%i %i %4.1f)\nOpt-Xray Offset (as): %f\nNum. of Blue/Red Gals: (%i,%i)\nRed Center: (%f,%f)\nBlue Center: (%f,%f)\nDifference in as: %f +%f/-%f\nNo Weights\nRed Center: (%f,%f)\nBlue Center: (%f,%f)\nDifference in as: %f +%f/-%f\n'%(names[i],RAcenh,RAcenm,RAcens,Deccenh,Deccenm,Deccens,odiff,len(gb),len(gr),RAcen_r,Deccen_r,RAcen_b,Deccen_b,diff,(sortdiffdist[np.searchsorted(sortdiffdist,diff)+333])-diff,diff-(sortdiffdist[np.searchsorted(sortdiffdist,diff)-333]),RAcen_rnw,Deccen_rnw,RAcen_bnw,Deccen_bnw,diffnw,(sortdiffdistnw[np.searchsorted(sortdiffdistnw,diffnw)+333])-diffnw,diffnw-(sortdiffdistnw[np.searchsorted(sortdiffdistnw,diffnw)-333]))
