...
plt.savefig('/home/rumbaugh/var_database/plots/max_diffs.hist.12.18.16.png')
...
np.savetxt('/home/rumbaugh/var_database/maxdiffs_DBID.12.18.16.txt',tcr,fmt='%7i %f',header='DatabasedID  Max_Mag_Difference')
