...
np.savetxt('/home/rumbaugh/test_max_mag_drop_DR7.4.17.17.dat',outcr,fmt='%24s %6.3f %4s %4s %i %7.1f',header='DatabaseID MaxMagDrop SurveyInit SurveyFinal Stripe82 Baseline',comments='')
