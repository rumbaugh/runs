...
for mask in ['1131m3']:
	for slit,i in zip(['1','54','80','261','449','416','484','564','663','679','948'],np.arange(11)):
		tdict = copy.deepcopy(files_dict[mask])
		print 'Slit #%i'%(i+1)
		lris_reduce_multislit(indir_dict[mask],outdir_dict[mask],files_dict[mask]['prefix'],tdict,mask,colors='blue',sides=['top'],doCR=False,slitname=slit)
