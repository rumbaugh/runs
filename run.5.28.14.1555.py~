...
FILE=open('/home/rumbaugh/runs/run.5.28.14.1545.sh','w')
FILE.write("#!/bin/csh\n")
...
for date,aipsdate in zip(dates,aips_dates):
    ...
    for source in tsources:
        ...
        #else:
        FILE.write('rmod /mnt/data2/rumbaugh/VLA/AF377/models/20010212_%s_g_wjet_jvarpos.mod\n'%(source[:4]))
        #FILE.write('rmod /mnt/data2/rumbaugh/VLA/AF377/models/comp_fit_med_0414+534_g_ellgauss.mod\n')
        #FILE.write('rmod /mnt/data2/rumbaugh/EVLA/11A-138/scripts/model.0414.wellgauss2.5.20.14.mod\n')
        FILE.write(fit_string)
        outfile = '/mnt/data2/rumbaugh/VLA/AF377/difmap_results/fit_aipsredux_wjet_5.28.14.%s.jvarpos.%s.mod'%(source,date)
        FILE.write('wmod %s\n'%outfile)
