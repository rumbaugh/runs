...
#cr=np.loadtxt('/home/rumbaugh/Fermi/data/test/testlightcurve_truthvalues.%s.dat'%date,arr,fmt='%.3f %.4f %.3f %.4f %.3f %.4f %.3f %.4f')
...
#while len(mu5[mu5<=0]) > 0: mu5[mu5<=0] = 1-np.random.gamma(2,0.15,len(mu5[mu5<=0]))
#while len(mu10[mu10<=0]) > 0: mu10[mu10<=0] = 1-np.random.gamma(2,0.15,len(mu10[mu10<=0]))
#while len(mu15[mu15<=0]) > 0: mu15[mu15<=0] = 1-np.random.gamma(2,0.15,len(mu15[mu15<=0]))
#while len(mu20[mu20<=0]) > 0: mu20[mu20<=0] = 1-np.random.gamma(2,0.15,len(mu20[mu20<=0]))
mu_arr=np.concatenate(([mu5],[mu10],[mu15],[mu20]),axis=0)
