...
for field in ['cl1604']:
    ...
    outcat='/home/rumbaugh/Chandra/ImperialPipeline/ORELSE/%s/proc/%s/%s_optmatch.%s_min5.dat'%(field,field,field,date)
    outreg='/home/rumbaugh/Chandra/ImperialPipeline/ORELSE/%s/proc/%s/%s_optmatch.%s_min5.reg'%(field,field,field,date)
    g=np.where(cr_aim['ID']==field)[0][0]
    raaim,decaim=cr_aim['RA'][g],cr_aim['DEC'][g]
    raaim_south, decaim_south=cr_aim['RA'][cr_aim['ID']=='cl1604_south'][0],cr_a`im['DEC'][cr_aim['ID']=='cl1604_south'][0]
