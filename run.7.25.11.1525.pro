...
loadct,13
set_plot,'PS'
device,file="/home/rumbaugh/paperstuff/logNlogSplot.overdensities.hard.7.25.11.ps",/color
usersymdash,thick=4
...
legend,['Composite','Cl0023','Cl1604','Cl1324','RXJ1757','RXJ1821'],PSYM=[8,7,4,2,6,5],color=[0,15,255,60,180,90],THICK=[18,4,4,4,4,4],SYMSIZE=[1.0,0.8,0.8,0.8,0.8,0.8],CHARSIZE=1.3,CHARTHICK=4,/bottom,box=0
