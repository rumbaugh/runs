...
imgname = {0: 'C', 1: 'B', 2: 'A'}
FILE = open('/home/rumbaugh/EVLA/light_curves/Dispersions/delta_var.1938.11.25.13.dat','w')
for delta in np.arange(18)+2.5:
    ttmp,mtmp,BA_disp = calc_disp_delay(Cflux,Bflux,ltime,ltime,Cerr,Berr,maxtimestep,timestep,minmu,maxmu,mustep,'D_4_2b',delta,output=2,simplemuerr=True)
    FILE.write('%4.1f %4.1f %f\n'%(delta,ttmp,mtmp))
FILE.close()
