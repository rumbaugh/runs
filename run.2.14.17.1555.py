...
crmqnomatch['SP_ROWNUM'],crmqnomatch['SDSS_NAME']='-1','-1'
...
crspnomatch['MQ_ROWNUM'],crspnomatch['SDSS_NAME']='-1','-1'
...
crbhnomatch['SP_ROWNUM'],crbhnomatch['MQ_ROWNUM']='-1','-1'
...
matchcr['SDSS_NAME'],matchcr['SP_ROWNUM'],matchcr['MQ_ROWNUM']='-1','-1','-1'
