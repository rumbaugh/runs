...
crRS = np.loadtxt('/home/rumbaugh/Chandra/RS_offsets_wACS.6.13.16.dat',dtype={'names':('field','number','ID','RA','Dec','RSoffset','magR','magI','magZ','SCmagRed','SCmagBlue'),'formats':('|S24','i8','|S48','f8','f8','f8','f8','f8','f8','f8','f8')})
...
FILE=open('/home/rumbaugh/Chandra/Pz_comp_chk.7.12.16.dat','w')
...
FILE.close()
plt.savefig('/home/rumbaugh/Chandra/plots/RSoffset_vs_Lum.7.3.16.png')
print newxray
