...
cr=np.loadtxt('/home/rumbaugh/radecname_forSDSScutouts.2.16.17.csv',dtype={'names':('ra','dec','name'),'formats':('f8','f8','|S40')},delimiter=',')

ra,dec,DBID=cr['ra'][0],cr['dec'][0],cr['name'][0]
save_image(ra,dec,DBID)


url_template = 'http://skyserver.sdss.org/dr13/SkyServerWS/ImgCutout/getjpeg?ra={}&dec={}&scale=0.004&width=600&height=600&opt=GI'
filename_template = '/home/rumbaugh/test2_{}.jpeg'
