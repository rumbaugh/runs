...
def do_redux(ID,side):
    ...
    mupoly,sigpoly=trace_spectrum(data[:,dlb_0810:dub_0810+1],mu0_0810,sig0_0810,stepsize=25,dispaxis='y',noblankcolumns=True)
    fname='%s%i'%(side,ID)
    FILE.write('%4s %E %E %E %E %.0f %.0f %E\n'%(fname,mupoly[0],mupoly[1],mupoly[2],mupoly[3],dlb_0810,dub_0810,mu0_0810))
    FILEs.write('%4s %E %E %E %E %.0f %.0f %E\n'%(fname,sigpoly[0],sigpoly[1],sigpoly[2],sigpoly[3],dlb_0810,dub_0810,sig0_0810))

FILE=open('/home/rumbaugh/KAST/Science/mupoly.0810.dat','w')
FILEs=open('/home/rumbaugh/KAST/Science/sigpoly.0810.dat','w')
