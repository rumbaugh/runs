...
crcp=np.loadtxt('/home/rumbaugh/LFC_color_param/comb_LFC_params.graz13.2.20.16.dat',usecols=cols)
Acomb=crcp[-1]
if allcolors:
    psfpdf=bpdf.PdfPages('/home/rumbaugh/Chandra/plots/CMDs.2.21.16.pdf')
else:
    psfpdf=bpdf.PdfPages('/home/rumbaugh/Chandra/plots/CMDs_param_colors.2.21.16.pdf')
