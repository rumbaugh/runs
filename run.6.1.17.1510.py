...
for DBID,idb in zip(crd['DBID'],np.arange(len(crd))):
    ...
    cr=cr[outlier_arr==0]
    for b,lo_arr,lonumarr,lomjdloarr,lomjdhiarr,hi_arr,hinumarr,himjdhiarr,himjdhiarr in zip(['r','i'],[rlo,ilo],[numrlo,numilo],[rlomjdlo,ilomjdlo],[rlomjdhi,ilomjdhi],[rhi,ihi],[numrhi,numihi],[rhimjdlo,ihimjdlo],[rhimjdhi,ihimjdhi]):
