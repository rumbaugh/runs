...
for i in range(2,3):
    ...
    if mslit == 0:
        ...
        #slitID(indir,pref,[flat_num,arc_num,images_num[0]],outname,side='bottom',slits=[[100,300]])
    else:
...
for i in range(7,rgroups):
    ...
    #slitID(indir,pref,[flat,arc,110],outname,side='top',slits=[[50,100]])
    if mslit == 0:
        slitID(indir,pref,[flat_num,arc_num,images_num[0]],outname,side='top',slits=[[10,500]])
    else:
        slitID(indir,pref,[flat_num,arc_num,images_num[0]],outname,side='top')
    oldName = None
    sf = True
