...
fluxl = (10^(41.7-57)*1.31*0.7^(-2))/k2
flag1 = 0
for i=1L, n_elements(sky_cov)-1 do begin  &$
    ...
    if flag1 eq 1 then print,i,fluxl*k2,farr[i]  &$ 
...
plot, farr*k2, sky_cov/max(sky_cov), /xlog, xrange=[1e-15,1e-14],yrange=[0.00,1.001],/xstyle,/ystyle
