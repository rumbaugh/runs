...
psfpdf=bpdf.PdfPages('/home/rumbaugh/Chandra/plots/CMDs.6.13.16.pdf')
...
fig=figure(1)
FILERS=open('/home/rumbaugh/Chandra/RS_offsets.6.13.16.dat','w')
...
for field in targets[np.argsort(zlist)]:
    ...
    ax.scatter(i,r-i)
    ax.scatter(AGNi,AGNr-AGNi,color='r',marker='d',s=48)
    ax.set_xlabel(r'$M_{red}$')
    ax.set_ylabel(r'$M_{blue} - M_{red}$')
    ax.set_title(field)
    ax.set_xlim(-27,-19.5)
