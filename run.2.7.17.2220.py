...
psfpdf=bpdf.PdfPages('/home/rumbaugh/var_database/plots/testLCs.2.7.17.pdf')
...
good_dbids=np.random.choice(crdb['DatabaseID'],25)
for DBID in good_dbids:
    cr=np.loadtxt('%s/%s/Y3A1/LC.tab'%(outputdir,DBID),dtype={'names':('DatabaseID','Survey','SurveyCoaddID','SurveyObjectID','RA','DEC','MJD','TAG','BAND','MAGTYPE','MAG','MAGERR','FLAG'),'formats':('|S64','|S20','|S20','|S20','f8','f8','f8','|S20','|S12','|S12','f8','f8','i8')},skiprows=1)
