...
ymax = [20,23,10,10,20]
device,file="/home/rumbaugh/paperstuff/clus.RSoffset.spatplot.5.20.11.ps",/color
...
if i eq 1 then g2 = where(rs[g[gq[gc]]] gt 0.72) &$
if i eq 1 then g3 = where((rsoffset[g[gq[gc[g2]]]] gt 0.01) & (rsoffset[g[gq[gc[g2]]]] lt 0.2)) &$
...
;plot,rs[g[gq[gc]]],rsoffset[g[gq[gc]]],XTITLE="Redshift",YTITLE="RS
;Offset
;(r'-i')",SYMSIZE=0.1,XRANGE=[0.65,0.8],YRANGE=[-1,0.5],PSYM=2,THICK=4,xstyle=1,ystyle=1,CHARSIZE=1.3,CHARTHICK=4,XTHICK=6,YTHICK=6
;&$
if i eq 1 then plot,raLFC[g[gq[gc[g2[g3]]]]],decLFC[g[gq[gc[g2[g3]]]]],PSYM=2,THICK=4,XTITLE='RA',YTITLE='Dec' &$
...
if i eq 1 then Histoplot,rsoffset[g[gq[gc[g2]]]],MININPUT=-1.00,MAXINPUT=0.5,BINSIZE=0.02,THICK=8,/oplot,/outline &$
