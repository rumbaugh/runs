...
plt.savefig('/home/rumbaugh/Chandra/plots/scaling_relations.Lx-T.8.24.16.png')
...
plt.savefig('/home/rumbaugh/Chandra/plots/scaling_relations.sig-T.8.24.16.png')
...
plt.ylabel(r'$L_x\ E(z)^{-1}$ ergs s$^{-1}$')
plt.savefig('/home/rumbaugh/Chandra/plots/scaling_relations.sig-Lx.8.24.16.png')
