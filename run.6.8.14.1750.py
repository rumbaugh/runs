...
#find time delays
    ...
    sampler = emcee.EnsembleSampler(nwalkers,ndim,delaylnprob,args=[Cflux[g],Bflux[g],Cerr[g],Berr[g],ltime[g],mu_init,mintime,maxtime,False,True,True,'boxcar',10.,0.5,None])
