...
np.savetxt('/home/rumbaugh/var_database/Y3A1/DR7_full_magdiffs.4.1.17.tab',outcr,header='RA DEC Redshift MJD_lo g_lo sig_lo MJD_hi g_hi sig_hi',fmt='%f %f %f %f %f %f %f %f %f')
