...
outdf=pd.DataFrame({'field':clbdf.field,'cluster':clbdf.cluster.unique(),'Xray_ra':clbdf.ra,'Xray_dec':clbdf.dec,'BCG_ra':bcgra,'BCG_dec':bcgdec,'LWM_ra':lwra,'LWM_dec':lwdec,'LWM_Ngal':lwN,'dist_bcg2x':dist_bcg2x,'dist_bcg2lw':dist_bcg2lw,'dist_lw2x':dist_lw2x})
outdf=outdf[['field','cluster','Xray_ra','Xray_dec','BCG_ra','BCG_dec','LWM_ra','LWM_dec','LWM_Ngal','dist_bcg2x','dist_bcg2lw','dist_lw2x']]
