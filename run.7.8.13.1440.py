...
for mask in ['0435_slit1']:
	for side in ['top','bottom']:
		if ((mask == '0435_slit1') & (side == 'top')):
			#lris_reduce_longslit(indir_dict[mask],outdir_dict[mask],files_dict[mask]['prefix'],files_dict[mask],mask,colors='red',sides=[side],doCR=True)
			pass
		else:
			if not ((mask == '0435_slit2') & (side == 'top')): lris_reduce_longslit(indir_dict[mask],outdir_dict[mask],files_dict[mask]['prefix'],files_dict[mask],mask,colors='red',sides=[side],doCR=True)
