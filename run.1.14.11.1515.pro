set_dirs
set_plot,'PS'
device,file='/home/rumbaugh/LFC/CapODPlotOverPlot.ps',/color
loadct,13
...
oplot,CfitZ,CfitR
oploterror,zMe[0:4],k0kref[0:4],k0kreferr[0:4],PSYM=4,color=250,SYMSIZE=2,THICK=2
oploterror,zMe[5],k0kref[5],k0kreferr[5],PSYM=5,color=180,SYMSIZE=2,THICK=2

LEGEND,['Fields from Cappeluti et al. 2005','Our fields','5-field composite'],PSYM=[6,4,5],COLOR=[30,250,180],SYMSIZE=[1.3,1.3,1.3],THICK=[1.5,1.5,1.5],/right_legend,/bottom
