...
loadct,13
set_plot,'PS'
device,file="/home/rumbaugh/paperstuff/logNlogSplot.combined.hard.paper.7.25.11.ps",/color
usersymdash
...
plot, src_flux_sort, N, /xlog, /ylog, psym=7,xrange=[3E-15,5E-14],yrange=[30,2000],XTITLE="S (erg s!E-1!N cm!E-2!N)", YTITLE = "N(>S) (deg!E-2!N)",/ysty,/xsty,SYMSIZE=0.6,THICK=4,XTHICK=6,YTHICK=6,CHARSIZE=1.3,CHARTHICK=5
...
oplot, src_flux_sort, N,  psym=4,color=255,SYMSIZE=0.6,THICK=4
...
; window, 1
;plot, src_flux_sort, N,  psym=7,xrange=[6E-16,2E-14],yrange=[50,2000]
oplot, src_flux_sort, N,  psym=2,color=60,SYMSIZE=0.6,THICK=4
...
; window, 1
;plot, src_flux_sort, N,  psym=7,xrange=[6E-16,2E-14],yrange=[50,2000]
oplot, src_flux_sort, N,  psym=5,color=100,SYMSIZE=0.6,THICK=4
...
; window, 1
;plot, src_flux_sort, N,  psym=7,xrange=[6E-16,2E-14],yrange=[50,2000]
oplot, src_flux_sort, N,  psym=6,color=160,SYMSIZE=0.6,THICK=4
