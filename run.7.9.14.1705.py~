...
level_dict = dict(zip(np.array([3,4,5,6,7,8,10,11,12,13,14,15,16,17,20]),np.array([150,140,105,210,145,125,150,180,100,85,200,30,120,100,155])))
...
FILE = open('/home/rumbaugh/runs/run.7.7.14.1335.sh','w')
