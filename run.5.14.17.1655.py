...
outcr=np.zeros((len(cr_peaks),),dtype={'names':('field','clus','Rmax','xcen','ycen','P3','P4','P3err','P4err'),'formats':('|S24','|S24','f8','f8','f8','f8','f8','f8','f8')})
...
for i in range(0,len(cr_peaks)):
    ...
    outcr['Rmax'][i]=R_Mpc
np.savetxt('/home/rumbaugh/Chandra/ORELSE.power_ratios.dat',outcr,fmt='%12s %12s %6.1f %10.5f %10.5f %f %f %f %f',header='field cluster Rmax ImageX ImageY P3 P4 P3err P4err')
