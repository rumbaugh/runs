...
ax.scatter(mred_all,mblue_all-mred_all)
ax.set_title('All field sources')
ax.set_xlim(-27,-19.5)
...
plt.tick_params(which='minor',length=4,width=1.5,labelsize=14)
ax=fig.add_subplot(1,1,1)
ax.scatter(mred_lowz,mblue_lowz-mred_lowz)
ax.set_title('z < 0.8')
ax.set_xlim(-27,-19.5)
ax.set_ylim(-0.5,1.72)
fig.savefig(psfpdf,format='pdf')
...
plt.tick_params(which='minor',length=4,width=1.5,labelsize=14)
ax=fig.add_subplot(1,1,1)
ax.scatter(mred_midz,mblue_midz-mred_midz)
ax.set_title('0.8< z < 0.96')
ax.set_xlim(-27,-19.5)
ax.set_ylim(-0.5,1.72)
fig.savefig(psfpdf,format='pdf')
...
plt.tick_params(which='minor',length=4,width=1.5,labelsize=14)
ax=fig.add_subplot(1,1,1)
ax.scatter(mred_highz,mblue_highz-mred_highz)
ax.set_title('z > 0.96')
ax.set_xlim(-27,-19.5)
ax.set_ylim(-0.5,1.72)
fig.savefig(psfpdf,format='pdf')
