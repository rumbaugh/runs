...
if appendflag == 0:
    ...
    wora = 'a'
i2 = 0
FILE = open('/home/rumbaugh/runs/run.8.26.12.0010.sh','w')
FILE.write("#!/bin/csh\n")
...
#for i in range(0,len(datearr)):
    ...
    if ((i != 13) & (i != 6) & (i != 14) & (i != 16)): 
        FILE.write('difmap << EOF\ninteger mfitniter\nmfitniter = 7\nlogical varpos\nvarpos = false\nobs %s%sSB%s_%s.%s.%s.11.11A-138.B1938+666.uvfits\nselect I\nmapunits arcsec\nmapsize 256,0.05\nshift %f,%f\naddcmp 0.0717458,true,-0.664,0.574,varpos\naddcmp 0.0307923,true,-0.053,0.869,varpos\naddcmp 0.0809120,true,-0.581,0.695,varpos\naddcmp 0.0112803,true,0.0,0,varpos\naddcmp 0.00985509,true,-0.310,0.973,varpos\naddcmp 0.00985509,true,-0.098,0.077,varpos\nmodelfit mfitniter\nselfcal false,false,60\nmodelfit mfitniter\nselfcal false,false, 60\nmodelfit mfitniter\nwmod /local3/rumbaugh/EVLA/data/11A-138/difmap_results/fit.B1938+666.%sSB%s_%s.indshift.fixpos.8.25.12.mod\nquit\nEOF\n'%(cur_dir,EarlyorLate_arr[i],SBgrouparr[i],SBnumarr[i],montharr[i],datearr[i],-1*A1x[i2],-1*A1y[i2],EarlyorLate_arr[i],SBgrouparr[i],SBnumarr[i]))
        FILE.write('difmap << EOF\ninteger mfitniter\nmfitniter = 30\nlogical varpos\nvarpos = true\nobs %s%sSB%s_%s.%s.%s.11.11A-138.B1938+666.uvfits\nselect I\nmapunits arcsec\nmapsize 256,0.05\nshift %f,%f\naddcmp 0.0717458,true,-0.664,0.574,varpos\naddcmp 0.0307923,true,-0.053,0.869,varpos\naddcmp 0.0809120,true,-0.581,0.695,varpos\naddcmp 0.0112803,true,0.05,0,varpos\naddcmp 0.00985509,true,-0.310,0.973,varpos\naddcmp 0.00985509,true,-0.098,0.077,varpos\nmodelfit mfitniter\nselfcal false,false,60\nmodelfit mfitniter\nselfcal false,false, 60\nmodelfit mfitniter\nwmod /local3/rumbaugh/EVLA/data/11A-138/difmap_results/fit.B1938+666.%sSB%s_%s.indshift.varpos.8.25.12.mod\nquit\nEOF\n'%(cur_dir,EarlyorLate_arr[i],SBgrouparr[i],SBnumarr[i],montharr[i],datearr[i],-1*A1x[i2],-1*A1y[i2],EarlyorLate_arr[i],SBgrouparr[i],SBnumarr[i]))
        FILE.write('difmap << EOF\ninteger mfitniter\nmfitniter = 7\nlogical varpos\nvarpos = false\nobs %s%sSB%s_%s.%s.%s.11.11A-138.B1938+666.uvfits\nselect I\nmapunits arcsec\nmapsize 256,0.05\nshift %f,%f\naddcmp 0.0717458,true,-0.664,0.574,varpos\naddcmp 0.0307923,true,-0.053,0.869,varpos\naddcmp 0.0809120,true,-0.581,0.695,varpos\naddcmp 0.0112803,true,0.05,0,varpos\naddcmp 0.00985509,true,-0.310,0.973,varpos\naddcmp 0.00985509,true,-0.098,0.077,varpos\nmodelfit mfitniter\nselfcal false,false,60\nmodelfit mfitniter\nselfcal false,false, 60\nmodelfit mfitniter\nwmod /local3/rumbaugh/EVLA/data/11A-138/difmap_results/fit.B1938+666.%sSB%s_%s.meanshift.fixpos.8.25.12.mod\nquit\nEOF\n'%(cur_dir,EarlyorLate_arr[i],SBgrouparr[i],SBnumarr[i],montharr[i],datearr[i],-1*A1x_mean,-1*A1y_mean,EarlyorLate_arr[i],SBgrouparr[i],SBnumarr[i]))
        FILE.write('difmap << EOF\ninteger mfitniter\nmfitniter = 35\nlogical varpos\nvarpos = true\nobs %s%sSB%s_%s.%s.%s.11.11A-138.B1938+666.uvfits\nselect I\nmapunits arcsec\nmapsize 256,0.05\nshift %f,%f\naddcmp 0.0717458,true,-0.664,0.574,varpos\naddcmp 0.0307923,true,-0.053,0.869,varpos\naddcmp 0.0809120,true,-0.581,0.695,varpos\naddcmp 0.0112803,true,0.05,0,varpos\naddcmp 0.00985509,true,-0.310,0.973,varpos\naddcmp 0.00985509,true,-0.098,0.077,varpos\nmodelfit mfitniter\nselfcal false,false,60\nmodelfit mfitniter\nselfcal false,false, 60\nmodelfit mfitniter\nwmod /local3/rumbaugh/EVLA/data/11A-138/difmap_results/fit.B1938+666.%sSB%s_%s.meanshift.varpos.8.25.12.mod\nquit\nEOF\n'%(cur_dir,EarlyorLate_arr[i],SBgrouparr[i],SBnumarr[i],montharr[i],datearr[i],-1*A1x_mean,-1*A1y_mean,EarlyorLate_arr[i],SBgrouparr[i],SBnumarr[i]))
        i2 += 1
