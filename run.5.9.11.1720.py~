...
pylab.errorbar(Temps, lums, xerr=[TerrD,TerrU],yerr=[lumes,lumes],fmt='ro')
pylab.xlabel('T (keV)')
...
for i in range(0,len(Temps)): 
    if i == 0: 
        ...
        pylab.text(Temps[i]-1,lums[i]-0.3,names[i],color='black',weight='extra bold')
    else:
        pylab.text(Temps[i],lums[i],names[i],color='black',weight='extra bold')
pylab.savefig('/home/rumbaugh/paperstuff/LxT.plot.4.25.11.png')
pylab.close('all')
