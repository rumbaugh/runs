...
for tdcfile in np.array(['tdc1_rung1_double_pair7','tdc1_rung1_double_pair322','tdc1_rung1_double_pair382','tdc1_rung1_double_pair403']):
    infile = '/mnt/data2/rumbaugh/TDC/tdc1sample_for_test/rung1/%s.txt'%tdcfile
    outfile = '/mnt/data2/rumbaugh/TDC/tdc1sample_for_test/rung1/output/%s.BA.dat'%tdcfile
