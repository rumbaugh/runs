...
set_plot,'PS'
loadct,'13'
device,file="/home/rumbaugh/LumvsRSplot.7.29.11.ps",/color
totalslum = []
totalhlum = []
yslum = []
yhlum = []
...
for i=0,4 do begin &$
   ...
   if i lt 1.5 then rsfity = [rsfity,rsfitt[nors[gic2]]] &$
   ...
   if i lt 1.5 then rsfity = [rsfity,rsfitt[ors[gic]]] &$
   ictemp[gic] = 1 &$
   ic = [ic,ictemp] &$
   flum = slum+hlum &$
   slum += 0.0000000001
   ...
   if i lt 1.5 then yslum = [yslum,slum[nors[gic2]]] &$
   if i lt 1.5 then yhlum = [yhlum,hlum[nors[gic2]]] &$
   if i gt 1.5 then oslum = [oslum,slum[nors[gic2]]] &$
   if i gt 1.5 then ohlum = [ohlum,hlum[nors[gic2]]] &$
   if i lt 1.5 then yhlum = [yhlum,hlum[ors[gic]]] &$
   if i lt 1.5 then yslum = [yslum,slum[ors[gic]]] &$
