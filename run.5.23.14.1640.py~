...
FILE2 = open('/mnt/data2/rumbaugh/VLA/AF377/models/comp_fit_med_0414+534_g.mod','w')
imgnames = ['A1','A2','B','C']
...
for img in imgnames:
    ...
    medrad,medtheta = np.median(rads[img][gno_outliers]),np.median(thetas[img][gno_outliers])
    FILE.write('%s   %f   %f\n'%(fluxes[img],rad,theta))
    FILE2.write('%s   %f   %f\n'%(fluxes[img],medrad,medtheta))
