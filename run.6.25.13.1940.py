...
for mask in ['miki22.f','miki21.f','miki04.f','miki04_B','miki04_A','miki03_B','miki03_A','miki21D.','miki16B.','bc3.file','bc3B.fil','miki21C.','M0744_A','M0744_B','M0417_B','M1115_A','miki10.f','miki22_z','miki21_B','1131m3','1131m4','miki16B.']:
    ...
    for side in sides:
        for color in colors:
            for slit in slit_name_dict[mask][color][side]:
                if not ((mask in ['miki03_A','miki22.f','miki21,f','miki04_A']) & (color == 'blue') & (side == 'top')):
                    if color == 'blue':
