...
ttmp,mtmp,BA_disp,neff = chi_squared_min_delays(Cflux,Bflux,ltime,ltime,Cerr,Berr,t_grid,maxtimestep,timestep,minmu,maxmu,mustep,smooth_function='gauss',smooth_param=np.array([10.]),use_overlap_mean=True,outfile='/home/rumbaugh/EVLA/light_curves/Dispersions/Chisq_grid_out.1938.11.14.13.dat')
