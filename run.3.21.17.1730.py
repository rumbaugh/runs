...
plot_DB_lightcurves(crmd['DBID'],'/home/rumbaugh/DR7_EVQ_lightcurves_2.3.21.17.pdf',DBdir='/home/rumbaugh/var_database/Y3A1',outlierflags=crmd['flag'],zoominband='g',calc_outliers=True,outlier_window=np.array([300,30,100]))
