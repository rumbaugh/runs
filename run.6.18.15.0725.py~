...
redo_dict={5:np.array([11,29,32,34,58,79,88,89,98]), 10:np.array([9,17,21,23,24,25,27,35,40,41,45,52,54,56,58,59,82,84,99]), 15:np.array([1,6,20,24,26,29,30,31,40,42,43,46,49,53,54,55,62,64,65,67,70,85,87,98]),20:np.array([3,9,19,26,36,58,64,68,90,94,95,96,97,98,99,100])}

for tau,it in zip([5,10,15,20],[0,1,2,3]):
