...
ymax = [20,40,10,10,20]
device,file="/home/rumbaugh/paperstuff/clus.RSwid.5.21.11.ps",/color
...
Histoplot,rswidA4,MINVALUE=-6,MAXVALUE=2,BINSIZE=0.1,THICK=4,locations=loca4,histdata=hista4,/oplot,/outline
...
oplot,loca4,hista4/12.0,PSYM=10,color=60,THICK=3
