...
for i in range(0,len(names)):
    ...
    infinal[gRGPtemp] = 1
    if names[i] == 'RXJ1821':
        for ifl in range(0,len(gRGP)): FILE5.write('%s %f %f %f %f %i %i\n'%(sID[g[gRGP[ifl]]],sRA[g[gRGP[ifl]]],sDec[g[gRGP[ifl]]],sz[g[gRGP[ifl]]],velstemp[ifl],sq[g[gRGP[ifl]]],infinal[ifl]))
    gq = np.where(sq > 2.2)
    ...
    infinal[gRGPtemp] = 1
    if names[i] != 'RXJ1821':
        for ifl in range(0,len(gRGP2)): FILE5.write('%s %f %f %f %f %i %i\n'%(sID[gq[gRGP2[ifl]]],sRA[gq[gRGP2[ifl]]],sDec[gq[gRGP2[ifl]]],sz[gq[gRGP2[ifl]]],velstemp2[ifl],sq[gq[gRGP2[ifl]]],infinal[ifl]))
    for im in range(0,len(gRGPtemp)):
