...
FILERS=open('/home/rumbaugh/Chandra/RS_offsets.6.7.16.dat','w')
FILERS.write('# field AGNnum specID RA Dec RSoffset magR magI magZ SCmagRed SCmagBlue\n')
...
for field in targets[np.argsort(zlist)]:
    ...
    ax.plot(xspace,ydummy-0.5*width,ls='--',lw=2,color='r')
    ax.set_xlim(-27,-19.5)
    ax.axvline(-22.3,color='k',ls='dotted',lw=2)
    #ax.set_xlim(18.5,25)
    ax.set_ylim(-0.5,1.72)
