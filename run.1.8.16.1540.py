...
execfile('/home/rumbaugh/ChandraImperialPSF.py')
...
for j in range(0,7): 
    ...
    for i in range(0,np.shape(cr)[0]):
        ...
        x_out[i] = x[i][g[0]]
        y_out[i] = y[i][g[0]]
    interp_psfA,interp_psfB,interp_ang=SetupImpPSF('soft','95')
    interp_psfAh,interp_psfBh,interp_angh=SetupImpPSF('hard','90')
