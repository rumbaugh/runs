...
qry='SELECT g.DR7ID,g.SDSS_NAME,g.DBID,y.SPREAD_MODEL_G,y.SPREAD_MODEL_G_ERR,y.SPREAD_MODEL_R,y.SPREAD_MODEL_R_ERR,y.SPREAD_MODEL_I,y.SPREAD_MODEL_I_ERR,y.SPREAD_MODEL_Z,y.SPREAD_MODEL_Z_ERR,y.SPREAD_MODEL_Y,y.SPREAD_MODEL_Y_ERR FROM RUMBAUGH.GEMINI_TARGET g,DES_ADMIN.Y3A1_COADD_OBJECT_SUMMARY y,RUMBAUGH.DATABASEIDS d WHERE y.COADD_OBJECT_ID=d.CID AND d.DATABASEID=g.DBID'
