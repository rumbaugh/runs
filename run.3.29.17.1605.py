...
qry='SELECT g.DR7ID,g.SDSS_NAME,g.DBID,y.SPREAD_MODEL,y.SPREAD_MODEL_ERR FROM RUMBAUGH.GEMINI_TARGET g,DES_ADMIN.Y3A1_COADD_OBJECT_SUMMARY y,RUMBAUGH.DATABASEIDS d WHERE y.COADD_OBJECT_ID=d.CID AND d.DATABASEID=g.DBID'
