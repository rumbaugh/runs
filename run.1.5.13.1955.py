...
BAdisparr,BAdispmu,BAdisptime = calc_disp_delay(Aflux,Bflux,ltime,ltime,Aerr,Berr,maxtimestep,timestep,minmu,maxmu,mustep,'D_2',output=2,disparray=True)
BCdisparr,BCdispmu,BCdisptime = calc_disp_delay(Cflux,Bflux,ltime,ltime,Cerr,Berr,maxtimestep,timestep,minmu,maxmu,mustep,'D_2',output=2,disparray=True)
BDdisparr,BDdispmu,BDdisptime = calc_disp_delay(Dflux,Bflux,ltime,ltime,Derr,Berr,maxtimestep,timestep,minmu,maxmu,mustep,'D_2',output=2,disparray=True)
if not justone:
...
pylab.savefig("/home/rumbaugh/disparr.BA_delay.1.5.13.png")
pylab.close('all')
if not justone:
    for i in range(0,len(delta_arr)): 
...
pylab.savefig("/home/rumbaugh/disparr.BC_delay.1.5.13.png")
pylab.close('all')
if not justone:
    for i in range(0,len(delta_arr)): 
...
pylab.savefig("/home/rumbaugh/disparr.BD_delay.1.5.13.png")
pylab.close('all')
if not justone:
    for i in range(0,len(delta_arr)): 
