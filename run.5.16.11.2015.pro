...
ymax = [20,40,10,10,20]
device,file="/home/rumbaugh/paperstuff/clus.RSwid.5.16.11.ps",/color
...
Histoplot,rswid[hh[g[gq]]],MINVALUE=-6,MAXVALUE=2,BINSIZE=0.1,THICK=4,/oplot,/outline
...
Histoplot,rswidA,MINVALUE=-6,MAXVALUE=2,BINSIZE=0.1,THICK=4,/oplot,/outline
end
