...
for lens in ['0414']:
    ...
    if lens == '0414':
        plt.legend(testlegs,('A','B','C'),loc=4)
        imgsarr = ['A2','B','C']
        plt.ylim(0.83,1.18)
    elif lens == '0712':
    ...
    if lens != '0712': plt.savefig('/home/rumbaugh/EVLA/light_curves/plots/%s.lc_norm_plot_offset_UVT_comb.%s.png'%(lens,date))
