...
#model_dict = {'MG0414+0534': 'rmod /mnt/data2/rumbaugh/EVLA/11A-138/scripts/model.0414.wgauss.5.20.14.mod'}

execfile('/mnt/data2/rumbaugh/EVLA/11A-138/scripts/utils_11A-138.py')
set_obs_arr()

FILE=open('/home/rumbaugh/runs/run.5.20.14.1450.sh','w')
FILE.write("#!/bin/csh\n")
