...
def reviewresults(pair,jiter,ldate='8.19.15',ddate='8.19.15',cbase='/home/rumbaugh/Fermi/TimeBombs/output/',showresults=True,ntrials=10000,testplot=False,errstd=np.sqrt(2)*7.5,T='ACFT',showfullsample=False):
...
for i,pair in zip(pairs-1,pairs):
    for j in range(0,1): crpost=reviewresults(pair,j)
