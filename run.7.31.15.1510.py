...
FILEr = open('/home/rumbaugh/KAST/Science/r0813_files.shift.list','w')
FILEb = open('/home/rumbaugh/KAST/Science/b0813_files.shift.list','w')


r0813_list = np.array([142,352,353,361,362],dtype='S99')
...
for i in np.arange(len(b0813_list)): 
    ...
    FILEb.write('/home/rumbaugh/KAST/Science/sci-b%s.shift.fits[0]\n'%b0813_list[i])
    b0956_list[i] = '/home/rumbaugh/KAST/Science/sci-b%s.fits\n'%b0813_list[i]
for i in np.arange(len(r0813_list)): 
    FILEr.write('/home/rumbaugh/KAST/Science/sci-r%s.shift.fits[0]\n'%r0813_list[i])
