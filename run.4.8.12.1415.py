...
files = ['FINAL.SG0023.deimos.lris.feb2012.nodups.cat','FINAL.cl1322.lrisplusdeimos.cat','newcats/FINAL.spectroscopic.autocompile.N200.blemaux.feb2012.nh.cat','FINAL.nep5281.deimos.gioia.feb2012.nodups.nh.cat','FINAL.spectra.sc1604.wcompletenessmasks.feb2012.nodups.nh.cat','FINAL.spectra.sc1604.wcompletenessmasks.feb2012.nodups.nh.cat','newcats/FINAL.spectroscopic.autocompile.blemaux.sc0910.mar2012.T08.nodups.cat']
...
for i in range(0,len(names)):
    ...
    gRGP2 = gRGP2[0]
    FILEz = open('/home/rumbaugh/rostat/rin%s.4.8.12.dat'%(names[i]),'w')
    ...
    FILEz = open('/home/rumbaugh/rostat/redshifts.%s.rostat_input.4.8.12.dat'%(names[i]),'w')
