...
ax.hist(rso,range=(-7,2),bins=9,color='r')
ax.hist(rso_all,range=(-10,3),bins=13,color='b',alpha=0.3,weights=20*np.ones(len(rso_all))*1./len(rso_all))
ax.set_xlabel("RS Offset")
ax.set_ylabel("Number of Sources")
ax.set_xlim(-10,3)
ax.set_ylim(0,20)
fig.savefig('/home/rumbaugh/Chandra/plots/RS_offset.hist.3.6.16.png')
