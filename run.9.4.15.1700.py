...
def plot_spec(ID,side):
    figure(1)
    clf()
    smooth_boxcar('/home/rumbaugh/KAST/Science/spec_skysub_noCR.%s%i_2.dat'%(side,ID),5)
    savefig('/home/rumbaugh/KAST/plots/spec_skysub_noCR.%s%i_2.smooth_5.png'%(side,ID))
