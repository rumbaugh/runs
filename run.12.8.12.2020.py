...
#find time delays
BA_delay_d2,BAmud2,BAdispd2 = calc_disp_delay(A1nflux,B1nflux,ltime,ltime,A1nerr,B1nerr,maxtimestep,timestep,minmu,maxmu,mustep,'D_2',output=2)
if not justone:
    BC1_delay_d2,BC1mud2,BC1dispd2 = calc_disp_delay(C1nflux,B1nflux,ltime,ltime,C1nerr,B1nerr,maxtimestep,timestep,minmu,maxmu,mustep,'D_2',output=2)
    BC2_delay_d2,BC2mud2,BC2dispd2 = calc_disp_delay(C2nflux,B1nflux,ltime,ltime,C2nerr,B1nerr,maxtimestep,timestep,minmu,maxmu,mustep,'D_2',output=2)
#now use D_4_2 with range of deltas
    ...
    for i in range(0,len(delta_arr)):
        BA_delay_d42[i],BAmud42[i],BAdispd42[i] = calc_disp_delay(A1nflux,B1nflux,ltime,ltime,A1nerr,B1nerr,maxtimestep,timestep,minmu,maxmu,mustep,'D_4_2',delta=delta_arr[i],output=2)
        BC1_delay_d42[i],BC1mud42[i],BC1dispd42[i] = calc_disp_delay(C1nflux,B1nflux,ltime,ltime,C1nerr,B1nerr,maxtimestep,timestep,minmu,maxmu,mustep,'D_4_2',delta=delta_arr[i],output=2)
        BC2_delay_d42[i],BC2mud42[i],BC2dispd42[i] = calc_disp_delay(C2nflux,B1nflux,ltime,ltime,C2nerr,B1nerr,maxtimestep,timestep,minmu,maxmu,mustep,'D_4_2',delta=delta_arr[i],output=2)

print "\n\nB-A:\nD_2 delay: %3.0f days  mu: %6.4f   disp: %f\nD_4_2:"%(BA_delay_d2,BAmud2,BAdispd2)
if not justone:
    for i in range(0,len(delta_arr)): print "delta = %4.1f days - delay: %3.0f days  mu: %6.4f   disp: %f"%(delta_arr[i],BA_delay_d42[i],BAmud42[i],BAdispd42[i])
    print "\n\nB-C1:\nD_2 delay: %3.0f days  mu: %6.4f   disp: %f\nD_4_2:"%(BC1_delay_d2,BC1mud2,BC1dispd2)
    for i in range(0,len(delta_arr)): print "delta = %4.1f days - delay: %3.0f days  mu: %6.4f   disp: %f"%(delta_arr[i],BC1_delay_d42[i],BC1mud42[i],BC1dispd42[i])
    print "\n\nB-C2:\nD_2 delay: %3.0f days  mu: %6.4f   disp: %f\nD_4_2:"%(BC2_delay_d2,BC2mud2,BC2dispd2)
    for i in range(0,len(delta_arr)): print "delta = %4.1f days - delay: %3.0f days  mu: %6.4f   disp: %f"%(delta_arr[i],BC2_delay_d42[i],BC2mud42[i],BC2dispd42[i])
