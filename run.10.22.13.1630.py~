...
FILE = open('/mnt/data2/rumbaugh/VLA/AF377/difmap_results/chisq_results.10.21.13.1715.dat','w')
...
for lens in lens_dict:
    ...
    for img in range(0,nimg):
        ...
        if lens != '0712': 
            chisq_arr[img],prob_arr[img] = calc_chi_sqrd(S[g]/CSOnorm,Serr[g]/CSOnorm,calcprob=True,trials=trials)
...
for img in range(1,nimg):
    ...
    Serr /= Smean
    imgarr = ['A+B','C','D','NA']
    chisq_arr[img-1],prob_arr[img-1] = calc_chi_sqrd(S[g]/CSOnorm,Serr[g]/CSOnorm,calcprob=True,trials=trials)  
