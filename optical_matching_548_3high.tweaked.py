...
try: 
	...
	Ra_aim = 259.25281405807
try:
	Dec_aim
except NameError:
	Dec_aim = 67.195019460966

try:
	optical_cat
except NameError:
	optical_cat = "/local3/rumbaugh/ChandraData/rxj1716.radecIDnmags.cat"
radio_cat = ""
try:
	xray_cat
except NameError:
	xray_cat = "/local3/rumbaugh/ChandraData/548/photometry/548.xray_phot.soft_hard_full.dat"

try:
	matching_dir
except NameError:
	matching_dir = "/local3/rumbaugh/ChandraData/548/opt_match"
try:
	reg_dir
except NameError:
