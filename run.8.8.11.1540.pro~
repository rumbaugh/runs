set_plot,'PS'
loadct,13
device,file='/home/rumbaugh/LumvsRS.nospectar.8.4.11.ps',/color
...
plot,[0-1],[0-1],/nodata,YRANGE=[41.5,44.5],XRANGE=[-15,3],/xsty,/ysty,XTITLE='RS Offsets (RS Wids)',YTITLE='Log Luminosity',TITLE='All Fields - Not Targeted for Spectroscopy',XTHICK=4,YTHICK=4,CHARTHICK=3
...
plot,[0-1],[0-1],/nodata,YRANGE=[41.5,44.5],XRANGE=[-15,3],/xsty,/ysty,XTITLE='RS Offsets (RS Wids)',YTITLE='Log Luminosity',TITLE='All Fields - Targeted for Spectroscopy',XTHICK=4,YTHICK=4,CHARTHICK=3
