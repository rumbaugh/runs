...
psfpdf=bpdf.PdfPages('/home/rumbaugh/SN_fields.S2_AUTO_CAR1_fits.specobjs.7.14.17.pdf')
...
for i in range(0,len(fulldf)):
    ...
    sample=pickle.load(open('/home/rumbaugh/CARpickles/SN_fields/S2/%i.DRWsample_AUTO_OR.pickle'%DBID,'rb'))
