...
for mask in ['miki22_z','miki21_B','1131m3','1131m4','miki16B.']:
    ...
    for side in sides:
        for color in colors:
            for slit in slit_name_dict[mask][color][side]:
                if not (((mask in ['miki03_A','miki22.f','miki21.f','miki04_A']) & (color == 'blue') & (side == 'top')) | ((mask in ['miki22_z']) & (((color == 'blue') & ((slit in ['34837','35433','35989','114','111','38826','38375','4','3','41092','1','102','101','40878','44500'])))))):
                    if color == 'blue':
