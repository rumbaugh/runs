        ...
        for j in range(0,5):
            ...
            for k in range(0,len(inwin)):
                ...
                if diststemp < crads[j+5]*60: 
                    indis[k] += 1
                    intemp[k] += 1
            clustot,clustotRS,clustotNRS = LookInCluster(clustot,clustotRS,clustotNRS,i,j+5)
    if i == 1:
        #NEP5281
        ...
        for j in range(0,7):
            ...
            for k in range(0,len(inwin)):
                ...
                if diststemp < crads[j+10]*60:
                    indis[k] += 1
                    intemp[k] += 1
            clustot,clustotRS,clustotNRS = LookInCluster(clustot,clustotRS,clustotNRS,i,j+10)
    if i == 4:
        #RXJ1757
        ...
        for k in range(0,len(inwin)):
            ...
            if diststemp < crads[len(clusRA)-1]*60:
                indis[k] += 1
                intemp[k] += 1
        clustot,clustotRS,clustotNRS = LookInCluster(clustot,clustotRS,clustotNRS,i,len(clusRA)-1)
