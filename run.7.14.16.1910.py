...
cr2=np.loadtxt('/home/rumbaugh/Chandra/coadds.allORELSE.AGN.type1excluded.magcut.fourregions.winfillcorr.lumcut.cat',dtype={'names':('file','region','N_AGN','OII','OIIerr','Hd','Hderr','D4000','D4000err','Hdcorr'),'formats':('|S124','i8','i8','f8','f8','f8','f8','f8','f8','f8')})

cr[2],cr[3]=cr2[4],cr2[5]
