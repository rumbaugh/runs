...
infile='/home/rumbaugh/match_catalog.cl0023+rxj1716.4.27.16.dat'

indict={'names':('field','number','RA','Dec','flux_soft','flux_hard','flux_full','ncnts_soft','ncnts_hard','ncnts_full','redshift','mask','slit','bcnts_soft','bcnts_hard','bcnts_full','sigS','sigH','sigF','optID'),'formats':('|S32','i8','f8','f8','f8','f8','f8','f8','f8','f8','f8','|S32','|S32','f8','f8','f8','f8','f8','f8','|S128')}
...
FILE=open('/home/rumbaugh/X-ray_lum_cat.cl0023+rxj1716.4.27.16.dat','w')
...
for i in range(0,len(nh_arr)): 
    FILE.write('%10s %2i %7.5f %7.5f %E %E %E %E %E %E %6.1f %6.1f %6.1f %5.3f %s %s %f %f %f %s\n'%(cr['field'][i],cr['number'][i],cr['RA'][i],cr['Dec'][i],lums[i][0],lums[i][1],lums[i][2],cr['flux_soft'][i],cr['flux_hard'][i],cr['flux_full'][i],cr['ncnts_soft'][i],cr['ncnts_hard'][i],cr['ncnts_full'][i],cr['redshift'][i],cr['mask'][i],cr['slit'][i],cr['sigS'][i],cr['sigH'][i],cr['sigF'][i],cr['optID'][i]))#,cr['ncnts_soft'][i]/(1.+np.sqrt(0.75+cr['bcnts_soft'][i])),cr['ncnts_hard'][i]/(1.+np.sqrt(0.75+cr['bcnts_hard'][i])),cr['ncnts_full'][i]/(1.+np.sqrt(0.75+cr['bcnts_full'][i]))))
