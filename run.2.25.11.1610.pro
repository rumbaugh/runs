...
set_plot,'PS'
loadct,'13'
device,file="/home/rumbaugh/XrayLums_RS.2.25.11.ps",/color
totalslum = []
totalhlum = []
yslum = []
yhlum = []
...
for i=0,4 do begin &$
   ...
   print, ids[i]
   print, "Number of sources in cluster: ",n_elements(gic)
   print, "Number of sources on RS:      ",n_elements(gic2)
   print, "Proportion on red sequence:   ",n_elements(gic2)/(1.0*n_elements(gic))
   print," "
endfor
...
;legend,['Cl1604,Cl0023','Cl1324,NEP5281,NEP200'],color=['255','70']
Histoplot,nrsflum,BINSIZE=0.25,MININPUT=41,MAXINPUT=45,TITLE="Comparison - Full Band",/LINE_FILL,POLYCOLOR='Royal Blue',datacolorname='Royal Blue',ORIENTATION=45,/oplot
