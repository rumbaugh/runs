...
for field in ['cl0849']:
    refcat='/home/rumbaugh/Chandra/Cl0849_Mei_speczs.dat'

    catin='/home/rumbaugh/Chandra/ImperialPipeline/ORELSE/%s/proc/%s/%s_xray_phot.%s.dat'%(field,field,field,ldate)
    outcat='/home/rumbaugh/Chandra/ImperialPipeline/ORELSE/%s/proc/%s/%s_optmatch_Mei.%s.dat'%(field,field,field,date)
    outreg='/home/rumbaugh/Chandra/ImperialPipeline/ORELSE/%s/proc/%s/%s_optmatch_Mei.%s.reg'%(field,field,field,date)
    ...
    MatchCat(catin,refcat,outcat,outreg,raaim,decaim,setup='xray',load_dict=load_dict,minsrch=1.5,useConcaveHull=True,reps=reps,usesig=False)
