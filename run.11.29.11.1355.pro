...
ymax = [20,40,10,10,20]
device,file="/home/rumbaugh/paperstuff/clus.RSwid.11.29.11.ps",/color
...
if i lt 4 then readcol,"/home/rumbaugh/LFC/FINAL.matched." + names2[i] + ".specnXray.nov2010.rumbaugh.cat",LFCid,mask,slit,raopt,decopt,rB,iB,zB,z,zerr,q,oldid,idX,raX,decX,errX,nm,Rel,Sig,format='A,A,I,D,D,D,D,D,D,D,I,A,I,D,D,D,I,D,D' &$
...
openw, 1, '/home/rumbaugh/full_5struc_color_hist.11.29.11.dat'
for u=0,n_elements(rswidA)-1 do begin &$
   printf,1,rswidA[u] &$
   endfor 
close,1

openw, 1, '/home/rumbaugh/1604_color_hist.11.29.11.dat'
for u=0,n_elements(rswidA5)-1 do begin &$
   printf,1,rswidA5[u] &$
   endfor 
close,1

openw, 1, '/home/rumbaugh/young_color_hist.11.29.11.dat'
for u=0,n_elements(y_RSO)-1 do begin &$
   printf,1,y_RSO[u] &$
   endfor 
close,1

openw, 1, '/home/rumbaugh/old_color_hist.11.29.11.dat'
for u=0,n_elements(o_RSO)-1 do begin &$
   printf,1,o_RSO[u] &$
   endfor 
close,1
