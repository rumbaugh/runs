...
FILE = open('/home/rumbaugh/sim_ltcurve_testing/results/VLA_MCMC_boxcar_wcovmat_Neff_%s.dat'%date,'w')
FILE.write('#pair tau tau_lowbnd tau_upbnd\n')
FILE.close()
FILE = open('/home/rumbaugh/sim_ltcurve_testing/results/VLA_MCMC_boxcar_wcovmat_noNeff_%s.dat'%date,'w')
FILE.write('#pair tau tau_lowbnd tau_upbnd\n')
FILE.close()
FILE = open('/home/rumbaugh/sim_ltcurve_testing/results/VLA_MCMC_boxcar_nocovmat_noNeff_%s.dat'%date,'w')
FILE.write('#pair tau tau_lowbnd tau_upbnd\n')
FILE.close()
FILE = open('/home/rumbaugh/sim_ltcurve_testing/results/VLA_MCMC_boxcar_nocovmat_Neff_%s.dat'%date,'w')
FILE.write('#pair tau tau_lowbnd tau_upbnd\n')
FILE.close()
FILE = open('/home/rumbaugh/sim_ltcurve_testing/results/VLA_MCMC_interp_wcovmat_%s.dat'%date,'w')
FILE.write('#pair tau tau_lowbnd tau_upbnd\n')
FILE.close()
FILE = open('/home/rumbaugh/sim_ltcurve_testing/results/VLA_MCMC_interp_nocovmat_%s.dat'%date,'w')
FILE.write('#pair tau tau_lowbnd tau_upbnd\n')
FILE.close()
FILE = open('/home/rumbaugh/sim_ltcurve_testing/results/VLA_MCMC_interp_wcovmat_noNeff_%s.dat'%date,'w')
FILE.write('#pair tau tau_lowbnd tau_upbnd\n')
FILE.close()
FILE = open('/home/rumbaugh/sim_ltcurve_testing/results/VLA_MCMC_interp_nocovmat_noNeff_%s.dat'%date,'w')
FILE.write('#pair tau tau_lowbnd tau_upbnd\n')
FILE.close()

FILE = open('/home/rumbaugh/sim_ltcurve_testing/progress_run.2.24.14.1410.dat','w')
FILE.write('# Starting...\n')
FILE.close()
    ...
    for kernel in ['interp','boxcar']:
        for use_cov_matrix in [True,False]:
            ...
            for use_Neff in [True,False]:
                ...
                FILE = open('/home/rumbaugh/sim_ltcurve_testing/results/VLA_MCMC_%s_%s%s_%s.dat'%(kernel,cmstr,Neffstr,date),'a')
                FILE.write('%3i %9.5f %9.5f %9.5f\n'%(pair,tau_med,tau_lb,tau_ub))
                FILE.close()
    if ((((pair/5)*5 == pair) & (pair < 100)) | (pair == 1)):
        tchk = time.time()-st
        ETA = tchk/pair*100-tchk
        FILE = open('/home/rumbaugh/sim_ltcurve_testing/progress_run.2.23.14.1420_dat','a')
        FILE.write('\n#%2i%% Done\n#%.1f seconds elapsed\n#ETA: %.1f seconds\n'%(pair,tchk,ETA))
        FILE.close()
FILE = open('/home/rumbaugh/sim_ltcurve_testing/progress_run.2.23.14.1420_dat','a')
FILE.write('\n#100%% Done\n#%.1f seconds elapsed'%(pair,tchk))
FILE.close()
