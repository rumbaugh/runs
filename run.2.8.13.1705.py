...
#find time delays
if justone: chisqmatAB,tau_out,mu_out,min_chisq,Neff,mu0 = chi_squared_min_delays(Aflux,Bflux,ltime,ltime,Aerr,Berr,t_grid,maxtimestep,timestep,minmu,maxmu,mustep,smooth_param=np.array([10.]),output=5,use_overlap_mean=True,ALAG=ALAG,chisqmatrix=True)
