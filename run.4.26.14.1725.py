...
for lens in ['0414']:
    ...
    plt.savefig('/home/rumbaugh/EVLA/light_curves/plots/%s.lc_rel_plot_UVT.%s.png'%(lens,date))
    plt.clf()
    plt.rc('axes',linewidth=2)
    plt.fontsize = 14
    plt.tick_params(which='major',length=8,width=2,labelsize=14)
    ...
    plt.ylabel('Normalized Flux',fontsize=14)
    plt.xlim(1810-cr[0][0],2090-cr[0][0])
    plt.savefig('/home/rumbaugh/EVLA/light_curves/plots/%s.lc_norm_plot_UVT.%s.png'%(lens,date))
