...
def do_redux(ID,side):
    ...
    crvar=py.open('/home/rumbaugh/KAST/Science/sci-%s%i.var_skysub.fits'%(side,ID))
    ...
    save_spectrum('/home/rumbaugh/KAST/Science/spec_skysub.%s%i.dat'%(side,ID),w,specm,var=varspec)
