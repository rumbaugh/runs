...
loadct,13
set_plot,'PS'
device,file="testlogNlogSplot.combined.soft.paper.7.14.11.ps",/color
...
plot, src_flux_sort, N, /xlog, /ylog, psym=7,xrange=[6E-16,3E-14],yrange=[30,2000],XTITLE="S (erg s!E-1!N cm!E-2!N)", YTITLE = "N(>S) (deg!E-2!N)", /ysty,/xsty,SYMSIZE=0.6,THICK=4,XTHICK=6,YTHICK=6,CHARSIZE=1.3,CHARTHICK=5
...
;oplot, COSMOS_S2, COSMOS_N, PSYM=0,LINESTYLE=5,THICK=4
...
; Plot logN-logS
; window, 1
;;plot, src_flux_sort, N, THICK=4,SYMSIZE=0.6,  psym=7,xrange=[6E-16,2E-14],yrange=[50,2000],/ysty,/xsty
oplot, src_flux_sort, N, THICK=4,SYMSIZE=0.6,  psym=2, color=60
...
rdfloat, "/scratch/rumbaugh/ciaotesting/Cl1604/master/../6932/acis6932.img.500-2000.nops.bin64.dat", xS, yS, countsS
...
; window, 1
;;plot, src_flux_sort, N, THICK=4,SYMSIZE=0.6,  psym=7,xrange=[6E-16,2E-14],yrange=[50,2000],/ysty,/xsty
oplot, src_flux_sort, N, THICK=4,SYMSIZE=0.6,  psym=4, color=255
...
; window, 1
;;plot, src_flux_sort, N, THICK=4,SYMSIZE=0.6,  psym=7,xrange=[6E-16,2E-14],yrange=[50,2000],/ysty,/xsty
oplot, src_flux_sort, N, THICK=4,SYMSIZE=0.6,  psym=5, color=100
...
; window, 1
;;plot, src_flux_sort, N, THICK=4,SYMSIZE=0.6,  psym=7,xrange=[6E-16,2E-14],yrange=[50,2000],/ysty,/xsty
oplot, src_flux_sort, N, THICK=4,SYMSIZE=0.6,  psym=6, color=160
...
legend,['Cl0023','Cl1604','Cl1324','NEP200','NEP5281'],PSYM=[7,4,2,6,5],color=[0,255,60,160,100],SYMSIZE=[0.8,0.8,0.8,0.8,0.8],THICK=[4,4,4,4,4],CHARSIZE=1.3,CHARTHICK=4,/bottom,box=0
