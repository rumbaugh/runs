...
psfpage=bpdf.PdfPages('/home/rumbaugh/DR7_notOVV_test.pdf')
...
np.savetxt('/home/rumbaugh/DR7_notOVV_maxvar.thresh_%i.dat'%timethresh,outcr,fmt='%24s %6.3f %6.3f',header='SDSS_NAME MaxVar MedVar')
psfpage.close()
