...
plt.hist(np.log10(crl['lum_full'][((crl['field']=='cl0023')|(crl['field']=='cl1604'))]),range=(42,44.5),bins=5,color='r',edgecolor='r',facecolor='None',lw=3,label='Cl0023 & Cl1604')
plt.hist(np.log10(crl['lum_full'][((crl['field']=='rxj1053')|(crl['field']=='cl0849')|(crl['field']=='rxj0910'))]),range=(42,44.5),bins=5,color='orange',edgecolor='orange',lw=3,alpha=0.5,label='High-z')
plt.hist(np.log10(crl['lum_full'][((crl['field']=='cl1324')|(crl['field']=='cl1324_north')|(crl['field']=='cl1324_south')|(crl['field']=='rxj1716'))]),range=(42,44.5),bins=5,color='green',alpha=0.3,edgecolor='green',lw=3,label='Inter.')
plt.hist(np.log10(crl['lum_full'][((crl['field']=='cl1350')|(crl['field']=='rxj1221')|(crl['field']=='rxj1757')|(crl['field']=='rxj1821')|(crl['field']=='rcs0224'))]),range=(42,44.5),bins=5,color='b',edgecolor='k',lw=3, alpha=0.3,label='Passive')
plt.xlabel('X-ray Luminosity')
plt.ylabel('Number of Sources')
plt.legend()
plt.savefig('/home/rumbaugh/Chandra/plots/lum_hist.group_comps.5.23.16.png')
