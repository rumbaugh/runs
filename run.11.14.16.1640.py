...
for ib,band in zip(np.arange(4),jbands):
    DEShists[ib]=cro['DES coadd %s'%band][(cro['DES coadd %s'%band]>0)&(cro['DES coadd %s'%band]<40)]
...
#plt.clf()
#execfile('/home/rumbaugh/pythonscripts/set_plt_params.py')
#plt.scatter(DEShists[0]-DEShists[1],DEShists[2]-DEShists[3],s=2)
#plt.xlabel('g-r')
#plt.ylabel('i-z')
...
plt.scatter(SDSShists[0]-SDSShists[1],SDSShists[2]-SDSShists[3],s=2,edgecolor='None',color='r')
plt.xlabel('g-r')
plt.ylabel('i-z')
plt.xlim(-1,3)
plt.ylim(-1.5,2)
...
#plt.clf()
#execfile('/home/rumbaugh/pythonscripts/set_plt_params.py')
#plt.scatter(DEShists[0]-DEShists[1],DEShists[2]-cr['magz'][(cr['magz']>0)&(cr['magz']<40)],s=2,edgecolor='None',color='r')
#plt.xlabel('g-r')
#plt.ylabel('i-z')
