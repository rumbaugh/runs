...
ltime = (ltime-ltime[0])
#find time delays
BA_delay_d2,BAmud2,BAdispd2 = calc_disp_delay(Anflux,Bnflux,ltime,ltime,Anerr,Bnerr,maxtimestep,timestep,minmu,maxmu,mustep,'D_2',output=2)
if not justone:
    BC_delay_d2,BCmud2,BCdispd2 = calc_disp_delay(Cnflux,Bnflux,ltime,ltime,Cnerr,Bnerr,maxtimestep,timestep,minmu,maxmu,mustep,'D_2',output=2)
    BD_delay_d2,BDmud2,BDdispd2 = calc_disp_delay(Dnflux,Bnflux,ltime,ltime,Dnerr,Bnerr,maxtimestep,timestep,minmu,maxmu,mustep,'D_2',output=2)
#now use D_4_2 with range of deltas
    ...
    for i in range(0,len(delta_arr)):
        BA_delay_d42[i],BAmud42[i],BAdispd42[i] = calc_disp_delay(Anflux,Bnflux,ltime,ltime,Anerr,Bnerr,maxtimestep,timestep,minmu,maxmu,mustep,'D_4_2',delta=delta_arr[i],output=2)
        BC_delay_d42[i],BCmud42[i],BCdispd42[i] = calc_disp_delay(Cnflux,Bnflux,ltime,ltime,Cnerr,Bnerr,maxtimestep,timestep,minmu,maxmu,mustep,'D_4_2',delta=delta_arr[i],output=2)
        BD_delay_d42[i],BDmud42[i],BDdispd42[i] = calc_disp_delay(Dnflux,Bnflux,ltime,ltime,Dnerr,Bnerr,maxtimestep,timestep,minmu,maxmu,mustep,'D_4_2',delta=delta_arr[i],output=2)
FILE = open('/home/rumbaugh/output.1.4.13.dat','w')
