...
for i in range(0,len(crdb)):
    ...
    bhdbids[i],mqdbids[i]='%02i%02i%04.1f%+03i%02i%02i'%(bhrah,bhram,bhras,bhdecd,bhdecm,int(bhdecs)),'%02i%02i%04.1f%+03i%02i%02i'%(mqrah,mqram,mqras,mqdecd,mqdecm,int(mqdecs))
    #bhdbids[i],mqdbids[i]='%02i%02i%02i%+03i%02i%02i'%(bhrah,bhram,bhras,bhdecd,bhdecm,int(bhdecs)),'%02i%02i%02i%+03i%02i%02i'%(mqrah,mqram,mqras,mqdecd,mqdecm,int(mqdecs))
    try:
