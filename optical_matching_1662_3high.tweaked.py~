...
try:
	...
	optical_cat = "/home/rumbaugh/rxj1053_rizdata.corr"
radio_cat = ""
try:
	xray_cat
except NameError:
	xray_cat = "/local3/rumbaugh/ChandraData/4936/photometry/4936.xray_phot.soft_hard_full.dat"

try:
	matching_dir
except NameError:
	matching_dir = "/local3/rumbaugh/ChandraData/4936/opt_match"
try:
	reg_dir
except NameError:
...
ra_opt = get_colvals(cr_opt,'col4')
dec_opt = get_colvals(cr_opt,'col5')
magI_opt = get_colvals(cr_opt,'col8')
