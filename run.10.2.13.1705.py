...
FILE=open('/home/rumbaugh/runs/run.10.2.13.1705.sh','w')
FILE.write("#!/bin/csh\n")
...
for date in dates:
    for source in sources:
        ...
        if source == '0414+573':
            FILE.write('rmod /mnt/data3/rumbaugh/VLA/AF377/models/prelim_fit.0414+573.5.28.01.mod')
        else:
            FILE.write('rmod /mnt/data3/rumbaugh/VLA/AF377/models/20010212_%s_g.mod\n'%(source[:4]))
