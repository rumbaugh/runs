...
loadct,13
set_plot,'PS'
device,file="/home/rumbaugh/paperstuff/logNlogSplot.overdensities.hard.5.5.11.ps",/color
...
plot,src_flux_sort,overdenseC,/xlog,xrange=[3E-15,5E-14],YRANGE=[-1,1],XTITLE="S (erg s!E-1!N cm!E-2!N)",YTITLE="Fractional Overdensity",TITLE="Cumulative Source Count Residuals - Hard Band",THICK=2,XTHICK=2,YTHICK=2,CHARSIZE=1.3,CHARTHICK=2,xstyle=1,ystyle=1
oplot,pzX,plotzero,linestyle=2
...
oplot,limitingX,limitingY,LINESTYLE=1
legend,['Composite','Cl0023','Cl1604','Cl1324','RXJ1757','RXJ1821'],PSYM=[0,7,4,2,6,5],color=[0,15,255,60,180,90],THICK=[1,2.2,2.2,2.2,2.2,2.2],SYMSIZE=[0.5,1,1,1,1,1],CHARSIZE=1.0,CHARTHICK=1.3,/bottom,box=0
