...
FILE = open('/home/rumbaugh/sim_ltcurve_testing/results/diftab.VLA_Dispgrid_%s.dat'%(date),'w')
...
for metric in dict_tmp:
    ...
    plt.savefig('/home/rumbaugh/sim_ltcurve_testing/results/plots/hist.%s.VLA_Dispgrid_%s.png'%(metric,date))
