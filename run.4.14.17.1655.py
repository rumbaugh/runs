...
crmd=np.loadtxt('/home/rumbaugh/var_database/Y3A1/max_mag_drop_DR7.old.3.23.17.dat',dtype={'names':('DBID','drop','Surv1','Surv2','S82'),'formats':('|S32','f8','|S8','|S8','i8')},skiprows=1)
