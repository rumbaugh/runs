...
ymax = [20,40,10,10,20]
device,file="/home/rumbaugh/paperstuff/clus.RSwid.6.6.11.ps",/color
...
Histoplot,rswid[hh[g[gq]]],MINVALUE=-6,MAXVALUE=2,BINSIZE=0.1,THICK=4,/oplot,/outline,histdata=hist1,locations=loc1
...
Histoplot,rswidA4,MININPUT=-7.12,MAXINPUT=2,BINSIZE=0.2,THICK=4,locations=loca4,histdata=hista4,/oplot,/outline
...
HISTOPLOT,y_RSO,BINSIZE=0.125,MININPUT=-1.375,MAXINPUT=0.5,xstyle=1,ystyle=1,/LINE_FILL,polycolor='Charcoal',datacolorname='Charcoal',spacing=0.25,orientation=-45,THICK=4,/oplot
...
g = where((z[h] le 0.96) and (z[h] ge 0.84))
rsfit = 3.182-0.063*iB
rsoffset = (F606W-F814W-rsfit)/(1.0*rsNSTD[i]*rsSTD[i])
...
HISTOPLOT,y_RSO,BINSIZE=0.5,MININPUT=-7,MAXINPUT=2,xstyle=1,ystyle=1,/LINE_FILL,polycolor='Charcoal',datacolorname='Charcoal',spacing=0.25,orientation=-45,THICK=4,/oplot
HISTOPLOT,o_RSO,BINSIZE=0.5,MININPUT=-7,MAXINPUT=2,xstyle=1,ystyle=1,datacolorname='Indian Red',THICK=8,/oplot
oplot,loca4,hista4/18.0,PSYM=10,color=60,THICK=3
legend,['All Spec. SC Sources','Cl1604,Cl0023','Cl1324,RXJ1821,RXJ1757'],color=['60','0','255'],PSYM=[0,6,6],SYMSIZE=[0.8,0.8,0.8],CHARTHICK=4,CHARSIZE=1,THICK=[2,18,18],/left
