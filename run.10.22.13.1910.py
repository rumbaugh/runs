...
FILE = open('/mnt/data2/rumbaugh/VLA/AF377/difmap_results/chisq_results_1938.10.22.13.1915.dat','w')
...
#plt.ylim(0.7,1.3)
print 'b'
plt.savefig('/home/rumbaugh/EVLA/light_curves/plots/B1938.lc_delay_plot.9.2.13.png')
#plt.close('all')
