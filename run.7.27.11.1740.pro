...
loadct,13
set_plot,'PS'
device,file="/home/rumbaugh/paperstuff/logNlogSplot.overdensities.soft.7.27.11.ps",/color
...
kti = 0
kta[kti] = interpol(N,src_flux_sort,2e-15)
kti = kti + 1
...
oplot,src_flux_sort, N,THICK=1.8,color=60
kta[kti] = interpol(N,src_flux_sort,2e-15)
kti = kti + 1

;oploy,src_flux_sort,NerrUp,THICK=3,color=60
;oploy,src_flux_sort,NerrDown,THICK=3,color=60
;oploy,CDFflux,CDFN,LINESTYLE=2,THICK=2
;oplot, COSMOS_S2, COSMOS_N, PSYM=0,LINESTYLE=5
;oploy,limitingX,limitingY,linestyle=1
sfsC = src_flux_sort
...
;oploy,pzX,plotzero,LINESTYLE=2,THICK=6
;oploy,sfs1,overdense1,PSYM=7,THICK=4,color=15,SYMSIZE=0.6;255
;oploy,sfs2,overdense2,PSYM=2,THICK=4,color=60,SYMSIZE=0.6;190
;oploy,sfs3,overdense3,PSYM=4,THICK=4,color=255,SYMSIZE=0.6;15
;oploy,sfs4,overdense4,PSYM=5,THICK=4,color=90,SYMSIZE=0.6;60
;oploy,sfs5,overdense5,PSYM=6,THICK=4,color=180,SYMSIZE=0.6;125
;oploy,limitingX,limitingY,LINESTYLE=1,THICK=4
...
;oploy,pzX,plotzero,LINESTYLE=1
;oploy,src_flux_sort,overdensey,LINESTYLE=0,THICK=2,color=250
...
sfso = src_flux_sort
;oploy,src_flux_sort,overdenseo,LINESTYLE=0,THICK=2,color=180
