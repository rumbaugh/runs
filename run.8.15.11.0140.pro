set_plot,'PS'
loadct,13
device,file='/home/rumbaugh/LumvsRS.nospectar.8.15.11.ps',/color
...
plot,[0-1],[0-1],/nodata,YRANGE=[41.5,44.5],XRANGE=[-20,10],/xstyle,/ystyle,XTITLE='RS Offsets (RS Wids)',YTITLE='Log Luminosity',TITLE=names[i] + " - Not Targeted for Spectroscopy",XTHICK=4,YTHICK=4,CHARTHICK=3 &$
...
print,names[i]   
print, '> 2s'
gtt = where((flums[g2s] gt 43.2) and (rswids[g2s] gt -6.1) and (rswids[g2s] lt -3))
if gtt[0] eq -1 then gtt = []
print,'Lum > 43.2, -6.1>C>-3: ',n_elements(gtt)
...
gtt = where((flums[g2s] gt 42.5) and (flums[g2s] lt 43.2) and (rswids[g2s] gt -6.1) and (rswids[g2s] lt -3))
if gtt[0] eq -1 then gtt = []
print,'43.2 > Lum > 42.5, -6.1>C>-3: ',n_elements(gtt)
...
print, '> 3s'
gtt = where((flums[g3s] gt 43.2) and (rswids[g3s] gt -6.1) and (rswids[g3s] lt -3))
if gtt[0] eq -1 then gtt = []
print,'Lum > 43.2, -6.1>C>-3: ',n_elements(gtt)
...
if gtt[0] eq -1 then gtt = []
print,'Lum > 43.2, -1>C>-2: ',n_elements(gtt)
gtt = where((flums[g3s] gt 42.5) and (flums[g3s] lt 43.2) and (rswids[g3s] gt -6.1) and (rswids[g3s] lt -3))
if gtt[0] eq -1 then gtt = []
print,'43.2 > Lum > 42.5, -6.1>C>-3: ',n_elements(gtt)
...
;if (i eq 2) then for j=0,n_elements(rswids)-1 do print,rsoffset[j],rswids[j],rprime[j],iprime[j],(-1*rsm[i]*iprime[j]+rsb[i]),flums[j] &$
plot,[0-1],[0-1],/nodata,YRANGE=[41.5,44.5],XRANGE=[-20,10],/xstyle,/ystyle,XTITLE='RS Offsets (RS Wids)',YTITLE='Log Luminosity',TITLE=names[i] + ' - Targeted for Spectroscopy',XTHICK=4,YTHICK=4,CHARTHICK=3 &$
...
print, '> 2s'
gtt = where((flumst[g2st] gt 43.2) and (rswidst[g2st] gt -6.1) and (rswidst[g2st] lt -3))
if gtt[0] eq -1 then gtt = []
print,'Lum > 43.2, -6.1>C>-3: ',n_elements(gtt)
...
if gtt[0] eq -1 then gtt = []
print,'Lum > 43.2, -1>C>-2: ',n_elements(gtt)
gtt = where((flumst[g2st] gt 42.5) and (flumst[g2st] lt 43.2) and (rswidst[g2st] gt -6.1) and (rswidst[g2st] lt -3))
if gtt[0] eq -1 then gtt = []
print,'43.2 > Lum > 42.5, -6.1>C>-3: ',n_elements(gtt)
...
print, '> 3s'
gtt = where((flumst[g3st] gt 43.2) and (rswidst[g3st] gt -6.1) and (rswidst[g3st] lt -3))
if gtt[0] eq -1 then gtt = []
print,'Lum > 43.2, -6.1>C>-3: ',n_elements(gtt)
...
if gtt[0] eq -1 then gtt = []
print,'Lum > 43.2, -1>C>-2: ',n_elements(gtt)
gtt = where((flumst[g3st] gt 42.5) and (flumst[g3st] lt 43.2) and (rswidst[g3st] gt -6.1) and (rswidst[g3st] lt -3))
if gtt[0] eq -1 then gtt = []
print,'43.2 > Lum > 42.5, -6.1>C>-3: ',n_elements(gtt)
...
plot,[0-1],[0-1],/nodata,YRANGE=[41.5,44.5],XRANGE=[-20,10],/xsty,/ysty,XTITLE='RS Offsets (RS Wids)',YTITLE='Log Luminosity',TITLE='All Fields - Not Targeted for Spectroscopy',XTHICK=4,YTHICK=4,CHARTHICK=3
...
print,'>2 sig'
gtemp = where((flumsYg2s gt 43.2) and (rswidsYg2s gt -6.1) and (rswidsYg2s lt -3))
if gtemp[0] eq -1 then gtemp = []
print,'Lum > 43.2, -6.1>C>-3, young: ',n_elements(gtemp)
gtemp = where((flumsOg2s gt 43.2) and (rswidsOg2s gt -6.1) and (rswidsOg2s lt -3))
if gtemp[0] eq -1 then gtemp = []
print,'Lum > 43.2, -6.1>C>-3, old: ',n_elements(gtemp)
...
gtemp = where((flumsYg2s lt 43.2) and (rswidsYg2s gt -6.1) and (rswidsYg2s lt -3))
if gtemp[0] eq -1 then gtemp = []
print,'Lum < 43.2, -6.1>C>-3, young: ',n_elements(gtemp)
gtemp = where((flumsOg2s lt 43.2) and (rswidsOg2s gt -6.1) and (rswidsOg2s lt -3))
if gtemp[0] eq -1 then gtemp = []
print,'Lum < 43.2, -6.1>C>-3, old: ',n_elements(gtemp)
...
print,'Lum < 43.2, -1>C>+2, old: ',n_elements(gtemp)
print,'>3 sig'
gtemp = where((flumsYg3s gt 43.2) and (rswidsYg3s gt -6.1) and (rswidsYg3s lt -3))
if gtemp[0] eq -1 then gtemp = []
print,'Lum > 43.2, -6.1>C>-3, young: ',n_elements(gtemp)
gtemp = where((flumsOg3s gt 43.2) and (rswidsOg3s gt -6.1) and (rswidsOg3s lt -3))
if gtemp[0] eq -1 then gtemp = []
print,'Lum > 43.2, -6.1>C>-3, old: ',n_elements(gtemp)
...
if gtemp[0] eq -1 then gtemp = []
print,'Lum > 43.2, -1>C>+2, old: ',n_elements(gtemp)
gtemp = where((flumsYg3s lt 43.2) and (rswidsYg3s gt -6.1) and (rswidsYg3s lt -3))
if gtemp[0] eq -1 then gtemp = []
print,'Lum < 43.2, -6.1>C>-3, young: ',n_elements(gtemp)
gtemp = where((flumsOg3s lt 43.2) and (rswidsOg3s gt -6.1) and (rswidsOg3s lt -3))
if gtemp[0] eq -1 then gtemp = []
print,'Lum < 43.2, -6.1>C>-3, old: ',n_elements(gtemp)
...
plot,[0-1],[0-1],/nodata,YRANGE=[41.5,44.5],XRANGE=[-20,10],/xsty,/ysty,XTITLE='RS Offsets (RS Wids)',YTITLE='Log Luminosity',TITLE='All Fields - Targeted for Spectroscopy',XTHICK=4,YTHICK=4,CHARTHICK=3
...
print,'>2 sig'
gtemp = where((flumsYg2st gt 43.2) and (rswidsYg2st gt -6.1) and (rswidsYg2st lt -3))
if gtemp[0] eq -1 then gtemp = []
print,'Lum > 43.2, -6.1>C>-3, young: ',n_elements(gtemp)
gtemp = where((flumsOg2st gt 43.2) and (rswidsOg2st gt -6.1) and (rswidsOg2st lt -3))
if gtemp[0] eq -1 then gtemp = []
print,'Lum > 43.2, -6.1>C>-3, old: ',n_elements(gtemp)
...
if gtemp[0] eq -1 then gtemp = []
print,'Lum > 43.2, -1>C>+2, old: ',n_elements(gtemp)
gtemp = where((flumsYg2st lt 43.2) and (rswidsYg2st gt -6.1) and (rswidsYg2st lt -3))
if gtemp[0] eq -1 then gtemp = []
print,'Lum < 43.2, -6.1>C>-3, young: ',n_elements(gtemp)
gtemp = where((flumsOg2st lt 43.2) and (rswidsOg2st gt -6.1) and (rswidsOg2st lt -3))
if gtemp[0] eq -1 then gtemp = []
print,'Lum < 43.2, -6.1>C>-3, old: ',n_elements(gtemp)
...
print,'Lum < 43.2, -1>C>+2, old: ',n_elements(gtemp)
print,'>3 sig'
gtemp = where((flumsYg3st gt 43.2) and (rswidsYg3st gt -6.1) and (rswidsYg3st lt -3))
if gtemp[0] eq -1 then gtemp = []
print,'Lum > 43.2, -6.1>C>-3, young: ',n_elements(gtemp)
gtemp = where((flumsOg3st gt 43.2) and (rswidsOg3st gt -6.1) and (rswidsOg3st lt -3))
if gtemp[0] eq -1 then gtemp = []
print,'Lum > 43.2, -6.1>C>-3, old: ',n_elements(gtemp)
...
if gtemp[0] eq -1 then gtemp = []
print,'Lum > 43.2, -1>C>+2, old: ',n_elements(gtemp)
gtemp = where((flumsYg3st lt 43.2) and (rswidsYg3st gt -6.1) and (rswidsYg3st lt -3))
if gtemp[0] eq -1 then gtemp = []
print,'Lum < 43.2, -6.1>C>-3, young: ',n_elements(gtemp)
gtemp = where((flumsOg3st lt 43.2) and (rswidsOg3st gt -6.1) and (rswidsOg3st lt -3))
if gtemp[0] eq -1 then gtemp = []
print,'Lum < 43.2, -6.1>C>-3, old: ',n_elements(gtemp)
