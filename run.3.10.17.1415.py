...
np.savetxt('/home/rumbaugh/radecname_forDEScutouts.3.10.17.csv',outcr,fmt='%f,%f,%s_DEScutout')
np.savetxt('/home/rumbaugh/radec_forDEScutouts.3.10.17.csv',outcr_radec,fmt='%f,%f')
...
np.savetxt('/home/rumbaugh/radecname_forSDSScutouts.3.10.17.csv',outcr,fmt='%f,%f,%s_SDSScutout')
np.savetxt('/home/rumbaugh/radec_forSDSScutouts.3.10.17.csv',outcr_radec,fmt='%f,%f')
