...
t_grid = None
ttmp,mtmp,BA_disp,nefft = chi_squared_min_delays(Aflux[g],Bflux[g],ltime[g],ltime[g],Aerr[g],Berr[g],None,maxtimestep,timestep,minmu,maxmu,mustep,smooth_function='boxcar',smooth_param=np.array([10.]),use_overlap_mean=True,outfile='/home/rumbaugh/EVLA/light_curves/Dispersions/test.Chisq_grid_out.%s.1.20.14.dat'%lens,dotime=True,use_cov_matrix=True)
