...
set_plot,'PS'
loadct,'13'
;device,file="/home/rumbaugh/XrayLums.5.21.11.ps",/color
totalslum = []
totalhlum = []
yslum = []
yhlum = []
...
for i=0,4 do begin &$
   ...
   slum = alog10(slum)+42  &$
   hlum = alog10(hlum)+42 &$
   flum = alog10(10^(slum-42)+10^(hlum-42))+42 &$
   for j=0,n_elements(gic)-1 do print,sz[gic[j]],sra[gic[j]],sdec[gic[j]],10^(slum[gic[j]]-42),10^(hlum[gic[j]]-42),10^(flum[gic[j]]-42) &$
...
;legend,['Cl1604,Cl0023','Cl1324,NEP5281,NEP200'],color=['255','70']
;Histoplot,yflum,BINSIZE=0.25,MININPUT=41,MAXINPUT=45,TITLE="Comparison - Full Band",datacolorname='Royal Blue',/LINE_FILL,THICK=4,POLYCOLOR='Royal Blue',ORIENTATION=45,spacing=0.25,/oplot
;Histoplot,oflum,BINSIZE=0.25,MININPUT=41,MAXINPUT=45,TITLE="Comparison - Full Band",THICK=8,/oplot
;legend,['Cl1604,Cl0023','Cl1324,RXJ1821,RXJ1757'],color=['70','255'],PSYM=[6,6],SYMSIZE=[0.8,0.8],CHARTHICK=4,CHARSIZE=1,THICK=18,/right
end
