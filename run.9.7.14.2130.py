...
try:
    ...
    ylimits = None
nbins = 20
FILE = open('/home/rumbaugh/EVLA/light_curves/fit_output.strucfunc_VLA.norm.nbins_%i.tau_gtr_%i.%s.dat'%(nbins,tau_gtr_than,date),'w')
