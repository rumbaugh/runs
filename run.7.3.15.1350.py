...
figure(25)
clf()
scatter(taus[avg_fwidth!=0]/avg_fwidth[avg_fwidth!=0],np.abs(medtau[avg_fwidth!=0]-taus[avg_fwidth!=0]),s=8)
#g=np.where(taus[avg_fwidth!=0]/avg_fwidth[avg_fwidth!=0]<3.502)[0]
#scatter(taus[avg_fwidth!=0][g]/avg_fwidth[avg_fwidth!=0][g],np.abs(medtau[avg_fwidth!=0][g]-taus[avg_fwidth!=0][g]),s=8,color='red')
#scatter(taus[avg_fwidth!=0]/avg_fwidth[avg_fwidth!=0],np.abs(medtau[avg_fwidth!=0]-taus[avg_fwidth!=0]),s=8)
g=np.where(medtau[avg_fwidth!=0]<3.502*avg_fwidth[avg_fwidth!=0])[0]
if len(g)>0:scatter(taus[avg_fwidth!=0][g]/avg_fwidth[avg_fwidth!=0][g],np.abs(medtau[avg_fwidth!=0][g]-taus[avg_fwidth!=0][g]),s=8,color='red')
axvline(3.502,color='magenta',ls='dashed',lw=2)
...
figure(29)
clf()
scatter(taus[avg_fwidth!=0]/avg_fwidth[avg_fwidth!=0],medtau[avg_fwidth!=0]-taus[avg_fwidth!=0],s=8)
g=np.where(medtau[avg_fwidth!=0]<3.502*avg_fwidth[avg_fwidth!=0])[0]
if len(g)>0:scatter(taus[avg_fwidth!=0][g]/avg_fwidth[avg_fwidth!=0][g],medtau[avg_fwidth!=0][g]-taus[avg_fwidth!=0][g],s=8,color='red')
...
figure(26)
clf()
scatter(taus[avg_fwidth!=0]/avg_fwidth[avg_fwidth!=0],np.abs(cliptau[avg_fwidth!=0]-taus[avg_fwidth!=0]),s=8)
g=np.where(cliptau[avg_fwidth!=0]<3.502*avg_fwidth[avg_fwidth!=0])[0]
if len(g)>0:scatter(taus[avg_fwidth!=0][g]/avg_fwidth[avg_fwidth!=0][g],np.abs(cliptau[avg_fwidth!=0][g]-taus[avg_fwidth!=0][g]),s=8,color='red')
axvline(3.502,color='cyan',ls='dashed',lw=2)
xlabel('Normalized True Delay (Flare widths)')
