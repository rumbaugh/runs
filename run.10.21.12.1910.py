...
for i in range(0,len(names)):
    ...
    pylab.errorbar(ann_arr-ann_step*0.5,SB_arr,SB_err_arr,fmt='ro',lw=2,capsize=3,mew=1,ms=8)
    pylab.scatter(ann_arr-ann_step*0.5,SB_arr,s=5)
    pylab.savefig('/home/rumbaugh/DE_counts_profile.%s.10.21.12.png'%names[i])
    pylab.close()
