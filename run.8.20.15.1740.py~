...
for i in np.arange(len(b0737_list)): b0737_list[i] = '/home/rumbaugh/KAST/Science/spec.b%s.dat'%b0737_list[i]
for i in np.arange(len(r0737_list)): r0737_list[i] = '/home/rumbaugh/KAST/Science/spec.r%s.dat'%r0737_list[i]
...
combine_spectra(b0737_list,'/home/rumbaugh/KAST/Science/comb_spec.0737_blue_2.19.dat')
combine_spectra(r0737_list,'/home/rumbaugh/KAST/Science/comb_spec.0737_red_2.19.dat')
