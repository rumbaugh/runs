...
FILE=open('/home/rumbaugh/runs/run.5.23.14.1646.sh','w')
FILE.write("#!/bin/csh\n")
...
for date,aipsdate in zip(dates,aips_dates):
    ...
    for source in tsources:
        ...
        FILE.write('rmod /mnt/data2/rumbaugh/VLA/AF377/models/comp_fit_med_0414+534_g.mod\n')
        #FILE.write('rmod /mnt/data2/rumbaugh/EVLA/11A-138/scripts/model.0414.wgauss2.5.20.14.mod\n')
        FILE.write(fit_string)
        outfile = '/mnt/data2/rumbaugh/VLA/AF377/difmap_results/fit_aipsredux_UVT_newpos_med_5.23.14.%s.fixpos.%s.mod'%(source,date)
        FILE.write('wmod %s\n'%outfile)
