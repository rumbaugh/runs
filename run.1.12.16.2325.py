...
for band in ['soft','hard','full']:
    ...
    title('%s Band'%band)
    savefig('/home/rumbaugh/Chandra/plots/pipeline_comparison_oldphotcats.%s_netcounts.%s.png'%(band,date))
    ...
    title('%s Band'%band)
    savefig('/home/rumbaugh/Chandra/plots/pipeline_comparison_oldphotcats.%s_flux.%s.png'%(band,date))
