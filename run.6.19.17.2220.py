...
for i in range(0,len(outcr)-2):
    ...
    #else:
    #    redux='v5_7_0'
    outcr[i+2]='wget https://dr12.sdss.org/sas/dr12/sdss/spectro/redux/%s/spectra/%04i/spec-%04i-%05i-%04i.fits'%(indf.run2d.values[i].strip(),indf.plate.values[i],indf.plate.values[i],indf.mjd.values[i],indf.fiberid.values[i])
