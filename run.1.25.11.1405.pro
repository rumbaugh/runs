...
device,file="/home/rumbaugh/LFC/analysis/RSoffset.plot_comb.1.25.11.ps",/color

plot,[0,1],[0,1],/nodata,TITLE="AGN Red Sequence Offset",XTITLE="i'-Band Magnitude",YTITLE="RS Offset",XRANGE=[17,27],YRANGE=[-3,3],xstyle=1,ystyle=1
...
;oplot,iprime,rsoffset,"0023",PSYM=3,THICK=2,SYMSIZE=0.1
...
rsfit = 1.777-0.0229*iprime-3*0.0625
rsoffset = rprime-iprime-rsfit
g = where((0.856 ge rs) and (rs ge 0.82))
oplot,iprime[g],rsoffset[g],PSYM=2,THICK=2,SYMSIZE=0.1,color=250
g = where((0.856 ge z) and (z ge 0.82))
rsfit = 1.777-0.0229*iB-3*0.0625
rsoffset = rB-iB-rsfit
oplot,iB[g],rsoffset[g],PSYM=4,THICK=2,SYMSIZE=1,color=80
...
rsoffset = rprime-iprime-rsfit
;plot,iprime,rsoffset,"1324",PSYM=3,THICK=2,SYMSIZE=1.7
...
rsfit = 1.325-0.0084*iprime-3*0.0735
rsoffset = rprime-iprime-rsfit
oplot,iprime[g],rsoffset[g],PSYM=2,SYMSIZE=0.1,THICK=2,color=250
g = where((0.785 ge z) and (z ge 0.67))
rsfit = 1.325-0.0084*iB-3*0.0735
rsoffset = rB-iB-rsfit
...
rsoffset = rprime-iprime-rsfit
;plot,iprime,rsoffset,"NEP200",PSYM=3,THICK=2,SYMSIZE=1.7
...
rsoffset = rprime-iprime-rsfit
;plot,iprime,rsoffset,"NEP5281",PSYM=3,THICK=2,SYMSIZE=1.7
...
rsfit = 1.48-0.012*iprime-3*0.0636
rsoffset = rprime-iprime-rsfit
oplot,iprime[g],rsoffset[g],PSYM=2,SYMSIZE=0.1,THICK=2,color=250
g = where((0.828 ge z) and (z ge 0.808))
rsfit = 1.48-0.012*iB-3*0.0636
rsoffset = rB-iB-rsfit
oplot,iB[g],rsoffset[g],PSYM=6,THICK=2,SYMSIZE=1,color=180
...
rsoffset = rprime-iprime-rsfit
;plot,iprime,rsoffset,"1604 - LFC only",PSYM=3,THICK=2,SYMSIZE=1.7
...
rsfit = 1.305-0.00485*iprime-2*0.0813
rsoffset = rprime-iprime-rsfit
oplot,iprime[g],rsoffset[g],PSYM=2,SYMSIZE=0.1,THICK=2,color=250
g = where((0.96 ge z) and (z ge 0.84))
rsfit = 1.305-0.00485*iB-2*0.0813
rsoffset = rB-iB-rsfit
oplot,iB[g],rsoffset[g],PSYM=4,THICK=2,SYMSIZE=1,color=80
;yl = 1.305-0.00485*xl
yl = -2*0.0813*[1,1,1]
...
;plot,f814[hh],rsoffset[hh],"1604 - ACS only",XTITLE="F814W Magnitude",YTITLE="F606W-F814W",PSYM=3,XRANGE=[17,27],YRANGE=[-3,3],xstyle=1,ystyle=1
...
yl = -2*0.0907*[1,1,1]
;;oplot,xl,yl,linestyle=3,thick=1.7
legend,['1604+0023','1324+NEP'],PSYM=[4,6],colors=[80,250]
