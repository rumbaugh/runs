...
np.savetxt('/home/rumbaugh/Chandra/ORELSE.BCGS.6.26.17.dat',outcr,header='field cluster BCGra BCGdec BCG_Mred BCGcol BCGrso BCGz allBCGra allBCGdec allBCG_Mred allBCGcol allBCGrso allBCGz',fmt='%20s %20s %f %f %f %f %f %f %f %f %f %f %f %f')
psfpdf.close()
