...
np.savetxt('/home/rumbaugh/var_database/Y3A1/imagestamps/DR7_DESimagestamp_index.4.15.17.dat',outcr,header='DatabaseID RA DEC TILE FILENAME',fmt='%s %f %f %s %s')
crin=np.loadtxt('/home/rumbaugh/var_database/Y3A1/imagestamps/DR7_DESimagestamp_index.4.15.17.dat',dtype={'names':('DBID','ra','dec','tile','fname'),'formats':('|S32','f8','f8','|S12','|S25')},skiprows=1)
