...
outcr['DBID'],outcr['DBIDS'],outcr['MQ_ROWNUM'],outcr['SP_ROWNUM'],outcr['SDRyID'],outcr['SDSSNAME'],outcr['COADD_OBJECTS_ID'],outcr['TILENAME']=primDBID,DBIDs,crmi['MQ_ROWNUM'],crmi['SP_ROWNUM'],sdr7ids,crmi['SDSSNAME'],crmi['COADD_OBJECTS_ID'],crmi['TILENAME']
