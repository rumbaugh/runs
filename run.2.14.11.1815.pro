...
set_plot,'PS'
loadct,'13'
device,file="/home/rumbaugh/XrayLums.3.10.11.ps",/color
totalslum = []
totalhlum = []
yslum = []
yhlum = []
...
;legend,['Cl1604,Cl0023','Cl1324,NEP5281,NEP200'],color=['255','70']
Histoplot,oflum,BINSIZE=0.25,MININPUT=41,MAXINPUT=45,TITLE="Comparison - Full Band",datacolorname='Royal Blue',/LINE_FILL,POLYCOLOR='Royal Blue',ORIENTATION=45,/oplot
Histoplot,yflum,BINSIZE=0.25,MININPUT=41,MAXINPUT=45,TITLE="Comparison - Full Band",THICK=4,/oplot
legend,['Cl1604,Cl0023','Cl1324,NEP5281,NEP200'],color=['255','70'],PSYM=[6,6],SYMSIZE=[0.8,0.8],CHARTHICK=2,CHARSIZE=1,THICK=18,/right
end
