...
for i in range(0,1):
    ...
    py.savefig('/home/rumbaugh/B1608_files/B1608.emcee_output_hist_tau.B%s_delay.3.22.13.ps'%lens2_names[i])
    py.close()
    py.plot(sampler.flatchain[:,1])
    py.savefig('/home/rumbaugh/B1608_files/B1608.emcee_output_chain_plot_mu1.B%s_delay.3.22.13.ps'%lens2_names[i])
    py.close()
    py.plot(sampler.flatchain[:,2])
    py.savefig('/home/rumbaugh/B1608_files/B1608.emcee_output_chain_plot_mu2.B%s_delay.3.22.13.ps'%lens2_names[i])
    py.close()
    py.plot(sampler.flatchain[:,3])
    py.savefig('/home/rumbaugh/B1608_files/B1608.emcee_output_chain_plot_mu3.B%s_delay.3.22.13.ps'%lens2_names[i])
    py.close()
    py.plot(sampler.flatchain[:,0])
    py.savefig('/home/rumbaugh/B1608_files/B1608.emcee_output_chain_plot_tau.B%s_delay.3.22.13.ps'%lens2_names[i])
    py.close()
