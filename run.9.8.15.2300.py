...
for i in np.arange(0,ntrials):
    ...
    plt.savefig('/home/rumbaugh/Fermi/plots/testlightcurve_%i_notau.%s.png'%(i+1,date))
    FILE=open('/home/rumbaugh/Fermi/data/test/testlightcurve_%i_notau.%s.dat'%(i+1,date),'w')
    FILEA=open('/home/rumbaugh/Fermi/data/test/testlightcurve_%i_A_notau.%s.dat'%(i+1,date),'w')
    FILEB=open('/home/rumbaugh/Fermi/data/test/testlightcurve_%i_B_notau.%s.dat'%(i+1,date),'w')
    ...
    np.savetxt('/home/rumbaugh/Fermi/data/test/testlightcurve_%i_notau.flare_params_truthvalues.%s.dat'%(i+1,date),arr,fmt='%f %f %f %f %f')
