...
for img in range(0,3):
    ...
    plt.axhline(y=np.mean(S),lw=2,ls='dashed',color='k')
...
plt.legend(testlegs,('C','B','A'),loc=1)
#plt.legend(loc=2)
...
plt.ylim(0.8,1.35)
plt.xlim(-19,266)
plt.savefig('/home/rumbaugh/EVLA/light_curves/plots/B1938.lc_norm_plot_offset_conformed_x.%s.png'%date)
plt.close('all')
