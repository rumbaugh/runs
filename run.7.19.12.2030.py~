...
for i in range(0,len(names)):
    ...
    pylab.scatter([BCGRA[i]],[BCGDec[i]],marker='x',edgecolors='blue',s=300,lw=4)
    pylab.scatter([centerRAs[i]],[centerDecs[i]],marker='s',edgecolors=html_brwn,facecolors='none',s=300,lw=4)
    pylab.scatter([RGalPeakRA[i]],[RGalPeakDec[i]],marker='d',edgecolors=html_purp,facecolors='none',s=300,lw=4)
    pylab.savefig('/home/rumbaugh/DSplot.%s.6.1.12.png'%(names[i]))
    pylab.close('all')
    #print 'd'
    #nep5281newcnt = 0
