...
FILEN = open('/home/rumbaugh/temp.powrat.2.15.12.dat','w')
for i in range(0,6):
    if i < len(names)-2.1:
...
pylab.xlim(10**-8,10**-4)
pylab.ylim(10**-8,10**-4)
...
#pylab.savefig('/home/rumbaugh/powerratios.p2vp3.0.5_mpc.2.13.12.png')
pylab.close('all')
...
pylab.title('Power Ratios within 0.5 Mpc')
#pylab.savefig('/home/rumbaugh/powerratios.p2vp4.0.5_mpc.2.13.12.png')
pylab.close('all')
...
pylab.ylabel('P$_4$/P$_0$')
pylab.title('Power Ratios within 0.5 Mpc')
#pylab.savefig('/home/rumbaugh/powerratios.p3vp4.0.5_mpc.2.13.12.png')
pylab.close('all')
...
#pylab.savefig('/home/rumbaugh/powerratios.p2vp3.0.25_mpc.2.13.12.png')
pylab.close('all')
...
pylab.ylabel('P$_4$/P$_0$')
pylab.title('Power Ratios within 0.25 Mpc')
#pylab.savefig('/home/rumbaugh/powerratios.p2vp4.0.25_mpc.2.13.12.png')
pylab.close('all')
...
pylab.ylabel('P$_4$/P$_0$')
pylab.title('Power Ratios within 0.25 Mpc')
#pylab.savefig('/home/rumbaugh/powerratios.p3vp4.0.25_mpc.2.13.12.png')
pylab.close('all')
FILEN.close()
