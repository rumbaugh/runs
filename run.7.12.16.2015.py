...
FILE=open('/home/rumbaugh/Chandra/lums_newphotoz_adam.1sig.7.8.16.dat','w')
FILE.write('# ID RA Dec z_peak nh lum_soft lum_hard lum_full\n')
cr=np.loadtxt('/home/rumbaugh/Chandra/fluxes_newphotoz_adam.1sig.7.8.16.dat',dtype={'names':('field','ID','RA','Dec','z_peak','nh','flux_soft','flux_hard','flux_full','P_inclus'),'formats':('|S24','i8','f8','f8','f8','f8','f8','f8','f8','f8')})
