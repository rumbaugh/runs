...
try: 
	...
	Ra_aim = 132.22891419571
try:
	Dec_aim
except NameError:
	Dec_aim = 44.909781269683

try:
	optical_cat
except NameError:
	optical_cat = "/home/rumbaugh/ORELSE/opt_cats/cl0849_rizdata.corr"

radio_cat = ""
try:
	xray_cat
except NameError:
	xray_cat = "/home/rumbaugh/ChandraData/0849/master/photometry/927+1708.xray_phot.soft_hard_full.dat"

try:
	matching_dir
except NameError:
	matching_dir = "/home/rumbaugh/ChandraData/0849/master/opt_match"
try:
	reg_dir
except NameError:
