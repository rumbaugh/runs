...
psfpdf=bpdf.PdfPages('/home/rumbaugh/Chandra/plots/Lum_lim.5.10.16.pdf')
...
for field,ifld in zip(targets,np.arange(0,len(targets))): 
    if field=='cl1324':
        ...
        crxy1=np.loadtxt('/home/rumbaugh/Chandra/ImperialPipeline/ORELSE/%s/proc/%s/XYout_%s.3.12.16.dat'%('cl1324_north','cl1324_north',band))
        crxy2=np.loadtxt('/home/rumbaugh/Chandra/ImperialPipeline/ORELSE/%s/proc/%s/XYout_%s.3.12.16.dat'%('cl1324_south','cl1324_south',band))
        crxy=np.append(crxy1,crxy2,axis=0)
        crxyspec1=np.loadtxt('/home/rumbaugh/Chandra/ImperialPipeline/ORELSE/%s/proc/%s/%s_XY_speccoords.dat'%('cl1324_north','cl1324_north','cl1324_north'))
        crxyspec2=np.loadtxt('/home/rumbaugh/Chandra/ImperialPipeline/ORELSE/%s/proc/%s/%s_XY_speccoords.dat'%('cl1324_south','cl1324_south','cl1324_south'))
        crxyspec=np.append(crxyspec1,crxyspec2,axis=0)
    else:
        crLum=np.loadtxt('/home/rumbaugh/Chandra/ImperialPipeline/ORELSE/%s/proc/%s/%s_lim_lums.5.3.16.dat'%(field,field,field))
        crxy=np.loadtxt('/home/rumbaugh/Chandra/ImperialPipeline/ORELSE/%s/proc/%s/XYout_%s.3.12.16.dat'%(field,field,band))
        crxyspec=np.loadtxt('/home/rumbaugh/Chandra/ImperialPipeline/ORELSE/%s/proc/%s/%s_XY_speccoords.dat'%(field,field,field))
    sHull,sEdges=ConcaveHull(crxyspec,alpha)
    gCH=CheckPoints(sHull,crxy[:,1],crxy[:,2])
    crLum[not(gCH)]=0
