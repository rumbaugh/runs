...
#        FILEA.write('%s & %2i & %2i\\ %2i\\ %4.1f & +%2i\\ %2i\\ %2i & %5.3f\\\\ \n'%(names[i],argcnt,rahA[jj],ramA[jj],rasA[jj],decdA[jj],decmA[jj],decsA[jj],zA[jj]))
    ...
    for j in range(0,len(gmsz)):
        ...
        if ((i == 2) & ((j == 2) | (j == 6) | (j == 5) | (j == 0) | (j == 4))):
            ...
            if j == 2: pylab.text(msRA[gmsq[gmsz[gzsort[j]]]]+0.006,msDec[gmsq[gmsz[gzsort[j]]]]+0.005,AGNstr,color='red',weight='extra bold',size=16)
            ...
            #Cl1324
            #AGNstr = str(j)
            if j == 0: pylab.text(msRA[gmsq[gmsz[gzsort[j]]]]+0.003,msDec[gmsq[gmsz[gzsort[j]]]]+0.005,AGNstr,color='red',weight='extra bold',size=16)
            ...
            if j == 5: pylab.text(msRA[gmsq[gmsz[gzsort[j]]]]+0.027,msDec[gmsq[gmsz[gzsort[j]]]]-0.011,AGNstr,color='red',weight='extra bold',size=16)
        elif i == 3:
            #Cl1604
            if j == 1:
                pylab.text(msRA[gmsq[gmsz[gzsort[j]]]]+0.015,msDec[gmsq[gmsz[gzsort[j]]]]-0.006,AGNstr,color='red',weight='extra bold',size=16)
            elif (j == 9):
                pylab.text(msRA[gmsq[gmsz[gzsort[j]]]]+0.025,msDec[gmsq[gmsz[gzsort[j]]]]-0.007,AGNstr,color='red',weight='extra bold',size=16)  
            elif (j == 2):
                pylab.text(msRA[gmsq[gmsz[gzsort[j]]]]-0.005,msDec[gmsq[gmsz[gzsort[j]]]]-0.009,AGNstr,color='red',weight='extra bold',size=16) 
            elif (j == 4):
    ...
    savfile = '/home/rumbaugh/paperstuff/AGN.spatmap.color.%s.6.27.11.png'%(names[i])
