...
crl=np.loadtxt('/home/rumbaugh/Chandra/ORELSE.clusters_lums.dat',dtype={'names':('field','cluster','ls','lh','lf','lserr','lherr','lferr'),'formats':('|S24','|S24','f8','f8','f8','f8','f8','f8')})
...
for i in range(0,len(ls500)):
    FILE.write('%12s %12s %E %E %E %E %E %E %E %E %E %E %E %E %E %E\n'%(crl['field'][i],crl['cluster'][i],crl['ls'][i],crl['lh'][i],crl['lf'][i],ls500[i],lh500[i],lf500[i],bolfact*lf500[i],crl['lserr'][i],crl['lherr'][i],crl['lferr'][i],ls500err[i],lh500err[i],lf500err[i],bolfact*lf500err[i]))
FILE.close()
