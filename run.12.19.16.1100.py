...
def plot_lightcurve(dbid,mjd,mag,magerr,bands,survey,plotSDSS=False,fname=None,DESfname=None,connectpoints=True,specfile=None):
...
for DBID in good_dbids:
    ...
    plot_lightcurve(DBID,mjd,mag,magerr,bands,survey,plotSDSS=False,specfile=specfile)
