set_dirs
set_plot,'PS'
device,file='/home/rumbaugh/paperstuff/CapODPlotOverPlot.4.30.11.ps',/color
loadct,13
...
plotsym,4,FILL=1
oploterror,zMe[5],k0kref[5],k0kreferr[5],PSYM=8,color=100,SYMSIZE=1,THICK=2
oplot,zMe[5:5],k0kref[5:5],PSYM=8,color=100,SYMSIZE=1.8,THICK=1

LEGEND,['Fields from Cappeluti et al. 2005','Our fields','5-field composite'],PSYM=[4,6,8],COLOR=[30,250,100],SYMSIZE=[1.2,0.7,1.3],THICK=[1.5,17,1],/right_legend,/bottom
