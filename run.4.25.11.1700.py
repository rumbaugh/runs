...
for i in range(0,len(sigma)):
    ...
    abs1.nh = 0.0
    fake_pha(1,get_arf(),get_rmf(),time)
    eflx2 = calc_energy_flux(0.5/rsarr[i],8.0/rsarr[i])
    ...
    lums[i] = flux*4*m.pi*lumdistmod[i]**2*10**5
    lumerr[i] = ferr*4*m.pi*lumdistmod[i]**2*10**5
    #lums in units of 10^43 ergs/s
FILE=open('/home/rumbaugh/paperstuff/clus.xlums.4.25.11.dat','w')
