...
plt.savefig('/home/rumbaugh/LFC_color_param/rizmag_vs_redshift.3.8.16.png')
plt.figure(2)
plt.clf()
plt.rc('axes',linewidth=2)
plt.fontsize = 14
...
plt.savefig('/home/rumbaugh/LFC_color_param/rizcolor_vs_redshift.3.8.16.png')
plt.figure(3)
plt.clf()
plt.rc('axes',linewidth=2)
plt.fontsize = 14
...
plt.savefig('/home/rumbaugh/LFC_color_param/supercolorRF_vs_redshift.3.8.16.png')
plt.figure(4)
plt.clf()
plt.rc('axes',linewidth=2)
plt.fontsize = 14
...
plt.xlim(0.66,1.2)
plt.legend(loc=7)
plt.savefig('/home/rumbaugh/LFC_color_param/supercolor_coeff.3.8.16.png')
