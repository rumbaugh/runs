...
def reviewresults(pair,ldate='4.20.15',ddate='6.3.14',cbase='/home/rumbaugh/Fermi/TimeBombs/output/',showresults=True,ntrials=10000,testplot=False,errstd=np.sqrt(2)*5,T='ACFT'):
    ...
    PPMC(T,posteriorFile,DataFile,ntrials,plotfile='/home/rumbaugh/Fermi/TimeBombs/plots/PPMC_%s_testlightcurve_%i.tau_%.2f.mu_%.3f.%s.png'%(T,pair,tau,mu,date),figN=7,testplot=testplot,errstd=errstd)
