...
#FILE = open('/mnt/data2/rumbaugh/VLA/AF377/difmap_results/chisq_results_Aconfig2.8.14.14.dat','w')
...
for lens in lens_dict:
    ...
    for img in range(0,nimg):
        ...
        print '%5s %i - %f'%(lens,img,np.mean(S[g]))
...
#for img in range(0,4):
#    FILE.write("%3s %7.2f %7.3f %6.4f "%(imgarr[img],chisq_arr[img],chisq_arr[img]/len(CSOnorm),prob_arr[img]))
#FILE.close()
