...
rdfloat, "acis6933+7343.img.500-2000.nops.bin64.dat", xN, yN, countsN
rdfloat, "acis6933+7343.bin64.offaxis_angle.dat", x_thetaN, y_thetaN, thetaN
...
rdfloat, "../6932/acis6932.img.500-2000.nops.bin64.dat", xS, yS, countsS
rdfloat, "../6932/acis6932.bin64.offaxis_angle.dat", x_thetaS, y_thetaS, thetaS
...
rdfloat, "acis6933+7343.expmap_soft.bin64.dat", x_expN, y_expN, exp_mapN
rdfloat, "../6932/acis6932.expmap_soft.bin64.dat", x_expS, y_expS, exp_mapS
...
lnlum = alog10(fluxt)+57+alog10(1.987)-2*alog10(0.7)
lum = (lnlum-42)
...
photcat2 = '../6932/stats.radec_netcntscor_netcnts_cnts_sig_flux.soft.dat'
...
ploterror, src_flux_sort, N,Nerr, /xlog, /ylog, psym=7,xrange=[6E-16,3E-14],yrange=[30,2000],XTITLE="S (erg s!E-1!N cm!E-2!N)", YTITLE = "N(>S) (deg!E-2!N)", TITLE = "Cl1604 North+South - Soft Band (0.5-2.0 keV)",/ysty,/xsty

;; Optional Output
;openw, 1, "src_flux_sort.N_sort.Nerr.Cl1604.soft.lst"
