...
q2='SELECT f.RA_CENT,f.DEC_CENT,f.RAC1,f.RAC2,f.RAC3,f.RAC4,f.DECC1,f.DECC2,f.DECC3,f.DECC4,f.ID,d.TILENAME FROM RUMBAUGH.Y3A1_TILENAMES_LIST d,DES_ADMIN.COADDTILE_GEOM f WHERE d.tilename=f.tilename'
...
np.savetxt('/home/rumbaugh/milliquas_Y3A1_tilenames.csv',outcr,fmt='%s,%s,%s,%s',header='MQ_ROWNUM,RA,DEC,TILENAME',comments='')
