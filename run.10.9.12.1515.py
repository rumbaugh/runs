...
for i in range(0,1):
    ...
    for j in range(9,10):
        ...
        print_window("/home/rumbaugh/chips.plot.NEP5281_model_fit.ungrouped.bkg.10.9.12.ps")
        ...
        projection(2)
        plot_fit(2)
        print_window("/home/rumbaugh/chips.plot.NEP5281_model_fit.ungrouped.src.10.9.12.ps")
