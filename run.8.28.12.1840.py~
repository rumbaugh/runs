...
while ((i < 13) & (endloop < 0.5)):
    ...
    if ((i != 13) & (i != 6) & (i != 14) & (i != 16)): 
        ...
        if counter > 1:
            counter = 0
            concat(vis=visarr2,concatvis='/local3/rumbaugh/EVLA/data/11A-138/temp.concat%i.ms'%(counter2+1))
            visarr2 = np.array(['aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa','aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa'])
            counter2 += 1
            if counter2 > 1:
                counter3 += 1
                concat(vis=['/local3/rumbaugh/EVLA/data/11A-138/temp.concat1.ms','/local3/rumbaugh/EVLA/data/11A-138/temp.concat2.ms'],concatvis = '/local3/rumbaugh/EVLA/data/11A-138/temp.concat_concat%i.ms'%counter3)
                counter2 = 0
                rm -rf /local3/rumbaugh/EVLA/data/11A-138/temp.concat1.ms/
                rm -rf /local3/rumbaugh/EVLA/data/11A-138/temp.concat2.ms/
