...
print KStest(lA,np.concatenate((lB,lC,lD)))
print KStest(lB,np.concatenate((lA,lC,lD)))
print KStest(lB,np.concatenate((lA,lD)))
print KStest(lB,lA)
print KStest(lC,np.concatenate((lB,lA,lD)))
print KStest(lD,np.concatenate((lB,lC,lA)))
