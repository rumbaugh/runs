...
#        sI = get_colvals(crs,'col18')
        ...
        if len(gCtmp) > 0: 
            ...
            for iI in range(0,4):
                ...
                if len(gItmp) > 0: 
                    ...
                    print "Tot. good spec. in Col reg. %i, Mag reg. %i: %i"%(iC,iI,len(gItmp))
                else:
    ...
    savname = '/home/rumbaugh/paperstuff/CMD.%s.completeness.rad_%3.1f.5.25.11.png'%(names[i],cradmult)
