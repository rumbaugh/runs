...
for i in range(0,5):
    ...
    for j in range(0,len(gmsz)):
        ...
        AGNstr = str(1+j)
        if ((i == 1) & ((j == 1) | (j == 4))):
            if j == 1: pylab.text(msRA[gmsq[gmsz[gzsort[j]]]]-0.004,msDec[gmsq[gmsz[gzsort[j]]]]-0.013,AGNstr,color='red',weight='extra bold')
            if j == 4: pylab.text(msRA[gmsq[gmsz[gzsort[j]]]]+0.022,msDec[gmsq[gmsz[gzsort[j]]]]-0.006,AGNstr,color='red',weight='extra bold')
        if i == 3:
            if j == 1:
                pylab.text(msRA[gmsq[gmsz[gzsort[j]]]]+0.01,msDec[gmsq[gmsz[gzsort[j]]]]+0.003,AGNstr,color='red',weight='extra bold')
            elif (j == 9):
                pylab.text(msRA[gmsq[gmsz[gzsort[j]]]]+0.022,msDec[gmsq[gmsz[gzsort[j]]]]-0.013,AGNstr,color='red',weight='extra bold')  
            elif (j == 2):
                pylab.text(msRA[gmsq[gmsz[gzsort[j]]]]-0.003,msDec[gmsq[gmsz[gzsort[j]]]]-0.013,AGNstr,color='red',weight='extra bold') 
            elif (j == 6):
                pylab.text(msRA[gmsq[gmsz[gzsort[j]]]]-0.005,msDec[gmsq[gmsz[gzsort[j]]]]-0.07,AGNstr,color='red',weight='extra bold')
            elif (j == 7):
                pylab.text(msRA[gmsq[gmsz[gzsort[j]]]]-0.005,msDec[gmsq[gmsz[gzsort[j]]]]-0.07,AGNstr,color='red',weight='extra bold')
            else:
