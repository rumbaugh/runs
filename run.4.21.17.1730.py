...
plt.hist(crs['mag_g'][gcontrol],range=(15,25),bins=20,color='r',edgecolor='r',facecolor='None',lw=3,normed=True)
plt.hist(random_from_cdf,range=(15,25),bins=20,color='green',edgecolor='green',facecolor='None',lw=3,normed=True)
plt.xlim(15,25)
plt.xlabel('g-band Magnitude')
plt.ylabel('Number of Object')
