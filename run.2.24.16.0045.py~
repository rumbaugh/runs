...
for year in np.arange(1,14):
    ...
    psfpdf=bpdf.PdfPages('/home/rumbaugh/LFC_color_param/LFC_color_param_UV_plots_graz%02i.2.23.16.pdf'%year)
    fig=plt.figure(1)
    FILEB=open('/home/rumbaugh/LFC_color_param/LFC_color_param_UV_output_graz%02i_ABlue.2.23.16.dat'%year,'w')
    FILEB.write('# Filename A(Blue):')
    for zi in z: FILEB.write(' %4.2f'%zi)
    FILEB.write('\n')
    FILER=open('/home/rumbaugh/LFC_color_param/LFC_color_param_UV_output_graz%02i_ARed.2.23.16.dat'%year,'w')
