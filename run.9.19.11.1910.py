...
for i in range(0,len(mpc)):
    ...
    set_model(beta2d.b*beta2d.b)
    b.xpos = 500
    b.ypos = 500
    b.r0 = 2*0.18*(mpc[i]*60)
    b.alpha = 1.5
    save_model("/home/rumbaugh/ChandraData/bmodels/temp/tmpmodel.r0_%7.4f.alpha_1.5.fits"%(b.r0.val))
    ostemp = os.system('dmcopy "/home/rumbaugh/ChandraData/bmodels/temp/tmpmodel.r0_%7.4f.alpha_1.5.fits[(#1,#2)=circle(500,500,150)]" /home/rumbaugh/ChandraData/bmodels/sqrd_beta_model.r0_%5.2f.alpha_1.5.fits clob+'%(b.r0.val,b.r0.val))
