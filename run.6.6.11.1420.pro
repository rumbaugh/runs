...
loadct,13
set_plot,'PS'
device,file="logNlogSplot.combined.soft.paper.6.6.11.ps",/color
...
oplot, COSMOS_S2, COSMOS_N, PSYM=0,LINESTYLE=2,THICK=3
...
oplot,CDFflux,CDFN,linestyle=4,THICK=5

legend,['Cl0023','Cl1604','Cl1324','RXJ1757','RXJ1821'],PSYM=[7,4,2,6,5],color=[0,255,60,160,100],SYMSIZE=[0.8,0.8,0.8,0.8,0.8],THICK=[4,4,4,4,4],CHARSIZE=1.3,CHARTHICK=4,/bottom,box=0
