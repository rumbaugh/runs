...
#for i in range(0,len(datearr)):
    ...
    if badants_arr[i] != 'none':
        #plotms(vis=curvis,xaxis='time',yaxis='amp',antenna=badants_arr[i],correlation='LL,RR',avgchannel='64',avgspw=True,avgtime='60',coloraxis='antenna2')
        gotcon = 0
