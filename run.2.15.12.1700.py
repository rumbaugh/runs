...
#    print "%s - 4th Position\n(RA,Dec) = (%s,%s)\ni'/f814 magnitude: %f\n"%(names[i],rastrs[3],decstrs[3],iB[g[gall[grs[garg[validBCGIDs[3]]]]]])
    FILE = open('/home/rumbaugh/tempreg.dat','w')
    FILE2 = open('/home/rumbaugh/tempreg.reg','w')
    ...
    for iw in range(0,len(gblu)):
        ...
        if len(giw) > 0: 
            if ((sz[gs[galls[gblus[giw[0]]]]] > centerzs[i]-0.1) & (sz[gs[galls[gblus[giw[0]]]]] < centerzs[i]+0.1)):
                isgood = 1
                regcol = 'blue'
                if ((i != 5) & (i != 6)):
    ...
    for iw in range(0,len(gars)):
        ...
        if len(giw) > 0: 
            if ((sz[gs[galls[garss[giw[0]]]]] > centerzs[i]-0.1) & (sz[gs[galls[garss[giw[0]]]]] < centerzs[i]+0.1)):
                isgood = 1
                regcol = 'yellow'
                if ((i != 5) & (i != 6)):
    ...
    for iw in range(0,len(garg)):
        ...
        if len(giw) > 0: 
            if ((sz[gs[galls[grss[giw[0]]]]] > centerzs[i]-0.1) & (sz[gs[galls[grss[giw[0]]]]] < centerzs[i]+0.1)):
                isgood = 1
                regcol = 'red'
                if ((i != 5) & (i != 6)):
        ...
        if ((top4 < 3.4) & (isgood < 2.2)):
            ...
            if top4 == BCGorder[i]:
                FILE3.write('%s  %f  %f  %f %f %f %f %i\n'%(names[i],RA[g[gall[grs[garg[iw]]]]],Dec[g[gall[grs[garg[iw]]]]],rB[g[gall[grs[garg[iw]]]]],iB[g[gall[grs[garg[iw]]]]],zB[g[gall[grs[garg[iw]]]]],sz[gs[galls[grss[giw[0]]]]],top4+1))
            print top4
            if ((i != 5) & (i != 6)):
