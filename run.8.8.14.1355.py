...
level_dict = dict(zip(np.array([3,5,6,7,8,10,11,12,13,14,15,16,17,20]),np.array([160,115,210,170,135,550,180,95,85,200,30,125,95,190])))
...
FILE = open('/home/rumbaugh/runs/run.8.6.14.1620.sh','w')
