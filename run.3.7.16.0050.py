...
psfpdf=bpdf.PdfPages('/home/rumbaugh/Chandra/plots/phase_space_diagrams.per_clus.3.7.16.pdf')
date='3.7.16'
...
plt.tick_params(which='major',length=8,width=2,labelsize=14)
plt.tick_params(which='minor',length=4,width=1.5,labelsize=14)
print KStest(ccdsomez*veldistsomez,allclusdistsomez*allveldistsomez)
veldistsomez[veldistsomez==0]=0.001
allveldistsomez[allveldistsomez==0]=0.0001
veldistsomez[veldistsomez<0.01]=0.011
allveldistsomez[allveldistsomez<0.01]=0.011
veldistsomez[veldistsomez>10]=9.99
allveldistsomez[allveldistsomez>10]=9.99
plt.hist(np.log10(ccdsomez*veldistsomez),color='r',bins=[-1.75,-1,np.log10(0.4),np.log10(2),1])
plt.hist(np.log10(allclusdistsomez*allveldistsomez),color='b',alpha=0.3,weights=25*np.ones(len(allclusdistsomez))*1./len(allclusdistsomez),bins=[-1.75,-1,np.log10(0.4),np.log10(2),1])
#plt.scatter(ccdsomez,veldistsomez,color='r',s=16)
...
#    plt.axvline(xval,color='b',lw=2,ls='--')
plt.xlim(0.01,100)
plt.ylim(np.min(allveldistsomez),12)
plt.legend(loc=3)
