...
delta = 17.5
FILE = open('/home/rumbaugh/output.disp_sim.%s_BA.10.28.13.dat'%lens,'w')
...
for i in range(0,ntrials):
    ...
    ttmp,mtmp,BA_disp_mat[i] = calc_disp_delay(Aflux_diff[g]+rA[g]+lsA_A+lsB_A*ltime,Bflux_diff[g2]+rB[g2]+lsA_B+lsB_B*ltime,ltime,ltime,Aerr[g],Berr[g2],maxtimestep,timestep,minmu,maxmu,mustep,'D_4_2b',delta,output=2,simplemuerr=True)
    FILE.write('%E\n'%(BA_disp_mat[i]))
FILE.close()
