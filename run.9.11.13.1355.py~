...
plt.savefig('/home/rumbaugh/EVLA/light_curves/plots/CSOnorm.9.8.13.png')
...
plt.savefig('/home/rumbaugh/EVLA/light_curves/plots/CSO1244.lc_norm_plot.9.8.13.png')
...
plt.xlabel('Days')
plt.ylabel('Normalized Flux')
plt.savefig('/home/rumbaugh/EVLA/light_curves/plots/CSO1400.lc_norm_plot.9.8.13.png')
...
plt.savefig('/home/rumbaugh/EVLA/light_curves/plots/CSO_rel_flux_plot.9.8.13.png')
...
for lens in lens_dict:
    ...
    plt.savefig('/home/rumbaugh/EVLA/light_curves/plots/%s.lc_plot.9.8.13.png'%lens)
    plt.clf()
    plt.rc('axes',linewidth=2)
    plt.fontsize = 14
    plt.tick_params(which='major',length=8,width=2,labelsize=14)
    ...
    plt.xlim(1810-cr[0][0],2090-cr[0][0])
    plt.savefig('/home/rumbaugh/EVLA/light_curves/plots/%s.lc_norm_plot.9.8.13.png'%lens)
lens = '0712'
cr = np.loadtxt('/home/rumbaugh/EVLA/light_curves/%s_g.edt'%(lens))
nimg = lens_dict[lens]['images']
testlegs = []
...
plt.ylabel('Normalized Flux',fontsize=14)
plt.xlim(1810-cr[0][0],2090-cr[0][0])
plt.savefig('/home/rumbaugh/EVLA/light_curves/plots/%s.lc_norm_plot_comb_A+B.9.8.13.png'%lens)
