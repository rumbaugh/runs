...
ttmp,mtmp,BA_disp,nefft = chi_squared_min_delays(Aflux[g],Bflux[g],ltime[g],ltime[g],Aerr[g],Berr[g],t_grid,maxtimestep,timestep,minmu,maxmu,mustep,smooth_param=np.array([10.]),use_overlap_mean=True,outfile='/home/rumbaugh/EVLA/light_curves/Dispersions/Chisq_grid_out.%s.10.23.13.dat'%lens)
