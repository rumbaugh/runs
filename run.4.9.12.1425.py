...
for i in range(0,len(names)):
    ...
    if names[i] == 'RXJ1821': sig,sige = biweight_scale(velstemp[gRGPtemp],ConfInvTrials=1000000,ConfInv=1)
    ...
    if names[i] == 'RXJ1821': sig,sige = biweight_scale(velstemp2[gRGPtemp],ConfInvTrials=1000000,ConfInv=1)
