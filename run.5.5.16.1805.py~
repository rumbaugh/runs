...
FILEl.write('# field ID RA Dec z_peak nh flux_soft flux_hard flux_full\n')
...
for field in reffile_dict.keys():
    ...
    for iflx in range(0,len(gxray)):
        FILEl.write('%12s %i %9.5f %9.5f %f %f %E %E %E\n'%(field,cr['ID'][gnew0][gnew][gxray][iflx],cr['ra'][gnew0][gnew][gxray][iflx], cr['dec'][gnew0][gnew][gxray][iflx],crpz['z_peak'][gnew0][gnew][gxray][iflx], nh_dict[field],fluxes[iflx][0],fluxes[iflx][1],fluxes[iflx][2]))
    #plt.figure(2)
