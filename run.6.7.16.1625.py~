...
psfpdf=bpdf.PdfPages('/home/rumbaugh/Chandra/plots/testCMDs.4.11.16.pdf')
...
for field in targets[np.argsort(zlist)]:
    FILES1=open('/home/rumbaugh/Chandra/coadd_cats/spectra_all.%s.4.11.16.dat'%field,'w')
    FILES2=open('/home/rumbaugh/Chandra/coadd_cats/spectra_cut-20.9.%s.4.11.16.dat'%field,'w')
    FILERS1=open('/home/rumbaugh/Chandra/coadd_cats/supercolors_all.%s.4.11.16.dat'%field,'w')
    FILERS1.write('# ID RA Dec magR magI magZ dmagR dmagI dmagZ SCmagRed SCmagBlue dRed dBlue\n')
    FILERS2=open('/home/rumbaugh/Chandra/coadd_cats/supercolors_cut-20.9.%s.4.11.16.dat'%field,'w')
