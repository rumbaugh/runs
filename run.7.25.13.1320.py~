...
#for mask in ['0435m2','1131m1_v2','1131m2_v2']:
	...
	#	lris_reduce_multislit(indir_dict[mask],outdir_dict[mask],files_dict[mask]['prefix'],files_dict[mask],mask,colors='blue',sides=['bottom'],doCR=False,subset=[2])
		...
		#tdict['blue']['images_split'][1] = tdict['blue']['images_split'][1][1:]
		...
		lris_reduce_multislit(indir_dict[mask],outdir_dict[mask],files_dict[mask]['prefix'],files_dict[mask],mask,colors='red',sides=['top','bottom'],doCR=False)
	else:
