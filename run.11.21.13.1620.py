...
for tdcfile in ref_dict:
    infile = '/mnt/data2/rumbaugh/TDC/tdc1sample_for_test/rung1/output/%s.BA.dat'%tdcfile
    outfile = '/mnt/data2/rumbaugh/TDC/tdc1sample_for_test/rung1/output/conplot.%s.BA.ps'%tdcfile
