...
loadct,13
set_plot,'PS'
device,file="/home/rumbaugh/paperstuff/logNlogSplot.overdensities.soft.10.5.11.ps",/color
...
k1 = 0.00000000000636569734274


;; First get amount of sky covered at a given flux (6932)

rdfloat, "/scratch/rumbaugh/ciaotesting/Cl0023/7914/acis7914.img.500-2000.nops.bin64.dat", x1, y1, counts1
...
; Plot logN-logS
; window, 1
;;plot, src_flux_sort, N, /xlog, /ylog, psym=4,xrange=[6E-16,2E-14],yrange=[50,2000],/ysty,/xsty
plot, src_flux_sort, N, /xlog, /ylog,xrange=[6E-16,3E-14],yrange=[30,2000],XTITLE="S (erg s!E-1!N cm!E-2!N)",TITLE="Cl0023 - Soft Band", YTITLE = "N(>S) (deg!E-2!N)", /ysty,/xsty,THICK=1,XTHICK=2,YTHICK=2,CHARSIZE=1.6,CHARTHICK=2
;oploy,CDFflux,CDFN,LINESTYLE=1

;oplot, COSMOS_S2, COSMOS_N, PSYM=0,LINESTYLE=5

CDFinterp1 = dblarr(n_elements(N))
CDFinterp1 = interp1(CDFflux,CDFN,src_flux_sort)
overdense1 = (N-CDFinterp1)/CDFinterp1
sfs1 = src_flux_sort

CDFinterp1err = interp_err(CDFflux,CDFN,CDFNerr,src_flux_sort)
gtemp = where((src_flux_sort ge 3E-15) and (src_flux_sort le 1E-14))
lastx = 1E-14
tsum = 0.0
for i=0,n_elements(gtemp)-1 do begin &$
tsum = tsum - (src_flux_sort[gtemp[i]]-lastx)*(N[gtemp[i]]-CDFinterp1[gtemp[i]])/sqrt(CDFinterp1err[gtemp[i]]*CDFinterp1err[gtemp[i]]+Nerr[gtemp[i]]*Nerr[gtemp[i]]) &$
lastx = src_flux_sort[gtemp[i]] &$
;print,tsum,lastx-src_flux_sort[gtemp[i]],(N[gtemp[i]]-CDFinterp1[gtemp[i]]),sqrt(CDFinterp1err[gtemp[i]]*CDFinterp1err[gtemp[i]]+Nerr[gtemp[i]]*Nerr[gtemp[i]]) &$
   endfor
i = n_elements(gtemp)-1
tsum = tsum - (3E-15 - src_flux_sort[gtemp[i]])*(N[gtemp[i]]-CDFinterp1[gtemp[i]])/sqrt(CDFinterp1err[gtemp[i]]*CDFinterp1err[gtemp[i]]+Nerr[gtemp[i]]*Nerr[gtemp[i]])
errsigsum = tsum/(1E-14- 3E-15)
print,errsigsum
...
vsum = 0.0
for i=0,n_elements(gtemp)-1 do begin &$
tsum = tsum - (src_flux_sort[gtemp[i]]-lastx)*(N[gtemp[i]]-CDFinterp1[gtemp[i]]) &$
vsum = vsum + (src_flux_sort[gtemp[i]]-lastx)*(src_flux_sort[gtemp[i]]-lastx)*(CDFinterp1err[gtemp[i]]*CDFinterp1err[gtemp[i]]+Nerr[gtemp[i]]*Nerr[gtemp[i]]) &$
lastx = src_flux_sort[gtemp[i]] &$
;print,tsum,lastx-src_flux_sort[gtemp[i]],(N[gtemp[i]]-CDFinterp1[gtemp[i]]),sqrt(CDFinterp1err[gtemp[i]]*CDFinterp1err[gtemp[i]]+Nerr[gtemp[i]]*Nerr[gtemp[i]]) &$
   endfor
i = n_elements(gtemp)-1
tsum = tsum - (3E-15 - src_flux_sort[gtemp[i]])*(N[gtemp[i]]-CDFinterp1[gtemp[i]])
vsum = vsum + (3E-15 - src_flux_sort[gtemp[i]])*(3E-15 - src_flux_sort[gtemp[i]])*(CDFinterp1err[gtemp[i]]*CDFinterp1err[gtemp[i]]+Nerr[gtemp[i]]*Nerr[gtemp[i]])
errsigsum = tsum/sqrt(vsum)
print,errsigsum

ploterror,src_flux_sort,overdense1,Nerr/CDFinterp1,/xlog,xrange=[6E-16,2E-14],/xsty,/ysty,YRANGE=[-1.5,4.1],XTITLE="S (erg s!E-1!N cm!E-2!N)",YTITLE="Overdensity (sigma)",TITLE="Cl0023 - Soft Band",THICK=2,XTHICK=2,YTHICK=2,CHARSIZE=1.6,CHARTHICK=2
oplot,pzX,plotzero,LINESTYLE=1

ploterror,src_flux_sort,overdense1,CDFinterp1err/CDFinterp1,/xlog,xrange=[6E-16,2E-14],/xsty,/ysty,YRANGE=[-1.5,4.1],XTITLE="S (erg s!E-1!N cm!E-2!N)",YTITLE="Overdensity (sigma)",TITLE="Cl0023 - Soft Band",THICK=2,XTHICK=2,YTHICK=2,CHARSIZE=1.6,CHARTHICK=2
oplot,pzX,plotzero,LINESTYLE=1

ploterror,src_flux_sort,overdense1,sqrt(CDFinterp1err*CDFinterp1err+Nerr*Nerr)/CDFinterp1,/xlog,xrange=[6E-16,2E-14],/xsty,/ysty,YRANGE=[-1.5,4.1],XTITLE="S (erg s!E-1!N cm!E-2!N)",YTITLE="Overdensity (sigma)",TITLE="Cl0023 - Soft Band",THICK=2,XTHICK=2,YTHICK=2,CHARSIZE=1.6,CHARTHICK=2
oplot,pzX,plotzero,LINESTYLE=1

;; Set counts to flux conversion
k2 = 0.5*(0.00000000000615692389864+0.00000000000615933244894)
kN2 = 0.00000000000615692389864
kS2 = 0.00000000000615933244894

;; First get amount of sky covered at a given flux (9404+9836)
rdfloat, "/scratch/rumbaugh/ciaotesting/Cl1324/master/acis9403+9840.img.500-2000.nops.bin64.dat", xN2, yN2, countsN2
...
rdfloat, "/scratch/rumbaugh/ciaotesting/Cl1324/master/acis9404+9836.img.500-2000.nops.bin64.dat", xS2, yS2, countsS2
...
rdfloat, "/scratch/rumbaugh/ciaotesting/Cl1324/master/acis9403+9840.expmap_soft.bin64.dat", x_expN2, y_expN2, exp_mapN2
rdfloat, "/scratch/rumbaugh/ciaotesting/Cl1324/master/acis9404+9836.expmap_soft.bin64.dat", x_expS2, y_expS2, exp_mapS2
...
overdense2 = (N-CDFinterp2)/CDFinterp2

CDFinterp2err = interp_err(CDFflux,CDFN,CDFNerr,src_flux_sort)
gtemp = where((src_flux_sort ge 3E-15) and (src_flux_sort le 1E-14))
lastx = 1E-14
tsum = 0.0
for i=0,n_elements(gtemp)-1 do begin &$
tsum = tsum - (src_flux_sort[gtemp[i]]-lastx)*(N[gtemp[i]]-CDFinterp2[gtemp[i]])/sqrt(CDFinterp2err[gtemp[i]]*CDFinterp2err[gtemp[i]]+Nerr[gtemp[i]]*Nerr[gtemp[i]]) &$
lastx = src_flux_sort[gtemp[i]] &$
;print,tsum,lastx-src_flux_sort[gtemp[i]],(N[gtemp[i]]-CDFinterp1[gtemp[i]]),sqrt(CDFinterp1err[gtemp[i]]*CDFinterp1err[gtemp[i]]+Nerr[gtemp[i]]*Nerr[gtemp[i]]) &$
   endfor
i = n_elements(gtemp)-1
tsum = tsum - (3E-15 - src_flux_sort[gtemp[i]])*(N[gtemp[i]]-CDFinterp2[gtemp[i]])/sqrt(CDFinterp2err[gtemp[i]]*CDFinterp2err[gtemp[i]]+Nerr[gtemp[i]]*Nerr[gtemp[i]])
errsigsum = tsum/(1E-14- 3E-15)
print,errsigsum

ploterror, src_flux_sort, N,Nerr
oplot,CDFflux,CDFN,LINESTYLE=1
;oploy, COSMOS_S2, COSMOS_N, PSYM=0,LINESTYLE=5
sfs2 = src_flux_sort
ploterror,src_flux_sort,overdense2,Nerr/CDFinterp2,/xlog,xrange=[6E-16,2E-14],/xsty,/ysty,YRANGE=[-1.5,4.1],XTITLE="S (erg s!E-1!N cm!E-2!N)",YTITLE="Overdensity (sigma)",TITLE="Cl1324 - Soft Band",THICK=2,XTHICK=2,YTHICK=2,CHARSIZE=1.6,CHARTHICK=2
oplot,pzX,plotzero,LINESTYLE=1

ploterror,src_flux_sort,overdense2,CDFinterp2err/CDFinterp2,/xlog,xrange=[6E-16,2E-14],/xsty,/ysty,YRANGE=[-1.5,4.1],XTITLE="S (erg s!E-1!N cm!E-2!N)",YTITLE="Overdensity (sigma)",TITLE="Cl1324 - Soft Band",THICK=2,XTHICK=2,YTHICK=2,CHARSIZE=1.6,CHARTHICK=2
oplot,pzX,plotzero,LINESTYLE=1

ploterror,src_flux_sort,overdense2,sqrt(CDFinterp2err*CDFinterp2err+Nerr*Nerr)/CDFinterp2,/xlog,xrange=[6E-16,2E-14],/xsty,/ysty,YRANGE=[-1.5,4.1],XTITLE="S (erg s!E-1!N cm!E-2!N)",YTITLE="Overdensity (sigma)",TITLE="Cl1324 - Soft Band",THICK=2,XTHICK=2,YTHICK=2,CHARSIZE=1.6,CHARTHICK=2
oplot,pzX,plotzero,LINESTYLE=1
...
;; Set counts to flux conversion
k3 = 0.5*(0.00000000000611784163965+0.00000000000611567272226)
kN3=0.00000000000611784163965
kS3=0.00000000000611567272226

;; First get amount of sky covered at a given flux (6932)
rdfloat, "/scratch/rumbaugh/ciaotesting/Cl1604/master/acis6933+7343.img.500-2000.nops.bin64.dat", xN3, yN3, countsN3
rdfloat, "/scratch/rumbaugh/ciaotesting/Cl1604/master/acis6933+7343.bin64.offaxis_angle.dat", x_thetaN, y_thetaN, thetaN

r95aN = interpol(perc95_radius, arcsec_offset, thetaN)
rdfloat, "/scratch/rumbaugh/ciaotesting/Cl1604/master/../6932/acis6932.img.500-2000.nops.bin64.dat", xS3, yS3, countsS3
rdfloat, "/scratch/rumbaugh/ciaotesting/Cl1604/master/../6932/acis6932.bin64.offaxis_angle.dat", x_thetaS, y_thetaS, thetaS

r95aS = interpol(perc95_radius, arcsec_offset, thetaS)
rdfloat, "/scratch/rumbaugh/ciaotesting/Cl1604/master/acis6933+7343.expmap_soft.bin64.dat", x_expN, y_expN, exp_mapN
rdfloat, "/scratch/rumbaugh/ciaotesting/Cl1604/master/../6932/acis6932.expmap_soft.bin64.dat", x_expS, y_expS, exp_mapS
...
photcat2 = '/scratch/rumbaugh/ciaotesting/Cl1604/master/../6932/stats.radec_netcntscor_netcnts_cnts_sig_flux.soft.dat'
...
overdense3 = (N-CDFinterp3)/CDFinterp3

CDFinterp3err = interp_err(CDFflux,CDFN,CDFNerr,src_flux_sort)
gtemp = where((src_flux_sort ge 3E-15) and (src_flux_sort le 1E-14))
lastx = 1E-14
tsum = 0.0
for i=0,n_elements(gtemp)-1 do begin &$
tsum = tsum - (src_flux_sort[gtemp[i]]-lastx)*(N[gtemp[i]]-CDFinterp3[gtemp[i]])/sqrt(CDFinterp3err[gtemp[i]]*CDFinterp3err[gtemp[i]]+Nerr[gtemp[i]]*Nerr[gtemp[i]]) &$
lastx = src_flux_sort[gtemp[i]] &$
;print,tsum,lastx-src_flux_sort[gtemp[i]],(N[gtemp[i]]-CDFinterp1[gtemp[i]]),sqrt(CDFinterp1err[gtemp[i]]*CDFinterp1err[gtemp[i]]+Nerr[gtemp[i]]*Nerr[gtemp[i]]) &$
   endfor
i = n_elements(gtemp)-1
tsum = tsum - (3E-15 - src_flux_sort[gtemp[i]])*(N[gtemp[i]]-CDFinterp3[gtemp[i]])/sqrt(CDFinterp3err[gtemp[i]]*CDFinterp3err[gtemp[i]]+Nerr[gtemp[i]]*Nerr[gtemp[i]])
errsigsum = tsum/(1E-14- 3E-15)
print,errsigsum
...
;oploy, COSMOS_S2, COSMOS_N, PSYM=0,LINESTYLE=5
sfs3 = src_flux_sort
ploterror,src_flux_sort,overdense3,Nerr/CDFinterp3,/xlog,xrange=[6E-16,2E-14],/xsty,/ysty,YRANGE=[-1.5,4.1],XTITLE="S (erg s!E-1!N cm!E-2!N)",YTITLE="Overdensity (sigma)",TITLE="Cl1604 - Soft Band",THICK=2,XTHICK=2,YTHICK=2,CHARSIZE=1.6,CHARTHICK=2
oplot,pzX,plotzero,LINESTYLE=1

ploterror,src_flux_sort,overdense3,CDFinterp3err/CDFinterp3,/xlog,xrange=[6E-16,2E-14],/xsty,/ysty,YRANGE=[-1.5,4.1],XTITLE="S (erg s!E-1!N cm!E-2!N)",YTITLE="Overdensity (sigma)",TITLE="Cl1604 - Soft Band",THICK=2,XTHICK=2,YTHICK=2,CHARSIZE=1.6,CHARTHICK=2
oplot,pzX,plotzero,LINESTYLE=1

ploterror,src_flux_sort,overdense3,sqrt(CDFinterp3err*CDFinterp3err+Nerr*Nerr)/CDFinterp3,/xlog,xrange=[6E-16,2E-14],/xsty,/ysty,YRANGE=[-1.5,4.1],XTITLE="S (erg s!E-1!N cm!E-2!N)",YTITLE="Overdensity (sigma)",TITLE="Cl1604 - Soft Band",THICK=2,XTHICK=2,YTHICK=2,CHARSIZE=1.6,CHARTHICK=2
oplot,pzX,plotzero,LINESTYLE=1
...
;; Set counts to flux conversion
k4 = 0.00000000000822741685491

rdfloat, "/scratch/rumbaugh/ciaotesting/NEP5281/master/acis10444+10924.img.500-2000.nops.bin64.dat", x, y, counts4
...
;j_lim = farr[i]
limitingX = dindgen(4)
limitingX[0] = j_lim*k4
limitingX[1] = j_lim*k4
limitingX[2] = j_lim*k4
limitingX[3] = j_lim*k4
limitingY = dindgen(4)
limitingY[0] = 0.0001
limitingY[1] = 1
limitingY[2] = 1000
...
overdense4 = (N-CDFinterp4)/CDFinterp4

CDFinterp4err = interp_err(CDFflux,CDFN,CDFNerr,src_flux_sort)
gtemp = where((src_flux_sort ge 3E-15) and (src_flux_sort le 1E-14))
lastx = 1E-14
tsum = 0.0
for i=0,n_elements(gtemp)-1 do begin &$
tsum = tsum - (src_flux_sort[gtemp[i]]-lastx)*(N[gtemp[i]]-CDFinterp4[gtemp[i]])/sqrt(CDFinterp4err[gtemp[i]]*CDFinterp4err[gtemp[i]]+Nerr[gtemp[i]]*Nerr[gtemp[i]]) &$
lastx = src_flux_sort[gtemp[i]] &$
;print,tsum,lastx-src_flux_sort[gtemp[i]],(N[gtemp[i]]-CDFinterp1[gtemp[i]]),sqrt(CDFinterp1err[gtemp[i]]*CDFinterp1err[gtemp[i]]+Nerr[gtemp[i]]*Nerr[gtemp[i]]) &$
   endfor
i = n_elements(gtemp)-1
tsum = tsum - (3E-15 - src_flux_sort[gtemp[i]])*(N[gtemp[i]]-CDFinterp4[gtemp[i]])/sqrt(CDFinterp4err[gtemp[i]]*CDFinterp4err[gtemp[i]]+Nerr[gtemp[i]]*Nerr[gtemp[i]])
errsigsum = tsum/(1E-14- 3E-15)
print,errsigsum
...
;oploy, COSMOS_S2, COSMOS_N, PSYM=0,LINESTYLE=5
sfs4 = src_flux_sort
ploterror,src_flux_sort,overdense4,Nerr/CDFinterp4,/xlog,xrange=[6E-16,2E-14],/xsty,/ysty,YRANGE=[-1.5,4.1],XTITLE="S (erg s!E-1!N cm!E-2!N)",YTITLE="Overdensity (sigma)",TITLE="NEP5281 - Soft Band",THICK=2,XTHICK=2,YTHICK=2,CHARSIZE=1.6,CHARTHICK=2
oplot,pzX,plotzero,LINESTYLE=1
ploterror,src_flux_sort,overdense4,CDFinterp4err/CDFinterp4,/xlog,xrange=[6E-16,2E-14],/xsty,/ysty,YRANGE=[-1.5,4.1],XTITLE="S (erg s!E-1!N cm!E-2!N)",YTITLE="Overdensity (sigma)",TITLE="NEP5281 - Soft Band",THICK=2,XTHICK=2,YTHICK=2,CHARSIZE=1.6,CHARTHICK=2
oplot,pzX,plotzero,LINESTYLE=1
ploterror,src_flux_sort,overdense4,sqrt(CDFinterp4err*CDFinterp4err+Nerr*Nerr)/CDFinterp4,/xlog,xrange=[6E-16,2E-14],/xsty,/ysty,YRANGE=[-1.5,4.1],XTITLE="S (erg s!E-1!N cm!E-2!N)",YTITLE="Overdensity (sigma)",TITLE="NEP5281 - Soft Band",THICK=2,XTHICK=2,YTHICK=2,CHARSIZE=1.6,CHARTHICK=2
oplot,pzX,plotzero,LINESTYLE=1
...
;; Set counts to flux conversion
k5 = 0.0000000000065997028703

rdfloat, "/scratch/rumbaugh/ciaotesting/RXJ1757/master/RXJ1757.img.500-2000.nops.bin64.dat", x, y, counts5
...
;print,CDFflux,CDFN
overdense5 = (N-CDFinterp5)/CDFinterp5

CDFinterp5err = interp_err(CDFflux,CDFN,CDFNerr,src_flux_sort)
gtemp = where((src_flux_sort ge 3E-15) and (src_flux_sort le 1E-14))
lastx = 1E-14
tsum = 0.0
for i=0,n_elements(gtemp)-1 do begin &$
tsum = tsum - (src_flux_sort[gtemp[i]]-lastx)*(N[gtemp[i]]-CDFinterp5[gtemp[i]])/sqrt(CDFinterp5err[gtemp[i]]*CDFinterp5err[gtemp[i]]+Nerr[gtemp[i]]*Nerr[gtemp[i]]) &$
lastx = src_flux_sort[gtemp[i]] &$
;print,tsum,lastx-src_flux_sort[gtemp[i]],(N[gtemp[i]]-CDFinterp1[gtemp[i]]),sqrt(CDFinterp1err[gtemp[i]]*CDFinterp1err[gtemp[i]]+Nerr[gtemp[i]]*Nerr[gtemp[i]]) &$
   endfor
i = n_elements(gtemp)-1
tsum = tsum - (3E-15 - src_flux_sort[gtemp[i]])*(N[gtemp[i]]-CDFinterp5[gtemp[i]])/sqrt(CDFinterp5err[gtemp[i]]*CDFinterp5err[gtemp[i]]+Nerr[gtemp[i]]*Nerr[gtemp[i]])
errsigsum = tsum/(1E-14- 3E-15)
print,errsigsum
...
;oploy, COSMOS_S2, COSMOS_N, PSYM=0,LINESTYLE=5
sfs5 = src_flux_sort
ploterror,src_flux_sort,overdense5,Nerr/CDFinterp5,/xlog,xrange=[6E-16,2E-14],/xsty,/ysty,YRANGE=[-1.5,4.1],XTITLE="S (erg s!E-1!N cm!E-2!N)",YTITLE="Overdensity (sigma)",TITLE="NEP200 - Soft Band",THICK=2,XTHICK=2,YTHICK=2,CHARSIZE=1.6,CHARTHICK=2
oplot,pzX,plotzero,LINESTYLE=1
ploterror,src_flux_sort,overdense5,CDFinterp5err/CDFinterp5,/xlog,xrange=[6E-16,2E-14],/xsty,/ysty,YRANGE=[-1.5,4.1],XTITLE="S (erg s!E-1!N cm!E-2!N)",YTITLE="Overdensity (sigma)",TITLE="NEP200 - Soft Band",THICK=2,XTHICK=2,YTHICK=2,CHARSIZE=1.6,CHARTHICK=2
oplot,pzX,plotzero,LINESTYLE=1
ploterror,src_flux_sort,overdense5,sqrt(CDFinterp5err*CDFinterp5err+Nerr*Nerr)/CDFinterp5,/xlog,xrange=[6E-16,2E-14],/xsty,/ysty,YRANGE=[-1.5,4.1],XTITLE="S (erg s!E-1!N cm!E-2!N)",YTITLE="Overdensity (sigma)",TITLE="NEP200 - Soft Band",THICK=2,XTHICK=2,YTHICK=2,CHARSIZE=1.6,CHARTHICK=2
oplot,pzX,plotzero,LINESTYLE=1
...
;print, j_lim
;j_lim = farr[i]
limitingXc = dindgen(4)
limitingXc[0] = j_lim*k3
limitingXc[1] = j_lim*k3
limitingXc[2] = j_lim*k3
limitingXc[3] = j_lim*k3
limitingYc = dindgen(4)
limitingYc[0] = 0.000001
limitingYc[1] = 0.0001
limitingYc[2] = 1000
limitingYc[3] = 2000
...
CDFinterpCerr= interp_err(CDFflux,CDFN,CDFNerr,src_flux_sort)

;print,overdenseC,src_flux_sort,N,CDFinterpC

NerrUp = N+3*Nerr
NerrDown = N-3*Nerr
plot,[0-1],[0-1],/nodata, /xlog, /ylog, xrange=[6E-16,3E-14],yrange=[30,2000],XTITLE="S (erg s!E-1!N cm!E-2!N)", YTITLE = "N(>S) (deg!E-2!N)", /ysty,/xsty,XTHICK=6,YTHICK=6,CHARSIZE=1.3,CHARTHICK=5
oplot,src_flux_sort, N,LINESTYLE=1,THICK=3,color=60
oplot,src_flux_sort,NerrUp,THICK=4,color=60
oplot,src_flux_sort,NerrDown,THICK=4,color=60
oplot,CDFflux,CDFN,LINESTYLE=2,THICK=4
;oplot, COSMOS_S2, COSMOS_N, PSYM=0,LINESTYLE=5
oplot,limitingXc,limitingYc,linestyle=1,THICK=4
sfsC = src_flux_sort
plot,src_flux_sort,overdenseC,/xlog,xrange=[6E-16,3E-14],/xsty,/ysty,YRANGE=[-1.5,6.5],XTITLE="S (erg s!E-1!N cm!E-2!N)",YTITLE="Overdensity (sigma)",TITLE="Composite - Soft Band",THICK=2,XTHICK=6,YTHICK=6,CHARSIZE=1.3,CHARTHICK=5
;oploy,pzX,plotzero,LINESTYLE=1

gtemp = where((src_flux_sort ge 2E-15) and (src_flux_sort le 8E-15))
lastx = 8E-15
tsum = 0.0
for i=0,n_elements(gtemp)-1 do begin &$
tsum = tsum - (src_flux_sort[gtemp[i]]-lastx)*(N[gtemp[i]]-CDFinterpC[gtemp[i]])/sqrt(CDFinterpCerr[gtemp[i]]*CDFinterpCerr[gtemp[i]]+Nerr[gtemp[i]]*Nerr[gtemp[i]]) &$
lastx = src_flux_sort[gtemp[i]] &$
;print,tsum,lastx-src_flux_sort[gtemp[i]],(N[gtemp[i]]-CDFinterpC[gtemp[i]]),sqrt(CDFinterpCerr[gtemp[i]]*CDFinterpCerr[gtemp[i]]+Nerr[gtemp[i]]*Nerr[gtemp[i]]) &$
   endfor
i = n_elements(gtemp)-1
tsum = tsum - (2E-15 - src_flux_sort[gtemp[i]])*(N[gtemp[i]]-CDFinterpC[gtemp[i]])/sqrt(CDFinterpCerr[gtemp[i]]*CDFinterpCerr[gtemp[i]]+Nerr[gtemp[i]]*Nerr[gtemp[i]])
errsigsum = tsum/(8E-15- 2E-15)
print,errsigsum


plot,src_flux_sort,overdenseC,/xlog,xrange=[6E-16,3E-14],/xsty,/ysty,YRANGE=[-1,1],XTITLE="S (erg s!E-1!N cm!E-2!N)",YTITLE="Fractional Overdensity",TITLE="Cumulative Source Count Residuals - Soft Band",THICK=4,XTHICK=6,YTHICK=6,CHARSIZE=1.3,CHARTHICK=5
...
legend,['Composite','Cl0023','Cl1604','Cl1324','RXJ1757','RXJ5281'],PSYM=[0,7,4,2,6,5],color=[0,15,255,60,180,90],THICK=[4,4,4,4,4,4],SYMSIZE=[0.5,0.8,0.8,0.8,0.8,0.8],CHARSIZE=1.3,CHARTHICK=4,/bottom,box=0
...
plot,[0,1],[0,1],/nodata,/xlog,xrange=[6E-16,2E-14],/xsty,/ysty,YRANGE=[-1.5,4.1],XTITLE="S (erg s!E-1!N cm!E-2!N)",YTITLE="Overdensity (sigma)",TITLE="Comparison - Soft Band",THICK=2,XTHICK=2,YTHICK=2,CHARSIZE=1.6,CHARTHICK=2
;oplot,pzX,plotzero,LINESTYLE=1
...
legend,['Advanced Systems','Not Advanced'],Linestyle=[0,0],color=[180,250],THICK=[2.2,2.2],CHARSIZE=1.6,CHARTHICK=2,/bottom,box=0
