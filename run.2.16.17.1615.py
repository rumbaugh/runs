...
crdb=np.loadtxt('/home/rumbaugh/var_database/Y3A1/databaseIDs.dat',dtype={'names':('DBID','DBIDS','MQrownum','SP_rownum','sdr7id','thingid','SDSSNAME','CID','TILENAME'),'formats':('|S64','i8','i8','|S24','i8','i8','|S64')})
...
for idb,DBID,cid,tid,sdr7id,MQRN,SPRN,sdssname in zip(np.arange(len(crdb)),crdb['DBID'],crdb['CID'],crdb['thingid'],crdb['sdr7id'],crdb['MQrownum'],crdb['SP_rownum'],crdb['SDSSNAME']):
