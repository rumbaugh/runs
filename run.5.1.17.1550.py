...
plt.figure(1)
plt.clf()
plt.scatter(psfmetric,np.repeat(drop,2),color='b',s=6,edgecolor='None',alpha=0.2)
plt.xlabel('PSF Metric')
plt.ylabel('Mag Drop')
plt.ylim(0,4)
...
plt.figure(1)
plt.clf()
plt.scatter(evqpsfmetric,np.repeat(drop[np.abs(drop)>1],2),color='b',s=6,edgecolor='None',alpha=0.2)
plt.xlabel('PSF Metric')
plt.ylabel('Mag Drop')
plt.ylim(0,4)
