...
pylab.xlim(4*10**-8,3*10**-5)
pylab.ylim(10**-9,4*10**-6)
...
pylab.xlim(5*10**-8,7*10**-5)
pylab.ylim(5*10**-9,3*10**-6)
pylab.loglog(np.arange(3),np.zeros(3))
...
pylab.xlim(10**-7,10**-4)
pylab.ylim(10**-7,3*10**-5)
pylab.loglog(np.arange(3),np.zeros(3))
