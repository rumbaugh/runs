...
#pos,prob,state=sampler.run_mcmc(p0,runs)
        ...
        FILE = open('/mnt/data2/rumbaugh/TDC/tdc1sample_for_test/rung%i/emcee/%s.emcee_output_hist_tau.%s.dat'%(rung,pair,date),'w')
        ...
        py.savefig('/mnt/data2/rumbaugh/TDC/tdc1sample_for_test/rung%i/emcee/plots/%s.BA_delay.%s.ps'%(rung,pair,date))
        py.close()
