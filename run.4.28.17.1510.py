...
dbids,gdb,gdbs,gmi=np.zeros(len(crch),dtype='i8'),np.zeros(len(crch),dtype='i8'),np.zeros(len(crch),dtype='object'),np.zeros(len(crch),dtype='i8')
for i in range(0,len(crcg)):
