...
crdt=np.loadtxt('/home/rumbaugh/var_database/Y3A1/imagestamps/matched_b674be38-e73a-4073-9b53-67b5af4ef137.csv',skiprows=1,delimiter=',',dtype={'names':('ra','dec','tile','fname'),'formats':('f8','f8','|S12','|S25')})
