...
try: 
	...
	Ra_aim = 185.37967072126
try:
	Dec_aim
except NameError:
	Dec_aim = 49.252675813192

try:
	optical_cat
except NameError:
	optical_cat = "/local3/rumbaugh/ChandraData/rxj1221.IDradecmag.cat"
radio_cat = ""
try:
	xray_cat
except NameError:
	xray_cat = "/local3/rumbaugh/ChandraData/1662/photometry/1662.xray_phot.soft_hard_full.dat"

try:
	matching_dir
except NameError:
	matching_dir = "/local3/rumbaugh/ChandraData/1662/opt_match"
try:
	reg_dir
except NameError:
