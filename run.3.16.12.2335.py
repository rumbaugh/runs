...
for i in range(0,len(names)):
    ...
    pylab.savefig('/home/rumbaugh/veldist.redblu.%s.3.16.12.png'%(names[i]))
    pylab.close('all')
    FILEidl1 = open('/home/rumbaugh/temp/idl_clusprops.%s.3.16.12.dat'%(names[i]),'w')
    if enoughBoR == 1:
        FILEidl1.write('%f %f %f %f'%(sig,blusig,redsig,BCGvel))
    else:
        FILEidl1.write('%f %f %f %f'%(sig,-1,-1,BCGvel))
    FILEidl1.close()
    FILEidl2 = open('/home/rumbaugh/temp/idl_vels.%s.3.16.12.dat'%(names[i]),'w')
