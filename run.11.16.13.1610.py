...
days = np.copy(CSO1day)
CSOnorm = 0.5*(CSO1S[g]/np.mean(CSO1S[g]) + CSO2S[g]/np.mean(CSO2S[g]))
CSOerr = 0.5*np.abs(CSO1S[g]/np.mean(CSO1S[g]) - CSO2S[g]/np.mean(CSO2S[g]))
plt.clf()
plt.rc('axes',linewidth=2)
plt.fontsize = 14
plt.tick_params(which='major',length=8,width=2,labelsize=14)
plt.tick_params(which='minor',length=4,width=1.5,labelsize=14)
plt.errorbar(days[g],CSOnorm,yerr=CSOerr,color='k')
#plt.plot(days[g],CSO1S[g]/np.mean(CSO1S[g]),color='red')
#plt.plot(days[g],CSO2S[g]/np.mean(CSO2S[g]),color='blue')
plt.plot(days[g],CSOnorm,color='k')
#plt.scatter(days[g],CSO1S[g]/np.mean(CSO1S[g]),color='red')
#plt.scatter(days[g],CSO2S[g]/np.mean(CSO2S[g]),color='blue')
plt.scatter(days[g],CSOnorm,color='k')
plt.xlabel('Days')
plt.ylabel('Normalized Flux')
plt.savefig('/home/rumbaugh/EVLA/light_curves/plots/CSOs.lc_norm_plot.11.16.13.png')
...
for lens in lens_dict:
    ...
    #FILE = open('/home/rumbaugh/EVLA/light_curves/test.%s.11.11.13.dat'%lens,'w')
