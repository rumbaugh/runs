...
ddata=crd[1].data
mdata=np.loadtxt('/home/rumbaugh/Chandra/7914/photometry/7914.xray_phot_imp.soft_hard_full.dat')
...
msig=msigf[minds]
wsig=wsigf[minds]
cntdiff,percdiff=dcnts_comp-mcnts_comp,(dcnts_comp-mcnts_comp)/dcnts_comp*100
plt.figure(1)
plt.clf()
...
plt.savefig('/home/rumbaugh/Chandra/7914/Dale/plots/diff_ncnts_vs_sig.imp_psf.7914.png')
...
plt.savefig('/home/rumbaugh/Chandra/7914/Dale/plots/diff_ncnts_vs_wsig.imp_psf.7914.png')
...
plt.title('Photometry Code Results')
plt.ylim(-800,200)
plt.savefig('/home/rumbaugh/Chandra/7914/Dale/plots/percdiff_ncnts_vs_sig.imp_psf.7914.png')
...
plt.ylabel('Difference in net counts (%)')
plt.title('wavdetect Results')
plt.savefig('/home/rumbaugh/Chandra/7914/Dale/plots/percdiff_ncnts_vs_wsig.imp_psf.7914.png')
...
plt.title('Photometry Code Results')
plt.savefig('/home/rumbaugh/Chandra/7914/Dale/plots/poserr_corr.imp_psf.7914.png')
...
plt.tick_params(which='major',length=8,width=2,labelsize=14)
plt.tick_params(which='minor',length=4,width=1.5,labelsize=14)
plt.scatter(dspsf95[dinds],r95s[minds]*0.492)
PlotUnity()
...
plt.xlim(0,17)
plt.ylim(0,17)
plt.savefig('/home/rumbaugh/Chandra/7914/Dale/plots/psf95_soft_corr.imp_psf.7914.png')
...
plt.xlim(0,17)
plt.ylim(0,17)
plt.savefig('/home/rumbaugh/Chandra/7914/Dale/plots/psf95_soft_chandra_corr.imp_psf.7914.png')
...
plt.xlim(0,17)
plt.ylim(0,17)
plt.savefig('/home/rumbaugh/Chandra/7914/Dale/plots/psf95_soft_1.25_chandra_corr.imp_psf.7914.png')
