...
for mask in ['bc3.file','bc3B.fil','miki21C.','M0744_A','M0744_B','M0417_B','M1115_A','miki10.f','miki22_z','miki21_B','1131m3','1131m4','miki16B.']:
    ...
    for side in sides:
        for color in colors:
            for slit in slit_name_dict[mask][color][side]:
                if not (((mask in ['miki03_A','miki22.f','miki21.f','miki04_A']) & (color == 'blue') & (side == 'top')) | ((mask in ['miki21D.']) & (((slit in ['26609','33317','32079','32152','31335','212','36253','37249','35460','37569','37074','36322','34872','42105']) & (color == 'blue')) | (side == 'top')))):
                    if color == 'blue':
