...
#        FILEA.write('%s & %2i & %2i\\ %2i\\ %4.1f & +%2i\\ %2i\\ %2i & %5.3f\\\\ \n'%(names[i],argcnt,rahA[jj],ramA[jj],rasA[jj],decdA[jj],decmA[jj],decsA[jj],zA[jj]))
    ...
    if i == 0:
        ...
        for ic in range(0,10):
            ...
            if ic == 2: pylab.text(clusRA[ic+icoff]+0.045,clusDec[ic+icoff],str(cnam[ic+icoff]),color='black',weight='extra bold')
            if ic == 3: pylab.text(clusRA[ic+icoff]-0.025,clusDec[ic+icoff],str(cnam[ic+icoff]),color='black',weight='extra bold')
            if ic == 4: pylab.text(clusRA[ic+icoff]+0.048,clusDec[ic+icoff]-0.01,str(cnam[ic+icoff]),color='black',weight='extra bold')
            if ic == 5: pylab.text(clusRA[ic+icoff]+0.04,clusDec[ic+icoff]-0.02,str(cnam[ic+icoff]),color='black',weight='extra bold')
            if ic == 6: pylab.text(clusRA[ic+icoff]-0.028,clusDec[ic+icoff],str(cnam[ic+icoff]),color='black',weight='extra bold')
            if ic == 7: pylab.text(clusRA[ic+icoff]-0.025,clusDec[ic+icoff],str(cnam[ic+icoff]),color='black',weight='extra bold')
            if ic == 8: pylab.text(clusRA[ic+icoff]-0.021,clusDec[ic+icoff]-0.027,str(cnam[ic+icoff]),color='black',weight='extra bold')
            if ic == 9: pylab.text(clusRA[ic+icoff]-0.028,clusDec[ic+icoff],str(cnam[ic+icoff]),color='black',weight='extra bold')
        #2 Extra
    ...
    savfile = '/home/rumbaugh/paperstuff/AGN.spatmap.color.%s.r_%3.1fMpc_nb.5.26.11.png'%(names[i],cradmult)
