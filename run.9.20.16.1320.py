...
b=ax2.hist(rso_all,range=(-7,2),bins=9,color='b',alpha=0.3,weights=100*np.ones(len(rso_all))*1./len(rso_all[(rso_all>-7)&(rso_all<2)]))
ax.set_xlabel("Red Sequence Offset")
ax.set_ylabel("Number of AGN Hosts")
ax.set_xlim(-7,2)
ax.set_ylim(0,20)
ax2.set_ylim(0,20./len(rso[(rso>-7)&(rso<2)])*100)
...
fig.savefig('/home/rumbaugh/Chandra/plots/RS_offset.hist.9.20.16.png')
...
b=ax2.hist(rso_all1604,range=(-7,2),bins=9,color='b',alpha=0.3,weights=100*np.ones(len(rso_all1604))*1./len(rso_all1604[(rso_all1604>-7)&(rso_all1604<2)]))
ax.set_xlabel("Red Sequence Offset")
ax.set_ylabel("Number of AGN Hosts")
ax.set_xlim(-7,2)
ax.set_ylim(0,3.1)
ax.set_yticks(np.arange(1,4))
ax2.set_ylim(0,3.1/len(rso1604[(rso1604>-7)&(rso1604<2)])*100)
ax2.set_ylabel("Percentage of All Sources")
fig.savefig('/home/rumbaugh/Chandra/plots/RS_offset_cl1604.hist.9.20.16.png')
print 'Cl1604'
for i in range(0,len(a[0])):
    print '%i-%i (AGN): %.2f'%(a[1][i],a[1][1+i],a[0][i]*1./np.sum(a[0]))
for i in range(0,len(a[0])):
...
ax2.set_ylabel("Percentage of All Sources")
fig.savefig('/home/rumbaugh/Chandra/plots/RS_offset_not1604.hist.9.20.16.png')
print 'not 1604'
for i in range(0,len(a[0])):
    print '%i-%i (AGN): %.2f'%(a[1][i],a[1][1+i],a[0][i]*1./np.sum(a[0]))
for i in range(0,len(a[0])):
...
#ax2.set_ylim(0,40)
ax2.set_ylabel("Percentage of All Sources")
fig.savefig('/home/rumbaugh/Chandra/plots/RS_offset_not0023no1604.hist.9.20.16.png')
print 'not 1604'
for i in range(0,len(a[0])):
    print '%i-%i (AGN): %.2f'%(a[1][i],a[1][1+i],a[0][i]*1./np.sum(a[0]))
for i in range(0,len(a[0])):
...
#ax2.set_ylim(0,40)
ax2.set_ylabel("Percentage of All Sources")
fig.savefig('/home/rumbaugh/Chandra/plots/RS_offset_lowlum.hist.9.20.16.png')
print 'Low lum'
for i in range(0,len(a[0])):
    print '%i-%i (AGN): %.2f'%(a[1][i],a[1][1+i],a[0][i]*1./np.sum(a[0]))
for i in range(0,len(a[0])):
