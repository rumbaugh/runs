...
for curid in nextIDs:
    ...
    POSSmagdict,POSSmagerrdict,POSSmjddict={b: crsp['%s_POSS'%(b.upper())][gid] for b in POSSbands},{b: crsp['%s_ERR'%(b.upper())][gid] for b in POSSbands},{b: 50448.+365.25*(crsp['Epoch%s'%(b.upper())][gid][0]-1997) for b in POSSbands}
