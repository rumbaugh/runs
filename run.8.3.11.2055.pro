...
set_plot,'PS'
loadct,'13'
device,file="/home/rumbaugh/XrayLums_RS.8.3.11.ps",/color
totalslum = []
totalhlum = []
yslum = []
yhlum = []
...
for i=0,4 do begin &$
   ...
   gic = where((sz[ors] ge zlb[i]) and (sz[ors] le zhb[i]) and ((sz[ors] lt 0.8125) or (sz[ors] ge 0.8135)) and ((sz[ors] lt 0.8295) or (sz[ors] ge 0.8305)) and ((sz[ors] lt 0.6955) or (sz[ors] ge 0.6965))) &$
   gic2 = where((sz[nors] ge zlb[i]) and (sz[nors] le zhb[i]) and ((sz[nors] lt 0.8125) or (sz[nors] ge 0.8135)) and ((sz[nors] lt 0.8295) or (sz[nors] ge 0.8305)) and ((sz[nors] lt 0.6955) or (sz[nors] ge 0.6965))) &$
   ictemp[gic] = 1 &$
   ic = [ic,ictemp] &$
   flum = slum+hlum &$
   slum += 0.0000000001
   ...
   if i ne 1 then nrsslum = [nrsslum,slum[nors[gic2]]] &$
   if i ne 1 then nrshlum = [nrshlum,hlum[nors[gic2]]] &$
   print,gic
