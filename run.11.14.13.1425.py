...
infile = '/home/rumbaugh/EVLA/light_curves/Dispersions/Chisq_grid_out.%s.11.12.13.dat'%lens
...
py.fontsize = 14
py.savefig('/home/rumbaugh/EVLA/light_curves/Dispersions/Chisq.con_plot.%s.11.14.13.ps'%lens)
