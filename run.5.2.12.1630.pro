...
device,file='/home/rumbaugh/test.veldisp_hists.5.2.12.ps',/color
...
plot,[0-1],[0-1],/nodata,xrange=[-xmax,xmax],yrange=[0,ymaxes[i]],XTITLE='Relative Recessional Velocity (km s!E-1!N)',YTITLE='Num. of Galaxies',TITLE=names2[i],xstyle=1,ystyle=1,XTHICK=4,YTHICK=4,CHARSIZE=1.3,CHARTHICK=4
...
Histoplot,vels[gblu],BINSIZE=500,MININPUT=-xmax,MAXINPUT=xmax,THICK=2,datacolorname='Royal Blue',/LINE_FILL,POLYCOLOR='Royal Blue',ORIENTATION=0,spacing=0.2,/OPLOT
Histoplot,vels[gred],BINSIZE=500,MININPUT=-xmax,MAXINPUT=xmax,THICK=2,datacolorname='Red',/LINE_FILL,POLYCOLOR='Red',ORIENTATION=90,spacing=0.2,/OPLOT
Histoplot,vels,BINSIZE=500,MININPUT=-xmax,MAXINPUT=xmax,THICK=4.5,datacolorname='Black',/OPLOT
tempgaussx = MAKE_ARRAY(2000,/INDEX)*xmax*2.0/2000-xmax
