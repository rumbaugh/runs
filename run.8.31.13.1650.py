...
plt.savefig('/home/rumbaugh/EVLA/light_curves/plots/CSOnorm.8.31.13.png')
...
plt.savefig('/home/rumbaugh/EVLA/light_curves/plots/CSO1244.lc_norm_plot.8.31.13.png')
...
plt.xlabel('Days')
plt.ylabel('Normalized Flux')
plt.savefig('/home/rumbaugh/EVLA/light_curves/plots/CSO1400.lc_norm_plot.8.31.13.png')
...
plt.savefig('/home/rumbaugh/EVLA/light_curves/plots/CSO_rel_flux_plot.8.31.13.png')
...
for lens in lens_dict:
    ...
    plt.ylabel('Flux')
    plt.xlim(1810,2090)
    plt.savefig('/home/rumbaugh/EVLA/light_curves/plots/%s.lc_plot.8.31.13.png'%lens)
    plt.clf()
    plt.rc('axes',linewidth=2)
    plt.fontsize = 14
    plt.tick_params(which='major',length=8,width=2,labelsize=14)
    ...
    for img in range(0,nimg):
        ...
        S /= np.mean(S[g])
        plt.scatter(days[g],S[g]/CSOnorm,color=color_arr[img])
        plt.plot(days[g],S[g]/CSOnorm,color=color_arr[img],lw=2)
    if lens == '0414':
    ...
    plt.xlim(1810,2090)
    plt.savefig('/home/rumbaugh/EVLA/light_curves/plots/%s.lc_norm_plot.8.31.13.png'%lens)
lens = '0712'
cr = np.loadtxt('/home/rumbaugh/EVLA/light_curves/%s_g.edt'%(lens))
nimg = lens_dict[lens]['images']
plt.figure(1)
...
plt.ylabel('Normalized Flux',fontsize=14)
plt.xlim(1810,2090)
plt.savefig('/home/rumbaugh/EVLA/light_curves/plots/%s.lc_norm_plot_comb_A+B.8.31.13.png'%lens)
