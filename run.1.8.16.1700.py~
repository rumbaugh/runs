...
for field in targets[5:11]: 
    ...
    for k in np.argsort(x_zoom_zs):
        ...
        FILE.write('%10s %2i %7.5f %7.5f %E %E %E %6.1f %6.1f %6.1f %5.3f %s %s\n'%(field,k,ra_zs[k],dec_zs[k],nfS[k],nfH[k],nfF[k],nncS[k],nncH[k],nncF[k],x_zoom_zs[k],mask_zs[k],slit_zs[k]))
