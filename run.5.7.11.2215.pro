...
set_plot,'PS'
loadct,'13'
device,file="/home/rumbaugh/XrayLums.5.7.11.ps",/color
totalslum = []
totalhlum = []
yslum = []
yhlum = []
...
;legend,['Cl1604,Cl0023','Cl1324,NEP5281,NEP200'],color=['255','70']
Histoplot,yflum,BINSIZE=0.25,MININPUT=41,MAXINPUT=45,TITLE="Comparison - Full Band",datacolorname='Royal Blue',/LINE_FILL,THICK=4,POLYCOLOR='Royal Blue',ORIENTATION=45,/oplot
