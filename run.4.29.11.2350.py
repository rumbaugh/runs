...
#        FILEA.write('%s & %2i & %2i\\ %2i\\ %4.1f & +%2i\\ %2i\\ %2i & %5.3f\\\\ \n'%(names[i],argcnt,rahA[jj],ramA[jj],rasA[jj],decdA[jj],decmA[jj],decsA[jj],zA[jj]))
    ...
    if i == 0:
        ...
        for ic in range(0,5):
            for icr in range(0,4):
                rp = (icr +1.0)/2
                plotcircle(RAcen=clusRA[ic+icoff],DECcen = clusDec[ic+icoff],rad=rp*crads[ic+icoff])
    ...
    savfile = '/home/rumbaugh/paperstuff/AGN.spatmap.color.%s.r_mult.4.29.11.png'%(names[i])
