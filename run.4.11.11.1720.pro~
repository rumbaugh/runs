...
device,file="/home/rumbaugh/paperstuff/RSoffset.hist.r-i.4.11.11.ps",/color
...
plot,[0,1],[0,1],/nodata,XTITLE='Red Sequence Offset',YTITLE='Num. of AGN',XRANGE=[-1.5,0.5],YRANGE=[0,4.1],/xstyle,/ystyle,XTHICK=2.5,YTHICK=2,CHARTHICK=2
HISTOPLOT,y_RSO,BINSIZE=0.125,MININPUT=-1.5,MAXINPUT=0.5,xstyle=1,ystyle=1,/LINE_FILL,polycolor='Indian Red',spacing=0.02,orientation=-45,THICK=2,/oplot
HISTOPLOT,o_RSO,BINSIZE=0.125,MININPUT=-1.5,MAXINPUT=0.5,xstyle=1,ystyle=1,/LINE_FILL,polycolor='Charcoal',spacing=0.2,orientation=45,THICK=1.5,datacolorname='Charcoal',/oplot
