...
;legend,['Cl1604,Cl0023','Cl1324,NEP5281,NEP200'],color=['255','70']
Histoplot,nrsflum,BINSIZE=0.25,MININPUT=41,MAXINPUT=45,TITLE="Comparison - Full Band",/LINE_FILL,datacolorname='Royal Blue',POLYCOLOR='Royal Blue',ORIENTATION=45,THICK=4,/oplot
