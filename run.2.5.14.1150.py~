...
def runtemplate(base,rung):
    ...
    sampler = emcee.EnsembleSampler(nwalkers,ndim,delaylnprob,args=[B,A,Berr,Aerr,ltime,mu_init,mintime,maxtime,True,True])
    ...
    FILE = open('/mnt/data2/rumbaugh/TDC/tdc1sample_for_test/rung%i/emcee/%s.emcee_output_full_chain_neff.%s.dat'%(rung,pair,date),'w')
