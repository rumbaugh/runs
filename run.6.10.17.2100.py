...
dfcode.to_csv('/home/rumbaugh/Chandra/ORELSE.test_codes.csv',index=False)
plt.figure(1)
plt.clf()
...
plt.savefig('/home/rumbaugh/Chandra/plots/code_vs_SROff.png')
plt.clf()
...
plt.savefig('/home/rumbaugh/Chandra/plots/code_vs_SROff.mean.png')
