...
ARed[zarr<0.63],ARed[zarr>1/1.81+0.63]=0.43,0
BRed[zarr<0.63],BRed[zarr>1/1.81+0.63]=0,0.57
BRed,BBlue=0.57*(1.81*(zarr-0.63)),0.55*(1.825*(zarr-0.7))
ABlue[zarr<0.7],ABlue[zarr>1/1.825+0.7]=0.45,0
BBlue[zarr<0.7],BBlue[zarr>1/1.825+0.7]=0,0.55
