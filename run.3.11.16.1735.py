...
psfpdf=bpdf.PdfPages('/home/rumbaugh/Chandra/plots/testCMDs.3.11.16.pdf')
date='3.11.16'
...
for field in targets[np.argsort(zlist)]:
    FILES1=open('/home/rumbaugh/Chandra/coadd_cats/spectra_all.%s.3.10.16.dat'%field,'w')
    FILES2=open('/home/rumbaugh/Chandra/coadd_cats/spectra_cut-22.%s.3.10.16.dat'%field,'w')
    FILERS1=open('/home/rumbaugh/Chandra/coadd_cats/supercolors_all.%s.3.10.16.dat'%field,'w')
    FILERS1.write('# ID RA Dec magR magI magZ dmagR dmagI dmagZ SCmagRed SCmagBlue dRed dBlue\n')
    FILERS2=open('/home/rumbaugh/Chandra/coadd_cats/supercolors_cut-22.%s.3.10.16.dat'%field,'w')
