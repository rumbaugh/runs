...
crdt=np.loadtxt('/home/rumbaugh/var_database/Y3A1/imagestamps/matched_37042c82-db2b-426f-888f-d77e3181f49b.csv',skiprows=1,delimiter=',',dtype={'names':('ra','dec','tile','fname'),'formats':('f8','f8','|S12','|S25')})
