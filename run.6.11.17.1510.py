...
plt.savefig('/home/rumbaugh/Chandra/plots/scaling_relations.Lx-T.6.11.17.png')
...
plt.savefig('/home/rumbaugh/Chandra/plots/scaling_relations.sig-T.6.11.17.png')
...
plt.ylabel(r'$L_x\ E(z)^{-1}$ ergs s$^{-1}$')
plt.savefig('/home/rumbaugh/Chandra/plots/scaling_relations.sig-Lx.6.11.17.png')
