...
loadct,13
set_plot,'PS'
device,file="/home/rumbaugh/paperstuff/logNlogSplot.overdensities.hard.10.5.11.ps",/color
...
readcol, photcat1, id_all,ra_all,dec_all,netcnts_corr_all,netcnts_all,counts_all,sig_all,offaxis_all,src_flux_all,wmask_all,wsigf_all,wsigs_all,wsigh_all, /silent,format='I,D,D,D,D,D,D,D,D,D,D,D,D,D,D'
...
gtemp = where((src_flux_sort ge 7E-15) and (src_flux_sort le 2E-14))
lastx = 2E-14
tsum = 0.0
...
tsum = tsum - (7E-15 - src_flux_sort[gtemp[i]])*(N[gtemp[i]]-CDFinterp1[gtemp[i]])/sqrt(CDFinterp1err[gtemp[i]]*CDFinterp1err[gtemp[i]]+Nerr[gtemp[i]]*Nerr[gtemp[i]])
errsigsum = tsum/(2E-14- 7E-15)
print,errsigsum

ploterror,src_flux_sort,overdense1,Nerr/CDFinterp1,/xlog,xrange=[3E-15,5E-14],/xsty,/ysty,YRANGE=[-3.5,3],XTITLE="S (erg s!E-1!N cm!E-2!N)",YTITLE="Overdensity (sigma)",TITLE="Cl0023 - Hard Band",THICK=2,XTHICK=2,YTHICK=2,CHARSIZE=1.6,CHARTHICK=2
oplot,pzX,plotzero,LINESTYLE=1


ploterror,src_flux_sort,overdense1,CDFinterp1err/CDFinterp1,/xlog,xrange=[3E-15,5E-14],/xsty,/ysty,YRANGE=[-3.5,3],XTITLE="S (erg s!E-1!N cm!E-2!N)",YTITLE="Overdensity (sigma)",TITLE="Cl0023 - Hard Band",THICK=2,XTHICK=2,YTHICK=2,CHARSIZE=1.6,CHARTHICK=2
oplot,pzX,plotzero,LINESTYLE=1


ploterror,src_flux_sort,overdense1,sqrt(CDFinterp1err*CDFinterp1err+Nerr*Nerr)/CDFinterp1,/xlog,xrange=[3E-15,5E-14],/xsty,/ysty,YRANGE=[-3.5,3],XTITLE="S (erg s!E-1!N cm!E-2!N)",YTITLE="Overdensity (sigma)",TITLE="Cl0023 - Hard Band",THICK=2,XTHICK=2,YTHICK=2,CHARSIZE=1.6,CHARTHICK=2
oplot,pzX,plotzero,LINESTYLE=1
...
readcol, photcat1, id_all1,ra_all1,dec_all1,netcnts_corr_all1,netcnts_all1,counts_all1,sig_all1,offaxis_all1,src_flux_all1,wmask_all1,wsigf_all1,wsigs_all1,wsigh_all1, /silent,format='I,D,D,D,D,D,D,D,D,D,D,D,D,D'
src_flux_all1 = src_flux_all1*kN2/kN22
;readcol, photcat1, id_all1,ra_all1,dec_all1,netcnts_corr_all1,netcnts_all1,counts_all1,sig_all1,offaxis_all1,src_flux_all1,wmask_all1,wflag_all1,wsigf_all1,wsigs_all1,wsigh_all1, /silent,format='I,D,D,D,D,D,D,D,D,D,D,D,D,D,D'
...
readcol, photcat2, id_all2,ra_all2,dec_all2,netcnts_corr_all2,netcnts_all2,counts_all2,sig_all2,offaxis_all2,src_flux_all2,wmask_all2,wsigf_all2,wsigs_all2,wsigh_all2, /silent,format='I,D,D,D,D,D,D,D,D,D,D,D,D,D'
src_flux_all2 = src_flux_all2*kS2/kS22
;readcol, photcat2, id_all2,ra_all2,dec_all2,netcnts_corr_all2,netcnts_all2,counts_all2,sig_all2,offaxis_all2,src_flux_all2,wmask_all2,wflag_all2,wsigf_all2,wsigs_all2,wsigh_all2, /silent,format='I,D,D,D,D,D,D,D,D,D,D,D,D,D,D'
...
lastx = src_flux_sort[gtemp[i]] &$
;print,tsum,lastx-src_flux_sort[gtemp[i]],(N[gtemp[i]]-CDFinterp2[gtemp[i]]),sqrt(CDFinterp2err[gtemp[i]]*CDFinterp2err[gtemp[i]]+Nerr[gtemp[i]]*Nerr[gtemp[i]]) &$
   endfor
i = n_elements(gtemp)-1
tsum = tsum - (7E-15 - src_flux_sort[gtemp[i]])*(N[gtemp[i]]-CDFinterp2[gtemp[i]])/sqrt(CDFinterp2err[gtemp[i]]*CDFinterp2err[gtemp[i]]+Nerr[gtemp[i]]*Nerr[gtemp[i]])
errsigsum = tsum/(2E-14- 7E-15)
print,errsigsum


sfs2 = src_flux_sort
ploterror,src_flux_sort,overdense2,Nerr/CDFinterp2,/xlog,xrange=[3E-15,5E-14],/xsty,/ysty,YRANGE=[-3.5,3],XTITLE="S (erg s!E-1!N cm!E-2!N)",YTITLE="Overdensity (sigma)",TITLE="Cl1324 - Hard Band",THICK=2,XTHICK=2,YTHICK=2,CHARSIZE=1.6,CHARTHICK=2
oplot,pzX,plotzero,LINESTYLE=1

ploterror,src_flux_sort,overdense2,CDFinterp2err/CDFinterp2,/xlog,xrange=[3E-15,5E-14],/xsty,/ysty,YRANGE=[-3.5,3],XTITLE="S (erg s!E-1!N cm!E-2!N)",YTITLE="Overdensity (sigma)",TITLE="Cl1324 - Hard Band",THICK=2,XTHICK=2,YTHICK=2,CHARSIZE=1.6,CHARTHICK=2
oplot,pzX,plotzero,LINESTYLE=1

ploterror,src_flux_sort,overdense2,sqrt(CDFinterp2err*CDFinterp2err+Nerr*Nerr)/CDFinterp2,/xlog,xrange=[3E-15,5E-14],/xsty,/ysty,YRANGE=[-3.5,3],XTITLE="S (erg s!E-1!N cm!E-2!N)",YTITLE="Overdensity (sigma)",TITLE="Cl1324 - Hard Band",THICK=2,XTHICK=2,YTHICK=2,CHARSIZE=1.6,CHARTHICK=2
oplot,pzX,plotzero,LINESTYLE=1
...
readcol, photcat1, id_all1,ra_all1,dec_all1,netcnts_corr_all1,netcnts_all1,counts_all1,sig_all1,offaxis_all1,src_flux_all1,wmask_all1,wsigf_all1,wsigs_all1,wsigh_all1, /silent,format='I,D,D,D,D,D,D,D,D,D,D,D,D'
...
readcol, photcat2, id_all2,ra_all2,dec_all2,netcnts_corr_all2,netcnts_all2,counts_all2,sig_all2,offaxis_all2,src_flux_all2,wmask_all2,wsigf_all2,wsigs_all2,wsigh_all2, /silent,format='I,D,D,D,D,D,D,D,D,D,D,D,D'
...
lastx = src_flux_sort[gtemp[i]] &$
;print,tsum,lastx-src_flux_sort[gtemp[i]],(N[gtemp[i]]-CDFinterp3[gtemp[i]]),sqrt(CDFinterp3err[gtemp[i]]*CDFinterp3err[gtemp[i]]+Nerr[gtemp[i]]*Nerr[gtemp[i]]) &$
   endfor
i = n_elements(gtemp)-1
tsum = tsum - (7E-15 - src_flux_sort[gtemp[i]])*(N[gtemp[i]]-CDFinterp3[gtemp[i]])/sqrt(CDFinterp3err[gtemp[i]]*CDFinterp3err[gtemp[i]]+Nerr[gtemp[i]]*Nerr[gtemp[i]])
errsigsum = tsum/(2E-14- 7E-15)
print,errsigsum

sfs3 = src_flux_sort
ploterror,src_flux_sort,overdense3,Nerr/CDFinterp3,/xlog,xrange=[3E-15,5E-14],/xsty,/ysty,YRANGE=[-3.5,3],XTITLE="S (erg s!E-1!N cm!E-2!N)",YTITLE="Overdensity (sigma)",TITLE="Cl1324 - Hard Band",THICK=2,XTHICK=2,YTHICK=2,CHARSIZE=1.6,CHARTHICK=2
oplot,pzX,plotzero,LINESTYLE=1

ploterror,src_flux_sort,overdense3,CDFinterp3err/CDFinterp3,/xlog,xrange=[3E-15,5E-14],/xsty,/ysty,YRANGE=[-3.5,3],XTITLE="S (erg s!E-1!N cm!E-2!N)",YTITLE="Overdensity (sigma)",TITLE="Cl1324 - Hard Band",THICK=2,XTHICK=2,YTHICK=2,CHARSIZE=1.6,CHARTHICK=2
oplot,pzX,plotzero,LINESTYLE=1


ploterror,src_flux_sort,overdense3,sqrt(CDFinterp3err*CDFinterp3err+Nerr*Nerr)/CDFinterp3,/xlog,xrange=[3E-15,5E-14],/xsty,/ysty,YRANGE=[-3.5,3],XTITLE="S (erg s!E-1!N cm!E-2!N)",YTITLE="Overdensity (sigma)",TITLE="Cl1324 - Hard Band",THICK=2,XTHICK=2,YTHICK=2,CHARSIZE=1.6,CHARTHICK=2
oplot,pzX,plotzero,LINESTYLE=1
...
readcol, photcat1, id_all,ra_all,dec_all,netcnts_corr_all,netcnts_all,counts_all,sig_all,offaxis_all,src_flux_all,wmask_all,wsigf_all,wsigs_all,wsigh_all, /silent,format='I,D,D,D,D,D,D,D,D,D,D,D,D'
...
lastx = src_flux_sort[gtemp[i]] &$
;print,tsum,lastx-src_flux_sort[gtemp[i]],(N[gtemp[i]]-CDFinterp4[gtemp[i]]),sqrt(CDFinterp4err[gtemp[i]]*CDFinterp4err[gtemp[i]]+Nerr[gtemp[i]]*Nerr[gtemp[i]]) &$
   endfor
i = n_elements(gtemp)-1
tsum = tsum - (7E-15 - src_flux_sort[gtemp[i]])*(N[gtemp[i]]-CDFinterp4[gtemp[i]])/sqrt(CDFinterp4err[gtemp[i]]*CDFinterp4err[gtemp[i]]+Nerr[gtemp[i]]*Nerr[gtemp[i]])
errsigsum = tsum/(2E-14- 7E-15)
print,errsigsum

sfs4 = src_flux_sort
ploterror,src_flux_sort,overdense4,Nerr/CDFinterp4,/xlog,xrange=[3E-15,5E-14],/xsty,/ysty,YRANGE=[-3.5,3],XTITLE="S (erg s!E-1!N cm!E-2!N)",YTITLE="Overdensity (sigma)",TITLE="NEP5281 - Hard Band",THICK=2,XTHICK=2,YTHICK=2,CHARSIZE=1.6,CHARTHICK=2
oplot,pzX,plotzero,LINESTYLE=1

ploterror,src_flux_sort,overdense4,CDFinterp4err/CDFinterp4,/xlog,xrange=[3E-15,5E-14],/xsty,/ysty,YRANGE=[-3.5,3],XTITLE="S (erg s!E-1!N cm!E-2!N)",YTITLE="Overdensity (sigma)",TITLE="NEP5281 - Hard Band",THICK=2,XTHICK=2,YTHICK=2,CHARSIZE=1.6,CHARTHICK=2
oplot,pzX,plotzero,LINESTYLE=1

ploterror,src_flux_sort,overdense4,sqrt(CDFinterp4err*CDFinterp4err+Nerr*Nerr)/CDFinterp4,/xlog,xrange=[3E-15,5E-14],/xsty,/ysty,YRANGE=[-3.5,3],XTITLE="S (erg s!E-1!N cm!E-2!N)",YTITLE="Overdensity (sigma)",TITLE="NEP5281 - Hard Band",THICK=2,XTHICK=2,YTHICK=2,CHARSIZE=1.6,CHARTHICK=2
oplot,pzX,plotzero,LINESTYLE=1
...
lastx = src_flux_sort[gtemp[i]] &$
;print,tsum,lastx-src_flux_sort[gtemp[i]],(N[gtemp[i]]-CDFinterp5[gtemp[i]]),sqrt(CDFinterp5err[gtemp[i]]*CDFinterp5err[gtemp[i]]+Nerr[gtemp[i]]*Nerr[gtemp[i]]) &$
   endfor
i = n_elements(gtemp)-1
tsum = tsum - (7E-15 - src_flux_sort[gtemp[i]])*(N[gtemp[i]]-CDFinterp5[gtemp[i]])/sqrt(CDFinterp5err[gtemp[i]]*CDFinterp5err[gtemp[i]]+Nerr[gtemp[i]]*Nerr[gtemp[i]])
errsigsum = tsum/(2E-14 - 7E-15)
print,errsigsum

sfs5 = src_flux_sort
ploterror,src_flux_sort,overdense5,Nerr/CDFinterp5,/xlog,xrange=[3E-15,5E-14],/xsty,/ysty,YRANGE=[-3.5,3],XTITLE="S (erg s!E-1!N cm!E-2!N)",YTITLE="Overdensity (sigma)",TITLE="NEP200 - Hard Band",THICK=2,XTHICK=2,YTHICK=2,CHARSIZE=1.6,CHARTHICK=2
oplot,pzX,plotzero,LINESTYLE=1
ploterror,src_flux_sort,overdense5,CDFinterp5err/CDFinterp5,/xlog,xrange=[3E-15,5E-14],/xsty,/ysty,YRANGE=[-3.5,3],XTITLE="S (erg s!E-1!N cm!E-2!N)",YTITLE="Overdensity (sigma)",TITLE="NEP200 - Hard Band",THICK=2,XTHICK=2,YTHICK=2,CHARSIZE=1.6,CHARTHICK=2
oplot,pzX,plotzero,LINESTYLE=1
ploterror,src_flux_sort,overdense5,sqrt(CDFinterp5err*CDFinterp5err+Nerr*Nerr)/CDFinterp5,/xlog,xrange=[3E-15,5E-14],/xsty,/ysty,YRANGE=[-3.5,3],XTITLE="S (erg s!E-1!N cm!E-2!N)",YTITLE="Overdensity (sigma)",TITLE="NEP200 - Hard Band",THICK=2,XTHICK=2,YTHICK=2,CHARSIZE=1.6,CHARTHICK=2
oplot,pzX,plotzero,LINESTYLE=1
...
NerrUp = N+3*Nerr
NerrDown = N-3*Nerr
plot, [0-1],[0-1],/nodata,/xlog, /ylog, xrange=[3E-15,5E-14],yrange=[30,2000],XTITLE="S (erg s!E-1!N cm!E-2!N)", YTITLE = "N(>S) (deg!E-2!N)", /ysty,/xsty,XTHICK=6,YTHICK=6,CHARSIZE=1.3,CHARTHICK=5
...
i = n_elements(gtemp)-1
tsum = tsum - (7E-15 - src_flux_sort[gtemp[i]])*(N[gtemp[i]]-CDFinterpC[gtemp[i]])/sqrt(CDFinterpCerr[gtemp[i]]*CDFinterpCerr[gtemp[i]]+Nerr[gtemp[i]]*Nerr[gtemp[i]])
errsigsum = tsum/(2E-14 - 7E-15)
print,errsigsum

gtemp = where((src_flux_sort ge 3E-14) and (src_flux_sort le 4E-14))
lastx = 4E-14
tsum = 0.0
for i=0,n_elements(gtemp)-1 do begin &$
tsum = tsum - (src_flux_sort[gtemp[i]]-lastx)*(N[gtemp[i]]-CDFinterpC[gtemp[i]])/sqrt(CDFinterpCerr[gtemp[i]]*CDFinterpCerr[gtemp[i]]+Nerr[gtemp[i]]*Nerr[gtemp[i]]) &$
...
i = n_elements(gtemp)-1
tsum = tsum - (3E-14 - src_flux_sort[gtemp[i]])*(N[gtemp[i]]-CDFinterpC[gtemp[i]])/sqrt(CDFinterpCerr[gtemp[i]]*CDFinterpCerr[gtemp[i]]+Nerr[gtemp[i]]*Nerr[gtemp[i]])
errsigsum = tsum/(4E-14 - 3E-14)
print,errsigsum

sfsC = src_flux_sort
plot,src_flux_sort,overdenseC,/xlog,xrange=[3E-15,5E-14],/xsty,/ysty,YRANGE=[-3.5,4.5],XTITLE="S (erg s!E-1!N cm!E-2!N)",YTITLE="Overdensity (!7r!3)",TITLE="Composite - Hard Band",THICK=3,XTHICK=6,YTHICK=6,CHARSIZE=1.3,CHARTHICK=5
oplot,pzX,plotzero,LINESTYLE=1
