...
target = 'SDSS-J095944.07+041017.0'
iraf.unlearn('astrodrizzle')
astrodrizzle.AstroDrizzle('HST.%s.*_flt.fits'%target,output='test.ADrizOut.HST.%s.pf_%4.2f.fs_%5.3f.%s'%(target,pf,fs,date),final_scale=fs,final_pixfrac=pf)
