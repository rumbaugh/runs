...
NCarr = zeros(len(names))
bkgarr = zeros(len(names))
r500cntsarr = zeros(len(names))
tcntsarr = zeros(len(names))
...
for i in range(0,len(names)):
    ...
    plot([r500,r500],[-10,10000],color='black',linestyle="dashed")
    plot([Re,Re],[-10,10000],color='black',linestyle="dashed")
    xlim(0,400)
    ylim(0,max(append(modelCr_fixNC(xdummy,r0),modelCr_fixNC(xdummy,r0fit3))))
