...
for buff in [100,300,600]:
    ...
    outcr['baseline_RF'],outcr['baseline_RFdec'],outcr['redshift'],outcr['redshiftdec'],outcr['anchor_epoch'],outcr['second_epoch'],outcr['detected'],outcr['firstspec'],outcr['secondspec'],outcr['lowepoch'],outcr['CLQ_detected']=buffcrs0[buff]['baseline_RF'],baselinedec,redshift,buffcrs0[buff]['redshiftdec'],buffcrs[buff]['anchor_epoch'],buffcrs[buff]['second_epoch'],buffcrs[buff]['detected'],buffcrs[buff]['firstspec'],buffcrs[buff]['secondspec'],buffcrs[buff]['lowepoch'],buffcrs[buff]['CLQ_detected']
    np.savetxt('/home/rumbaugh/mock_EVQs.buff_%i.trials_%i.fixed.5.6.17.dat'%(buff,ntrials),outcr,fmt='%i.%i %i.%i %f %f %i %f %f %i %i',header='baseline_RF redshift anchor_epoch second_epoch detected firstspec secondspec lowepoch CLQ_detected')
