...
for buff in [100,300,600]:
    ...
    buffcrs0[buff]=np.loadtxt('/home/rumbaugh/mock_EVQs.buff_%i.trials_%i.5.6.17.dat'%(buff,ntrials),dtype={'names':('baseline_RF','baselinedecredshift','redshiftdec'),'formats':('i8','i8','i8')},delimiter='.')
