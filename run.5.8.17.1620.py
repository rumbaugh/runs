...
for buff in [100,300,600]:
    ...
    outcr['baseline_RF'],outcr['baseline_RFdec'],outcr['redshift'],outcr['redshiftdec'],outcr['anchor_epoch'],outcr['second_epoch'],outcr['detected'],outcr['firstspec'],outcr['secondspec'],outcr['lowepoch'],outcr['CLQ_detected']=buffcrs0[buff]['baseline_RF'],baselinedec,buffcrs0[buff]['redshift'],redshiftdec,buffcrs[buff]['anchor_epoch'],buffcrs[buff]['second_epoch'],buffcrs[buff]['detected'],buffcrs[buff]['firstspec'],buffcrs[buff]['secondspec'],buffcrs[buff]['lowepoch'],buffcrs[buff]['CLQ_detected']
