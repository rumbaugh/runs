...
device,file="/home/rumbaugh/clus.RSwid.5.16.11.ps",/color
...
plot,[0,1],[0,1],/nodata,TITLE="RS Offsets - 0023",XTITLE="RS Offset (RS widths)",YTITLE="Num. of galaxies",PSYM=3,THICK=2,SYMSIZE=0.1,XRANGE=[-7,2],YRANGE=[0,10],xstyle=1,ystyle=1
...
rswid = rsoffset/(3*0.0625)
rswidA = [rswidA,rswid[g[gq]]]
Histoplot,rswid[g[gq]],MINVALUE=-6,MAXVALUE=2,BINSIZE=0.1,/oplot,/outline
...
rsoffset = rprime-iprime-rsfit
plot,[0,1],[0,1],/nodata,TITLE="RS Offsets - 1324",XTITLE="RS Offset (RS widths)",YTITLE="Num. of galaxies",PSYM=3,XRANGE=[-7,2],YRANGE=[0,35],xstyle=1,ystyle=1
...
rsoffset = rprime-iprime-rsfit
plot,[0,1],[0,1],/nodata,TITLE="RS Offsets - NEP200",XTITLE="RS Offset (RS widths)",YTITLE="Num. of galaxies",PSYM=3,XRANGE=[-7,2],YRANGE=[0,10],xstyle=1,ystyle=1
...
rsoffset = rprime-iprime-rsfit
plot,[0,1],[0,1],/nodata,TITLE="RS Offsets - NEP5281",XTITLE="RS Offset (RS widths)",YTITLE="Num. of galaxies",PSYM=3,XRANGE=[-7,2],YRANGE=[0,10],xstyle=1,ystyle=1
...
rsoffset = rprime-iprime-rsfit
;plot,[0,1],[0,1],/nodata,TITLE="RS Offsets - 1604 - LFC only",XTITLE="RS Offset (RS widths)",YTITLE="Num. of galaxies",PSYM=3,XRANGE=[-7,2],YRANGE=[0,50],xstyle=1,ystyle=1
...
plot,[0,1],[0,1],/nodata,TITLE="RS Offsets - Combined",XTITLE="RS Offset (RS widths)",YTITLE="Num. of galaxies",PSYM=3,XRANGE=[-5,2],YRANGE=[0,40],xstyle=1,ystyle=1

Histoplot,rswidA,MINVALUE=-6,MAXVALUE=2,BINSIZE=0.1,/oplot,/outline
end
