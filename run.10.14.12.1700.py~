...
for i in range(0,len(names)):
    ...
    pylab.errorbar(ann_arr,cum_ncnts,cum_ncnts_err,fmt=None)
    pylab.scatter(ann_arr,cum_ncnts)
    pylab.savefig('/home/rumbaugh/DE_counts_profile.%s.10.13.12.png'%names[i])
    pylab.close()
