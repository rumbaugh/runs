...
for iSED in range(0,len(SEDs)):
    ...
    for iz in range(0,len(zarr)):
        ...
        obsU[iSED][iz]=calc_rest_flux(w,S,safeLB,safeUB,D_L=D_L[gdl],filt='u')
        obsB[iSED][iz]=calc_rest_flux(w,S,safeLB,safeUB,D_L=D_L[gdl],filt='B')
...
np.savetxt('/home/rumbaugh/LFC_color_param/MCfit_RF_flatchain.out.3.7.16.dat',sampler.flatchain)
...
plt.savefig('/home/rumbaugh/LFC_color_param/MCfit_RF.UBmag_plot.runs_%i.3.7.16.png'%runs)
...
plt.savefig('/home/rumbaugh/LFC_color_param/MCfit_RF.UBcolor_plot.runs_%i.3.7.16.png'%runs)
