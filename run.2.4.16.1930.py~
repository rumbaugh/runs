...
FILE=open('/home/rumbaugh/Chandra/ORELSE.cluster_ann_counts.dat','w')
FILE.write('# field cluster Xcen Ycen anncounts\n')
FILE2=open('/home/rumbaugh/Chandra/ORELSE.cluster_ann_counts_noVC.dat','w')
FILE2.write('# field cluster Xcen Ycen anncounts\n')

for i in np.delete(np.arange(len(targets)),6):
