...
FILEstat = open("/home/rumbaugh/status.run.5.16.12.1555.txt",'w')
FILEstat.close()
FILE1 = open("/home/rumbaugh/baselines.test.5.16.12.dat",'w')
for i in range(5,5):
    baseline = np.zeros(2)
    for j in range(0,1):
        ...
        FILEstat = open("/home/rumbaugh/status.run.5.16.12.1555.txt",'a')
