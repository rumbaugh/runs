...
device,file='/home/rumbaugh/veldisp_hists.3.20.12.ps',/color
...
;ymaxes = [11,11,8]
ymaxes = [14,5,8,8,12,14,13,8,11]

for i=0,n_elements(names)-1 do begin
readcol,'/home/rumbaugh/temp/idl_clusprops.' + names2[i] + '.3.16.12.dat',sig,blusig,redsig,BCGvel
readcol,'/home/rumbaugh/temp/idl_vels.' + names2[i] + '.3.16.12.dat',vels,deltas,isblu,format='D,D,I'
...
if ((n_elements(gred) ge 8) and (n_elements(gblu) ge 8)) then begin
