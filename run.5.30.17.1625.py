...
ax1.scatter(gdrop,idrop,color='k',edgecolor='None',s=6)
ax1.scatter(gdrop[np.abs(gdrop)>1],idrop[np.abs(gdrop)>1],color='r',edgecolor='None',s=6)
ax1.set_xlim(-2.4,2.4)
ax1.set_ylim(-1.4,1.4)
ax1.set_xlabel(r'$\Delta g$',fontsize=20)
ax1.set_ylabel(r'$\Delta i$',fontsize=20)
ax1.set_xticks(xticks_minor,minor=True)
ax1.set_yticks(yticks_minor,minor=True)
fig.savefig('/home/rumbaugh/var_database/Y3A1/plots/g_vs_i.EVQs.png')
...
ax1.set_ylim(-1.4,1.4)
ax1.set_xlabel(r'$\Delta g$',fontsize=20)
ax1.set_ylabel(r'$\Delta \left(g-i\right)$',fontsize=20)
ax1.set_xticks(xticks_minor,minor=True)
ax1.set_yticks(yticks_minor,minor=True)
...
ax1.set_ylim(-1.4,1.4)
ax1.set_xlabel(r'$\Delta g$',fontsize=20)
ax1.set_ylabel(r'$\Delta \left(g-r\right)$',fontsize=20)
ax1.set_xticks(xticks_minor,minor=True)
ax1.set_yticks(yticks_minor,minor=True)
