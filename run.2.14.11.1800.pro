...
Histoplot,oslum,DATACOLORNAME='Charcoal',TITLE="Comparison - Soft Band",/LINE_FILL,POLYCOLOR='Royal Blue',ORIENTATION=45,/oplot
Histoplot,yhlum,TITLE="Comparison - Hard Band",THICK=4
Histoplot,ohlum,TITLE="Comparison - Hard Band",/LINE_FILL,POLYCOLOR='Royal Blue',ORIENTATION=45,DATACOLORNAME='Charcoal',/oplot
Histoplot,yflum,TITLE="Comparison - Full Band",THICK=4
Histoplot,oflum,TITLE="Comparison - Full Band",/LINE_FILL,POLYCOLOR='Royal Blue',ORIENTATION=45,DATACOLORNAME='Charcoal',/oplot
legend,['
end
