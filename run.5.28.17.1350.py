...
np.savetxt('/home/rumbaugh/Chandra/ORELSE_cluster_member_info_all.dat',outcr,header='field cluster ra dec z mag col rso isBCG isBCG_tot',fmt='%12s %12s %f %f %f %f %f %f %i %i')
