...
for field in ['cl1604']:
    ...
    srcfile='%s/%s_optmatch_ACS.1.19.16.dat'%(basedir,field)
    srcfile2='%s/%s_optmatch_ACS.1.19.16_min5.dat'%(basedir,field)
    regfile='%s/%s_optmatch_ACS.1.19.16.reg'%(basedir,field)
    regfile2='%s/%s_optmatch_ACS.1.19.16_min5.reg'%(basedir,field)
    outfile='%s/%s_optmatch_ACS_comb.1.19.16.dat'%(basedir,field)
    outregfile='%s/%s_optmatch_ACS_comb.1.19.16.reg'%(basedir,field)
