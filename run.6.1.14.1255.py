...
FILE=open('/home/rumbaugh/runs/run.6.1.14.1255.sh','w')
FILE.write("#!/bin/csh\n")
...
for date,aipsdate in zip(dates,aips_dates):
    ...
    for source in tsources:
        ...
        #else:
        FILE.write('rmod /mnt/data2/rumbaugh/VLA/AF377/models/20010212_%s_g_varpos.mod\n'%(source[:4]))
        #FILE.write('rmod /mnt/data2/rumbaugh/EVLA/11A-138/scripts/model.0414.wgauss2.5.20.14.mod\n')
        FILE.write(fit_string)
        outfile = '/mnt/data2/rumbaugh/VLA/AF377/difmap_results/fit_aipsredux_UVR_0_300_6.1.14.%s.varpos.%s_wrms.mod'%(source,date)
        FILE.write('wmod %s\n'%outfile)
