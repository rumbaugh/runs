...
plt.figure(1)
plt.clf()
plt.hist(crs.flatten(),range=(-0.01,0.025),bins=14,lw=2,color='k',normed=True)
plt.hist(crs[drop>1].flatten(),range=(-0.01,0.025),bins=14,lw=2,color='r',edgecolor='r',facecolor='None',normed=True)
plt.xlim(-0.01,0.025)
plt.xlabel('Spread')
