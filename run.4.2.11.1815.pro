...
device,file="/home/rumbaugh/colVr.plot_all+clust.4.2.11.ps",/color
...
plot,[0,1],[0,1],/nodata,TITLE="AGN Color-Magnitude Diagram - 0023",XTITLE="i'-Band Magnitude",YTITLE="r'-i'",PSYM=3,THICK=2,SYMSIZE=0.1,XRANGE=[19,26],YRANGE=[-0.5,1.9],xstyle=1,ystyle=1
...
rsfit = 1.325-0.0084*xl
rsoffset = rprime-iprime-rsfit
plot,[0,1],[0,1],/nodata,TITLE="AGN Color-Magnitude Diagram - 1324",XTITLE="i'-Band Magnitude",YTITLE="r'-i'",PSYM=3,XRANGE=[19,26],YRANGE=[-0.5,1.9],xstyle=1,ystyle=1
...
rsfit = 1.84-0.0319*xl
rsoffset = rprime-iprime-rsfit
plot,[0,1],[0,1],/nodata,TITLE="AGN Color-Magnitude Diagram - NEP200",XTITLE="i'-Band Magnitude",YTITLE="r'-i'",PSYM=3,XRANGE=[19,26],YRANGE=[-0.5,1.9],xstyle=1,ystyle=1
...
rsfit = 1.203-0.0012*xl
rsoffset = rprime-iprime-rsfit
plot,[0,1],[0,1],/nodata,TITLE="AGN Color-Magnitude Diagram - NEP5281",XTITLE="i'-Band Magnitude",YTITLE="r'-i'",PSYM=3,XRANGE=[19,26],YRANGE=[-0.5,1.9],xstyle=1,ystyle=1
...
rsfit = 1.305-0.00485*xl
rsoffset = rprime-iprime-rsfit
plot,[0,1],[0,1],/nodata,TITLE="AGN Color-Magnitude Diagram - 1604 - LFC only",XTITLE="i'-Band Magnitude",YTITLE="r'-i'",PSYM=3,XRANGE=[19,26],YRANGE=[-0.5,1.9],xstyle=1,ystyle=1
...
plot,[0,1],[0,1],/nodata,TITLE="AGN Color-Magnitude Diagram - 1604 - ACS only",XTITLE="F814W Magnitude",YTITLE="F606W-F814W",PSYM=3,XRANGE=[19,26],YRANGE=[-0.5,2.8],xstyle=1,ystyle=1
