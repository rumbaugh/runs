...
plot,src_flux_sort,overdenseC,/xlog,xrange=[6E-16,2E-14],/xsty,/ysty,YRANGE=[-1.5,5.1],XTITLE="S (erg s!E-1!N cm!E-2!N)",YTITLE="Overdensity (sigma)",TITLE="Cumulative Source Count Residuals - Soft Band",THICK=2,XTHICK=2,YTHICK=2,CHARSIZE=1.3,CHARTHICK=2
oplot,pzX,plotzero,LINESTYLE=1
...
legend,['Composite','Cl0023','Cl1604','Cl1324','RXJ1757','RXJ5281'],PSYM=[1,7,4,2,6,5],color=[0,15,255,60,180,90],THICK=[2.2,2.2,2.2,2.2,2.2,2.2],CHARSIZE=1.0,CHARTHICK=1.3,/right,box=0
