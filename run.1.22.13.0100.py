...
ltime = (ltime-ltime[0])
#find time delays
BA_delay_d2,BAmud2,BAdispd2 = calc_disp_delay(Aflux,Bflux,ltime,ltime,Aerr,Berr,maxtimestep,timestep,minmu,maxmu,mustep,'D_2',output=2,simplemuerr=True,use_overlap_mean=True,ALAG=CLAG)
t1 = time.time()
print "33%% Done. Elapsed Time: %f seconds"%(t1-st1)
BC_delay_d2,BCmud2,BCdispd2 = calc_disp_delay(Cflux,Bflux,ltime,ltime,Cerr,Berr,maxtimestep,timestep,minmu,maxmu,mustep,'D_2',output=2,simplemuerr=True,use_overlap_mean=True,ALAG=CLAG)
t2 = time.time()
print "66%% Done. Elapsed Time: %f seconds"%(t2-st1)
BD_delay_d2,BDmud2,BDdispd2 = calc_disp_delay(Dflux,Bflux,ltime,ltime,Derr,Berr,maxtimestep,timestep,minmu,maxmu,mustep,'D_2',output=2,simplemuerr=True,use_overlap_mean=True,ALAG=DLAG)
