...
plt.errorbar(true_lsigs,np.log10(0.5*df.sigma.values**2*df.tau.values),yerr=[np.sqrt(4*df.lsigma_errl**2+(0.5*(df.ltau_errl+df.ltau_erru))**2),np.sqrt(4*df.lsigma_erru**2+(0.5*(df.ltau_errl+df.ltau_erru))**2)],fmt='co',lw=1,capsize=2,mew=1,ms=4)
...
plt.errorbar(true_lsigs,np.log10(0.5*df.drwvar.values**2*df.tau.values),yerr=[np.sqrt(4*df.lvar_errl**2+(0.5*(df.ltau_errl+df.ltau_erru))**2),np.sqrt(4*df.lvar_erru**2+(0.5*(df.ltau_errl+df.ltau_erru))**2)],fmt='ko',lw=1,capsize=2,mew=1,ms=4)
xlim=plt.xlim()
ylim=plt.ylim()
...
plt.errorbar(true_lsigs,true_lsigs-np.log10(0.5*df.sigma.values**2*df.tau.values),yerr=[np.sqrt(4*df.lsigma_errl**2+(0.5*(df.ltau_errl+df.ltau_erru))**2),np.sqrt(4*df.lsigma_erru**2+(0.5*(df.ltau_errl+df.ltau_erru))**2)],fmt='co',lw=1,capsize=2,mew=1,ms=4)
...
plt.errorbar(true_lsigs,true_lsigs-np.log10(0.5*df.drwvar.values**2*df.tau.values),yerr=[np.sqrt(4*df.lvar_errl**2+(0.5*(df.ltau_errl+df.ltau_erru))**2),np.sqrt(4*df.lvar_erru**2+(0.5*(df.ltau_errl+df.ltau_erru))**2)],fmt='ko',lw=1,capsize=2,mew=1,ms=4)
xlim=plt.xlim()
ylim=plt.ylim()
...
plt.errorbar(true_ltaus-df.ltau,true_lsigs-np.log10(0.5*df.sigma.values**2*df.tau.values),xerr=[df.ltau_errl,df.ltau_erru],yerr=[np.sqrt(4*df.lsigma_errl**2+(0.5*(df.ltau_errl+df.ltau_erru))**2),np.sqrt(4*df.lsigma_erru**2+(0.5*(df.ltau_errl+df.ltau_erru))**2)],fmt='co',lw=1,capsize=2,mew=1,ms=4)
xlim=plt.xlim()
ylim=plt.ylim()
xdummy=np.linspace(xlim[0],xlim[1],100)
plt.plot(xdummy,xdummy,lw=2,color='k',ls='dashed')
