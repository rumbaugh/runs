...
def reviewresults(pair,ldate='4.20.15',ddate='6.3.14',cbase='/home/rumbaugh/Fermi/TimeBombs/output/',showresults=True,ntrials=10000,testplot=False,errstd=7.5,T='T1'):
