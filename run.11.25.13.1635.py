...
prefix = 'tdc1_rung'
FILE = open('/mnt/data2/rumbaugh/TDC/tdc1sample_for_test/Dispersion_output_extended.11.25.13.dat','w')
...
for rung in range(0,5):
    for tdcbase in ref_dict:
        try:
            ...
            infile = '/mnt/data2/rumbaugh/TDC/tdc1sample_for_test/rung%i/output/%s.BA.dat'%(rung,tdcfile)
            outfile = '/mnt/data2/rumbaugh/TDC/tdc1sample_for_test/rung%i/output/conplot.%s.BA.ps'%(rung,tdcfile)
