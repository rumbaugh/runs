...
load_pha("spec_%s_soft_combined_src.pi"%(names[i]))
rmf1 = unpack_rmf("spec_%s_soft_combined_src.rmf"%(names[i]))
set_rmf(rmf1)
arf1 = unpack_arf("spec_%s_soft_combined_src.arf"%(names[i]))
set_arf(arf1)
ignore()
notice(0.5,2.0)
group_counts(15)
...
load_pha("spec_%s_hard_combined_src.pi"%(names[i]))
rmf1 = unpack_rmf("spec_%s_hard_combined_src.rmf"%(names[i]))
set_rmf(rmf1)
arf1 = unpack_arf("spec_%s_hard_combined_src.arf"%(names[i]))
set_arf(arf1)
ignore()
notice(2.0,10.0)
group_counts(15)
