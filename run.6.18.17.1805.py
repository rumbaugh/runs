...
srodf=pd.read_csv('/home/rumbaugh/Chandra/ORELSE.scaling_relation_offsets.tab',delim_whitespace=True,comment='#',names=['field','cluster','mindistlit_LxT','mindistfit_LxT','mindistfit_iter_LxT','mindistlit_sigT','mindistfit_sigT','mindistfit_iter_sigT','mindistlit_Lxsig','mindistfit_Lxsig','mindistfit_iter_Lxsig'])
