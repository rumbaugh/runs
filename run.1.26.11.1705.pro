...
plot,[0,1],[0,1],/nodata,TITLE="AGN Color-Magnitude Diagram - 0023",XTITLE="i'-Band Magnitude",YTITLE="i'-z'",PSYM=3,THICK=2,SYMSIZE=0.1,XRANGE=[17,27],YRANGE=[-3,3],xstyle=1,ystyle=1
...
oplot,zprime[g],iprime[g]-zprime[g],PSYM=2,SYMSIZE=0.3,THICK=8,color=250
g = where((0.856 ge z) and (z ge 0.82))
rsfit = 0.967-0.015*xl
rsoffset = iB-zB-rsfit
oplot,zB[g],iB[g]-zB[g],PSYM=6,THICK=3,SYMSIZE=0.8,color=160
...
rsoffset = iprime-zprime-rsfit
plot,[0,1],[0,1],/nodata,TITLE="AGN Color-Magnitude Diagram - 1324",XTITLE="i'-Band Magnitude",YTITLE="i'-z'",PSYM=3,XRANGE=[17,27],YRANGE=[-3,3],xstyle=1,ystyle=1
...
rsfit = 0.96-0.023*xl
rsoffset = iprime-zprime-rsfit
plot,[0,1],[0,1],/nodata,TITLE="AGN Color-Magnitude Diagram - NEP200",XTITLE="i'-Band Magnitude",YTITLE="i'-z'",PSYM=3,XRANGE=[17,27],YRANGE=[-3,3],xstyle=1,ystyle=1
...
rsoffset = iprime-zprime-rsfit
plot,[0,1],[0,1],/nodata,TITLE="AGN Color-Magnitude Diagram - NEP5281",XTITLE="i'-Band Magnitude",YTITLE="i'-z'",PSYM=3,XRANGE=[17,27],YRANGE=[-3,3],xstyle=1,ystyle=1
...
rsoffset = iprime-zprime-rsfit
plot,[0,1],[0,1],/nodata,TITLE="AGN Color-Magnitude Diagram - 1604 - LFC only",XTITLE="i'-Band Magnitude",YTITLE="i'-z'",PSYM=3,XRANGE=[17,27],YRANGE=[-3,3],xstyle=1,ystyle=1
