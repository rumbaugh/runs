...
crf = read_file("/home/rumbaugh/SBfits.10.30.12.dat")
#r0fit = copy_colvals(crf,'col2')
#r0fitl = copy_colvals(crf,'col3')
#r0fitu = copy_colvals(crf,'col4')
...
#FILE.close()
FILE=open('/home/rumbaugh/paperstuff/clus.lums.soft.10.30.12.dat','w')
