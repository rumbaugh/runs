...
FILE=open('/home/rumbaugh/runs/run.5.30.14.1315.sh','w')
FILE.write("#!/bin/csh\n")
...
for date,aipsdate in zip(dates,aips_dates):
    ...
    for source in tsources:
        ...
        outfile = '/mnt/data2/rumbaugh/VLA/AF377/difmap_results/fit_aipsredux_UVR_0_300_5.30.14.%s.varpos.%s.mod'%(source,date)
        FILE.write('wmod %s\n'%outfile)
