...
crCMD=np.loadtxt('/home/rumbaugh/Chandra/ORELSE_cluster_member_info_all.6.26.17.dat',dtype={'names':('field','cluster','ra','dec','z','mag','col','rso','isBCG','isBCG_tot'),'formats':('|S12','|S12','f8','f8','f8','f8','f8','f8','i8','i8')})
...
outdf.to_csv('/home/rumbaugh/Chandra/ORELSE.BCG_vels.6.26.17.csv',index=False)
