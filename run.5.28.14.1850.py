...
FILE=open('/home/rumbaugh/runs/run.5.28.14.1850.sh','w')
FILE.write("#!/bin/csh\n")
...
for date,aipsdate in zip(dates,aips_dates):
    ...
    for source in tsources:
        ...
        #else:
        FILE.write('rmod /mnt/data2/rumbaugh/VLA/AF377/models/20010212_%s_g_w2jet.mod\n'%(source[:4]))
        ...
        outfile = '/mnt/data2/rumbaugh/VLA/AF377/difmap_results/fit_aipsredux_w2jet_5.28.14.%s.fixpos.%s.mod'%(source,date)
        FILE.write('wmod %s\n'%outfile)
