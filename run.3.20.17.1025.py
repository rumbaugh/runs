...
plot_DB_lightcurves(crmd['DBID'],'/home/rumbaugh/DR7_EVQ_lightcurves.3.20.17.pdf',DBdir='/home/rumbaugh/var_database/Y3A1',outlierflags=crmd['flag'],zoominband='g',calc_outliers=True)
