...
cr = read_file("/local3/rumbaugh/ChandraData/2229/opt_match/opt_Xray_matched_catalog_3high.twk.dat")
cr2 = read_file("/local3/rumbaugh/ChandraData/2229/opt_match/opt_Xray_matched_catalog_3high.twk.dat.minsrch.dat")

FILE=open("/local3/rumbaugh/ChandraData/2229/opt_match/regions/discrepant_sources.reg","w")
for i in range(0,1):
