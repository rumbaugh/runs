...
for imgname in imgnames:
    ...
    for i in range(0,ntrials):
        ...
        ttmp,mtmp,BA_disp_mat[i] = calc_disp_delay(fluxdict[imgname][gAonly[g]]+rC[g],Bflux[gAonly[g2]]+rB[g2],ltime[gAonly],ltime[gAonly],errdict[imgname][gAonly[g]],Berr[gAonly[g2]],maxtimestep,timestep,minmu,maxmu,mustep,'D_4_2a',delta,output=2,verbose=False)
        FILE.write('%E\n'%(BA_disp_mat[i]))
        if i == 0: 
            t0 = time.time()
