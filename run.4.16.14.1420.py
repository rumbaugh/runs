...
calc_disp_delay(Sfull[g],Sfull[g],ltime[g],ltime[g],Sfullerr[g],Sfullerr[g],maxtime,timestep,minmu,maxmu,mustep,disp_type,delta=delta,mintime=mintime,dispmatrix=True,outfile=outfile)
