...
sampler = emcee.EnsembleSampler(nwalkers,ndim,delaylnprob,args=[Bflux[g],Aflux[g],Berr[g],Aerr[g],ltime[g],mu_init,mintime,maxtime,False,False,False,'interpolate'])
pos,prob,state=sampler.run_mcmc(p0,100)
sampler.reset()
pos,prob,state=sampler.run_mcmc(pos,runs)
FILE = open('/home/rumbaugh/EVLA/light_curves/Dispersions/%s.emcee_output_full_chain.%s.dat'%(lens,date),'w')
