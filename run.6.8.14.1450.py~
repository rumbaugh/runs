...
#find time delays
    ...
    sampler = emcee.EnsembleSampler(nwalkers,ndim,delaylnprob,args=[Bflux[g],Aflux[g],Berr[g],Aerr[g],ltime[g],mu_init,mintime,maxtime,False,True,True,'interp',10.,0.5,None])
