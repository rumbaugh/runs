...
FILEl=open('/home/rumbaugh/Chandra/fluxes_newphotoz_adam.1sig.7.26.16.dat','w')
...
for field in ['cl1604']:
    ...
    if field in ['rxj0910','rcs0224','cl1324','rxj1757']:
    ...
    if field=='cl1324':print 'New Blue Fraction: %f'%((0.32*454+np.sum(P_inclus[gnew0][gnew][gBC]))/(454+np.sum(P_inclus[gnew0][gnew])))
    ...
    plt.savefig('/home/rumbaugh/Chandra/plots/P_inclus_test.%s.7.26.16.png'%field)
    plt.figure(2)
    plt.clf()
    plt.hist(P_inclus[gold][((crpz['z_spec'][gold]>=fzl)&(crpz['z_spec'][gold]<=fzu))],range=(0,1),bins=20)
    plt.xlim(0,1)
    plt.xlabel('P(in_structure)')
    plt.savefig('/home/rumbaugh/Chandra/plots/P_inclus_test_hist.%s.7.26.16.png'%field)
