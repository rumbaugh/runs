...
ttmp,mtmp,BA_disp = calc_disp_delay(Aflux[g],Bflux[g],ltime[g],ltime[g],Aerr[g],Berr[g],maxtimestep,timestep,minmu,maxmu,mustep,'D_4_2b',delta,output=2,simplemuerr=True)
