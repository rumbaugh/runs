...
a=ax.hist(cr['Baseline']/(1.+data['redshift'][gmf]),range=(0,6500),bins=26,color='k',edgecolor='k',facecolor='None',lw=2)
b=ax2.plot(np.sort(cr['Baseline']/(1.+data['redshift'][gmf])),(np.arange(len(cr))+1.)/len(cr),lw=2,color='r')
...
ax2.set_xlim(0,6500)
ax2.set_ylim(0,1)
fig.savefig('/home/rumbaugh/var_database/Y3A1/plots/MaxChangeBaselinePlot.RF.CLQ_candidates.DR7.4.10.17.png')
