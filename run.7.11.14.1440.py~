...
#plt.savefig('/mnt/data2/rumbaugh/Fermi/plots/testmock.frt_vs_ftimestd.%s.png'%date)
...
plt.tick_params(which='major',length=8,width=2,labelsize=14)
plt.tick_params(which='minor',length=4,width=1.5,labelsize=14)
plt.scatter(mskew,skewSTD,c='k',s=2)
...
plt.savefig('/mnt/data2/rumbaugh/Fermi/plots/testmock.skewavg_vs_skewstd.%s.png'%date)
...
plt.tick_params(which='major',length=8,width=2,labelsize=14)
plt.tick_params(which='minor',length=4,width=1.5,labelsize=14)
plt.scatter(mTfl,TflSTD,c='k',s=2)
LinReg(mTfl,TflSTD)
tx = np.array([0,np.max(mTfl)])
plt.plot(tx,0.121+0.482*tx,color='b')
...
plt.savefig('/mnt/data2/rumbaugh/Fermi/plots/testmock.Tflavg_vs_Tflstd.%s.png'%date)
...
plt.tick_params(which='major',length=8,width=2,labelsize=14)
plt.tick_params(which='minor',length=4,width=1.5,labelsize=14)
plt.scatter(mAmp,AmpSTD,c='k',s=2)
LinReg(mAmp,AmpSTD)
tx = np.array([0,np.max(mAmp)])
plt.plot(tx,-11.8+0.612*tx,color='b')
...
plt.savefig('/mnt/data2/rumbaugh/Fermi/plots/testmock.ampavg_vs_ampstd.%s.png'%date)
...
#plt.savefig('/mnt/data2/rumbaugh/Fermi/plots/testmock.nampavg_vs_nampstd.%s.png'%date)
