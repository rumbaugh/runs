set_plot,'PS'
loadct,13
device,file='/home/rumbaugh/testLumvsRS.nospectar.8.16.11.ps',/color

xt = [-6.1,-6.1,-3,-3,-1,-1,2,2,10,10,-20,-20,10,10,-20]
yt = [30,50,50,30,30,50,50,30,30,43.3,43.3,43.0,43.0,42.5,42.5]
...
pnames = ['/home/rumbaugh/LFC/cl0023_radecIDmags.cat',"LFC/final.idradecmag.lfcpluscosmic.withsdss.cat","/home/rumbaugh/LFC/sc1322.lfc.newIDsandoldIds.radecmag.cat","/home/rumbaugh/LFC/nep5281.lfc.newIDradecmag.cat","/home/rumbaugh/LFC/nep200.idradecmag.lfc.uhcorr.neat"]
...
m1604 = (43.35861-43.38914)/(240.9075-241.19939)
y01604 = 43.38914 
x01604 = 241.19939
...
fourpiDL2 = [1.676,1.987,1.148,1.58,1.034]/(0.7*0.7) ;times 10^57 ;using z=0.84,0.9,0.72,0.82,0.69
...
if i eq 1 then readcol,"/home/rumbaugh/LFC/ACS_merged.F606W+F814W_deep.all.coll.nh.dat",pra,pdec,p606,p814,d606,d814,rh606,rh814,c606,c814,format='D,D,D,D,D,D,D,D,D,D',/silent &$
...
if i eq 1 then gntall = where((nm gt 0.1)) &$
for j=0,n_elements(gnt)-1 do begin &$
   ...
   if i eq 1 then gidLFC = where(LFCID eq optID[gnt[j]]) &$
   if ((gid[0] lt -0.1) and (gidLFC[0] gt -0.1)) then gid = gidLFC &$
   if ((i ne 1) and (nm[gnt[j]] gt 1.1)) then gid2 = where(LFCID eq optID2[gnt[j]]) &$
   if ((i eq 1) and (nm[gnt[j]] gt 1.1)) then gid2LFC = where(LFCID eq optID2[gnt[j]]) &$
   if ((i eq 1) and (nm[gnt[j]] gt 1.1)) then gid2 = where(acsID eq optID2[gnt[j]]) &$
   if ((gid2[0] lt -0.1) and (gid2LFC[0] gt -0.1)) then gid2 = gid2LFC &$
...
for j=0,n_elements(gnotar)-1 do begin &$
   ...
   if i eq 1 then gliLFC = where(pID eq optID[gnotar[j]]) &$
   if ((i eq 1) and (gliLFC[0] lt -0.1)) then gli = long(optID[gnotar[j]])-2 &$
   ...
   if ((i eq 1) and ((rprime[j] lt 1) or (rprime[j] gt 50))) then rprime[j] = pR[gli[0]] &$
   if ((i eq 1) and ((iprime[j] lt 1) or (iprime[j] gt 50))) then iprime[j] = pI[gli[0]] &$
   if ((i eq 1) and ((rprime[j] lt 1) or (rprime[j] gt 50))) then rprime[j] = pR[gliLFC[0]] &$
   if ((i eq 1) and ((iprime[j] lt 1) or (iprime[j] gt 50))) then iprime[j] = pI[gliLFC[0]] &$
...
g3s = where((sigmax[gnotar] ge 3) and (rprime gt 0) and (iprime gt 0)) &$
g2s = where((sigmax[gnotar] ge 2) and (rprime gt 0) and (iprime gt 0)) &$
;if (i eq 2) then for j=0,n_elements(rswids)-1 do print,rsoffset[j],rswids[j],rprime[j],iprime[j],(-1*rsm[i]*iprime[j]+rsb[i]),flums[j] &$
plot,[0-1],[0-1],/nodata,YRANGE=[41.5,46],XRANGE=[-20,10],/xstyle,/ystyle,XTITLE='RS Offsets (RS Wids)',YTITLE='Log Luminosity',TITLE=names[i] + " - Not Targeted for Spectroscopy",XTHICK=4,YTHICK=4,CHARTHICK=3 &$
...
print,names[i]   
print, '> 2s'
gtt = where((flums[g2s] gt 43.3) and (rprime[g2s] gt 0) and (iprime[g2s] gt 0))
if gtt[0] eq -1 then gtt = []
print,'Lum > 43.3: ',n_elements(gtt)
gtt = where((flums[g2s] gt 43.3) and (rswids[g2s] gt -6.1) and (rswids[g2s] lt -3))
if gtt[0] eq -1 then gtt = []
print,'Lum > 43.3, -6.1>C>-3: ',n_elements(gtt)
gtt = where((flums[g2s] gt 43.3) and (rswids[g2s] gt -3) and (rswids[g2s] lt -1))
if gtt[0] eq -1 then gtt = []
print,'Lum > 43.3, -3>C>-1: ',n_elements(gtt)
gtt = where((flums[g2s] gt 43.3) and (rswids[g2s] gt -1) and (rswids[g2s] lt 2))
if gtt[0] eq -1 then gtt = []
print,'Lum > 43.3, -1>C>-2: ',n_elements(gtt)
gtt = where((flums[g2s] gt 42.5) and (flums[g2s] lt 43.3) and (rswids[g2s] gt -6.1) and (rswids[g2s] lt -3))
if gtt[0] eq -1 then gtt = []
print,'43.3 > Lum > 42.5, -6.1>C>-3: ',n_elements(gtt)
gtt = where((flums[g2s] gt 42.5) and (flums[g2s] lt 43.3) and (rswids[g2s] gt -3) and (rswids[g2s] lt -1))
if gtt[0] eq -1 then gtt = []
print,'43.3 > Lum > 42.5, -3>C>-1: ',n_elements(gtt)
gtt = where((flums[g2s] gt 42.5) and (flums[g2s] lt 43.3) and (rswids[g2s] gt -1) and (rswids[g2s] lt 2))
if gtt[0] eq -1 then gtt = []
print,'43.3 > Lum > 42.5, -1>C>-2: ',n_elements(gtt)
gtt = where((flums[g2s] gt 43.0) and (rswids[g2s] gt -6.1) and (rswids[g2s] lt -3))
if gtt[0] eq -1 then gtt = []
print,'Lum > 43.0, -6.1>C>-3: ',n_elements(gtt)
...
gtt = where((flums[g2s] gt 42.5) and (flums[g2s] lt 43.0) and (rswids[g2s] gt -6.1) and (rswids[g2s] lt -3))
if gtt[0] eq -1 then gtt = []
print,'43.0 > Lum > 42.5, -6.1>C>-3: ',n_elements(gtt)
...
gtt = where((flums[g2s] lt 42.5) and (rswids[g2s] gt -6.1) and (rswids[g2s] lt -3))
if gtt[0] eq -1 then gtt = []
print,'Lum < 42.5, -6.1>C>-3: ',n_elements(gtt)
...
print, '> 3s'
gtt = where((flums[g3s] gt 43.3) and (rprime[g3s] gt 0) and (iprime[g3s] gt 0))
if gtt[0] eq -1 then gtt = []
print,'Lum > 43.3: ',n_elements(gtt)
gtt = where((flums[g3s] gt 43.3) and (rswids[g3s] gt -6.1) and (rswids[g3s] lt -3))
if gtt[0] eq -1 then gtt = []
print,'Lum > 43.3, -6.1>C>-3: ',n_elements(gtt)
gtt = where((flums[g3s] gt 43.3) and (rswids[g3s] gt -3) and (rswids[g3s] lt -1))
if gtt[0] eq -1 then gtt = []
print,'Lum > 43.3, -3>C>-1: ',n_elements(gtt)
gtt = where((flums[g3s] gt 43.3) and (rswids[g3s] gt -1) and (rswids[g3s] lt 2))
if gtt[0] eq -1 then gtt = []
print,'Lum > 43.3, -1>C>-2: ',n_elements(gtt)
gtt = where((flums[g3s] gt 42.5) and (flums[g3s] lt 43.3) and (rswids[g3s] gt -6.1) and (rswids[g3s] lt -3))
if gtt[0] eq -1 then gtt = []
print,'43.3 > Lum > 42.5, -6.1>C>-3: ',n_elements(gtt)
gtt = where((flums[g3s] gt 42.5) and (flums[g3s] lt 43.3) and (rswids[g3s] gt -3) and (rswids[g3s] lt -1))
if gtt[0] eq -1 then gtt = []
print,'43.3 > Lum > 42.5, -3>C>-1: ',n_elements(gtt)
gtt = where((flums[g3s] gt 42.5) and (flums[g3s] lt 43.3) and (rswids[g3s] gt -1) and (rswids[g3s] lt 2))
if gtt[0] eq -1 then gtt = []
print,'43.3 > Lum > 42.5, -1>C>-2: ',n_elements(gtt)
gtt = where((flums[g3s] gt 43.0) and (rswids[g3s] gt -6.1) and (rswids[g3s] lt -3))
if gtt[0] eq -1 then gtt = []
print,'Lum > 43.0, -6.1>C>-3: ',n_elements(gtt)
...
if gtt[0] eq -1 then gtt = []
print,'Lum > 43.0, -1>C>-2: ',n_elements(gtt)
gtt = where((flums[g3s] gt 42.5) and (flums[g3s] lt 43.0) and (rswids[g3s] gt -6.1) and (rswids[g3s] lt -3))
if gtt[0] eq -1 then gtt = []
print,'43.0 > Lum > 42.5, -6.1>C>-3: ',n_elements(gtt)
...
if gtt[0] eq -1 then gtt = []
print,'43.0 > Lum > 42.5, -1>C>-2: ',n_elements(gtt)
gtt = where((flums[g3s] lt 42.5) and (rswids[g3s] gt -6.1) and (rswids[g3s] lt -3))
if gtt[0] eq -1 then gtt = []
print,'Lum < 42.5, -6.1>C>-3: ',n_elements(gtt)
...
print,'Lum < 42.5, -1>C>-2: ',n_elements(gtt)
   ...
   if i eq 1 then gliLFC = where(pID eq optID[gnotar[j]]) &$
   if ((i eq 1) and (gliLFC[0] lt -0.1)) then gli = long(optID[gnt[gtar[j]]])-2 &$
   ...
   if ((i eq 1) and ((rprimet[j] lt 1) or (rprimet[j] gt 50))) then rprimet[j] = pR[gli[0]] &$
   if ((i eq 1) and ((iprimet[j] lt 1) or (iprimet[j] gt 50))) then iprimet[j] = pI[gli[0]] &$
   if ((i eq 1) and ((rprimet[j] lt 1) or (rprimet[j] gt 50))) then rprimet[j] = pR[gliLFC[0]] &$
   if ((i eq 1) and ((iprimet[j] lt 1) or (iprimet[j] gt 50))) then iprimet[j] = pI[gliLFC[0]] &$
...
g3st = where((sigmax[gnt[gtar]] ge 3) and (rprime gt 0) and (iprime gt 0)) &$
g2st = where((sigmax[gnt[gtar]] ge 2) and (rprime gt 0) and (iprime gt 0)) &$
;if (i eq 2) then for j=0,n_elements(rswids)-1 do print,rsoffset[j],rswids[j],rprime[j],iprime[j],(-1*rsm[i]*iprime[j]+rsb[i]),flums[j] &$
plot,[0-1],[0-1],/nodata,YRANGE=[41.5,46],XRANGE=[-20,10],/xstyle,/ystyle,XTITLE='RS Offsets (RS Wids)',YTITLE='Log Luminosity',TITLE=names[i] + ' - Targeted for Spectroscopy',XTHICK=4,YTHICK=4,CHARTHICK=3 &$
...
print, '> 2s'
gtt = where((flumst[g2st] gt 43.3) and (rprime[g2st] gt 0) and (iprime[g2st] gt 0))
if gtt[0] eq -1 then gtt = []
print,'Lum > 43.3: ',n_elements(gtt)
gtt = where((flumst[g2st] gt 43.3) and (rswidst[g2st] gt -6.1) and (rswidst[g2st] lt -3))
if gtt[0] eq -1 then gtt = []
print,'Lum > 43.3, -6.1>C>-3: ',n_elements(gtt)
gtt = where((flumst[g2st] gt 43.3) and (rswidst[g2st] gt -3) and (rswidst[g2st] lt -1))
if gtt[0] eq -1 then gtt = []
print,'Lum > 43.3, -3>C>-1: ',n_elements(gtt)
gtt = where((flumst[g2st] gt 43.3) and (rswidst[g2st] gt -1) and (rswidst[g2st] lt 2))
if gtt[0] eq -1 then gtt = []
print,'Lum > 43.3, -1>C>-2: ',n_elements(gtt)
gtt = where((flumst[g2st] gt 42.5) and (flumst[g2st] lt 43.3) and (rswidst[g2st] gt -6.1) and (rswidst[g2st] lt -3))
if gtt[0] eq -1 then gtt = []
print,'43.3 > Lum > 42.5, -6.1>C>-3: ',n_elements(gtt)
gtt = where((flumst[g2st] gt 42.5) and (flumst[g2st] lt 43.3) and (rswidst[g2st] gt -3) and (rswidst[g2st] lt -1))
if gtt[0] eq -1 then gtt = []
print,'43.3 > Lum > 42.5, -3>C>-1: ',n_elements(gtt)
gtt = where((flumst[g2st] gt 42.5) and (flumst[g2st] lt 43.3) and (rswidst[g2st] gt -1) and (rswidst[g2st] lt 2))
if gtt[0] eq -1 then gtt = []
print,'43.3 > Lum > 42.5, -1>C>-2: ',n_elements(gtt)
gtt = where((flumst[g2st] gt 43.0) and (rswidst[g2st] gt -6.1) and (rswidst[g2st] lt -3))
if gtt[0] eq -1 then gtt = []
print,'Lum > 43.0, -6.1>C>-3: ',n_elements(gtt)
...
if gtt[0] eq -1 then gtt = []
print,'Lum > 43.0, -1>C>-2: ',n_elements(gtt)
gtt = where((flumst[g2st] gt 42.5) and (flumst[g2st] lt 43.0) and (rswidst[g2st] gt -6.1) and (rswidst[g2st] lt -3))
if gtt[0] eq -1 then gtt = []
print,'43.0 > Lum > 42.5, -6.1>C>-3: ',n_elements(gtt)
...
if gtt[0] eq -1 then gtt = []
print,'43.0 > Lum > 42.5, -1>C>-2: ',n_elements(gtt)
gtt = where((flumst[g2st] lt 42.5) and (rswidst[g2st] gt -6.1) and (rswidst[g2st] lt -3))
if gtt[0] eq -1 then gtt = []
print,'Lum < 42.5, -6.1>C>-3: ',n_elements(gtt)
...
print, '> 3s'
gtt = where((flumst[g3st] gt 43.3) and (rprime[g3st] gt 0) and (iprime[g3st] gt 0))
if gtt[0] eq -1 then gtt = []
print,'Lum > 43.3: ',n_elements(gtt)
gtt = where((flumst[g3st] gt 43.3) and (rswidst[g3st] gt -6.1) and (rswidst[g3st] lt -3))
if gtt[0] eq -1 then gtt = []
print,'Lum > 43.3, -6.1>C>-3: ',n_elements(gtt)
gtt = where((flumst[g3st] gt 43.3) and (rswidst[g3st] gt -3) and (rswidst[g3st] lt -1))
if gtt[0] eq -1 then gtt = []
print,'Lum > 43.3, -3>C>-1: ',n_elements(gtt)
gtt = where((flumst[g3st] gt 43.3) and (rswidst[g3st] gt -1) and (rswidst[g3st] lt 2))
if gtt[0] eq -1 then gtt = []
print,'Lum > 43.3, -1>C>-2: ',n_elements(gtt)
gtt = where((flumst[g3st] gt 42.5) and (flumst[g3st] lt 43.3) and (rswidst[g3st] gt -6.1) and (rswidst[g3st] lt -3))
if gtt[0] eq -1 then gtt = []
print,'43.3 > Lum > 42.5, -6.1>C>-3: ',n_elements(gtt)
gtt = where((flumst[g3st] gt 42.5) and (flumst[g3st] lt 43.3) and (rswidst[g3st] gt -3) and (rswidst[g3st] lt -1))
if gtt[0] eq -1 then gtt = []
print,'43.3 > Lum > 42.5, -3>C>-1: ',n_elements(gtt)
gtt = where((flumst[g3st] gt 42.5) and (flumst[g3st] lt 43.3) and (rswidst[g3st] gt -1) and (rswidst[g3st] lt 2))
if gtt[0] eq -1 then gtt = []
print,'43.3 > Lum > 42.5, -1>C>-2: ',n_elements(gtt)
gtt = where((flumst[g3st] gt 43.0) and (rswidst[g3st] gt -6.1) and (rswidst[g3st] lt -3))
if gtt[0] eq -1 then gtt = []
print,'Lum > 43.0, -6.1>C>-3: ',n_elements(gtt)
...
if gtt[0] eq -1 then gtt = []
print,'Lum > 43.0, -1>C>-2: ',n_elements(gtt)
gtt = where((flumst[g3st] gt 42.5) and (flumst[g3st] lt 43.0) and (rswidst[g3st] gt -6.1) and (rswidst[g3st] lt -3))
if gtt[0] eq -1 then gtt = []
print,'43.0 > Lum > 42.5, -6.1>C>-3: ',n_elements(gtt)
...
if gtt[0] eq -1 then gtt = []
print,'43.0 > Lum > 42.5, -1>C>-2: ',n_elements(gtt)
gtt = where((flumst[g3st] lt 42.5) and (rswidst[g3st] gt -6.1) and (rswidst[g3st] lt -3))
if gtt[0] eq -1 then gtt = []
print,'Lum < 42.5, -6.1>C>-3: ',n_elements(gtt)
...
plot,[0-1],[0-1],/nodata,YRANGE=[41.5,46],XRANGE=[-15,6],/xsty,/ysty,XTITLE='RS Offsets (RS Wids)',YTITLE='Log Luminosity',TITLE='All Fields - Not Targeted for Spectroscopy',XTHICK=4,YTHICK=4,CHARTHICK=3
...
plot,[0-1],[0-1],/nodata,YRANGE=[41.5,46],XRANGE=[-15,6],/xsty,/ysty,XTITLE='RS Offsets (RS Wids)',YTITLE='Log Luminosity',TITLE='All Fields - Targeted for Spectroscopy',XTHICK=4,YTHICK=4,CHARTHICK=3
...
plot,[0-1],[0-1],/nodata,YRANGE=[41.5,46],XRANGE=[-20,10],/xsty,/ysty,XTITLE='RS Offsets (RS Wids)',YTITLE='Log Luminosity',TITLE='All Fields - Not Targeted for Spectroscopy',XTHICK=4,YTHICK=4,CHARTHICK=3
...
print,'>2 sig'
gtemp = where((flumsYg2s gt 43.3) and (rswidsYg2s gt -6.1) and (rswidsYg2s lt -3))
if gtemp[0] eq -1 then gtemp = []
print,'Lum > 43.3, -6.1>C>-3, young: ',n_elements(gtemp)
gtemp = where((flumsOg2s gt 43.3) and (rswidsOg2s gt -6.1) and (rswidsOg2s lt -3))
if gtemp[0] eq -1 then gtemp = []
print,'Lum > 43.3, -6.1>C>-3, old: ',n_elements(gtemp)
gtemp = where((flumsYg2s gt 43.3) and (rswidsYg2s gt -3) and (rswidsYg2s lt -1))
if gtemp[0] eq -1 then gtemp = []
print,'Lum > 43.3, -3>C>-1, young: ',n_elements(gtemp)
gtemp = where((flumsOg2s gt 43.3) and (rswidsOg2s gt -3) and (rswidsOg2s lt -1))
if gtemp[0] eq -1 then gtemp = []
print,'Lum > 43.3, -3>C>-1, old: ',n_elements(gtemp)
gtemp = where((flumsYg2s gt 43.3) and (rswidsYg2s gt -1) and (rswidsYg2s lt 2))
if gtemp[0] eq -1 then gtemp = []
print,'Lum > 43.3, -1>C>+2, young: ',n_elements(gtemp)
gtemp = where((flumsOg2s gt 43.3) and (rswidsOg2s gt -1) and (rswidsOg2s lt 2))
if gtemp[0] eq -1 then gtemp = []
print,'Lum > 43.3, -1>C>+2, old: ',n_elements(gtemp)
gtemp = where((flumsYg2s lt 43.3) and (rswidsYg2s gt -6.1) and (rswidsYg2s lt -3))
if gtemp[0] eq -1 then gtemp = []
print,'Lum < 43.3, -6.1>C>-3, young: ',n_elements(gtemp)
gtemp = where((flumsOg2s lt 43.3) and (rswidsOg2s gt -6.1) and (rswidsOg2s lt -3))
if gtemp[0] eq -1 then gtemp = []
print,'Lum < 43.3, -6.1>C>-3, old: ',n_elements(gtemp)
gtemp = where((flumsYg2s lt 43.3) and (rswidsYg2s gt -3) and (rswidsYg2s lt -1))
if gtemp[0] eq -1 then gtemp = []
print,'Lum < 43.3, -3>C>-1, young: ',n_elements(gtemp)
gtemp = where((flumsOg2s lt 43.3) and (rswidsOg2s gt -3) and (rswidsOg2s lt -1))
if gtemp[0] eq -1 then gtemp = []
print,'Lum < 43.3, -3>C>-1, old: ',n_elements(gtemp)
gtemp = where((flumsYg2s lt 43.3) and (rswidsYg2s gt -1) and (rswidsYg2s lt 2))
if gtemp[0] eq -1 then gtemp = []
print,'Lum < 43.3, -1>C>+2, young: ',n_elements(gtemp)
gtemp = where((flumsOg2s lt 43.3) and (rswidsOg2s gt -1) and (rswidsOg2s lt 2))
if gtemp[0] eq -1 then gtemp = []
print,'Lum < 43.3, -1>C>+2, old: ',n_elements(gtemp)
print,'>3 sig'
gtemp = where((flumsYg3s gt 43.3) and (rswidsYg3s gt -6.1) and (rswidsYg3s lt -3))
if gtemp[0] eq -1 then gtemp = []
print,'Lum > 43.3, -6.1>C>-3, young: ',n_elements(gtemp)
gtemp = where((flumsOg3s gt 43.3) and (rswidsOg3s gt -6.1) and (rswidsOg3s lt -3))
if gtemp[0] eq -1 then gtemp = []
print,'Lum > 43.3, -6.1>C>-3, old: ',n_elements(gtemp)
gtemp = where((flumsYg3s gt 43.3) and (rswidsYg3s gt -3) and (rswidsYg3s lt -1))
if gtemp[0] eq -1 then gtemp = []
print,'Lum > 43.3, -3>C>-1, young: ',n_elements(gtemp)
gtemp = where((flumsOg3s gt 43.3) and (rswidsOg3s gt -3) and (rswidsOg3s lt -1))
if gtemp[0] eq -1 then gtemp = []
print,'Lum > 43.3, -3>C>-1, old: ',n_elements(gtemp)
gtemp = where((flumsYg3s gt 43.3) and (rswidsYg3s gt -1) and (rswidsYg3s lt 2))
if gtemp[0] eq -1 then gtemp = []
print,'Lum > 43.3, -1>C>+2, young: ',n_elements(gtemp)
gtemp = where((flumsOg3s gt 43.3) and (rswidsOg3s gt -1) and (rswidsOg3s lt 2))
if gtemp[0] eq -1 then gtemp = []
print,'Lum > 43.3, -1>C>+2, old: ',n_elements(gtemp)
gtemp = where((flumsYg3s lt 43.3) and (rswidsYg3s gt -6.1) and (rswidsYg3s lt -3))
if gtemp[0] eq -1 then gtemp = []
print,'Lum < 43.3, -6.1>C>-3, young: ',n_elements(gtemp)
gtemp = where((flumsOg3s lt 43.3) and (rswidsOg3s gt -6.1) and (rswidsOg3s lt -3))
if gtemp[0] eq -1 then gtemp = []
print,'Lum < 43.3, -6.1>C>-3, old: ',n_elements(gtemp)
gtemp = where((flumsYg3s lt 43.3) and (rswidsYg3s gt -3) and (rswidsYg3s lt -1))
if gtemp[0] eq -1 then gtemp = []
print,'Lum < 43.3, -3>C>-1, young: ',n_elements(gtemp)
gtemp = where((flumsOg3s lt 43.3) and (rswidsOg3s gt -3) and (rswidsOg3s lt -1))
if gtemp[0] eq -1 then gtemp = []
print,'Lum < 43.3, -3>C>-1, old: ',n_elements(gtemp)
gtemp = where((flumsYg3s lt 43.3) and (rswidsYg3s gt -1) and (rswidsYg3s lt 2))
if gtemp[0] eq -1 then gtemp = []
print,'Lum < 43.3, -1>C>+2, young: ',n_elements(gtemp)
gtemp = where((flumsOg3s lt 43.3) and (rswidsOg3s gt -1) and (rswidsOg3s lt 2))
if gtemp[0] eq -1 then gtemp = []
print,'Lum < 43.3, -1>C>+2, old: ',n_elements(gtemp)


plot,[0-1],[0-1],/nodata,YRANGE=[41.5,46],XRANGE=[-20,10],/xsty,/ysty,XTITLE='RS Offsets (RS Wids)',YTITLE='Log Luminosity',TITLE='All Fields - Targeted for Spectroscopy',XTHICK=4,YTHICK=4,CHARTHICK=3
...
print,'>2 sig'
gtemp = where((flumsYg2st gt 43.3) and (rswidsYg2st gt -6.1) and (rswidsYg2st lt -3))
if gtemp[0] eq -1 then gtemp = []
print,'Lum > 43.3, -6.1>C>-3, young: ',n_elements(gtemp)
gtemp = where((flumsOg2st gt 43.3) and (rswidsOg2st gt -6.1) and (rswidsOg2st lt -3))
if gtemp[0] eq -1 then gtemp = []
print,'Lum > 43.3, -6.1>C>-3, old: ',n_elements(gtemp)
gtemp = where((flumsYg2st gt 43.3) and (rswidsYg2st gt -3) and (rswidsYg2st lt -1))
if gtemp[0] eq -1 then gtemp = []
print,'Lum > 43.3, -3>C>-1, young: ',n_elements(gtemp)
gtemp = where((flumsOg2st gt 43.3) and (rswidsOg2st gt -3) and (rswidsOg2st lt -1))
if gtemp[0] eq -1 then gtemp = []
print,'Lum > 43.3, -3>C>-1, old: ',n_elements(gtemp)
gtemp = where((flumsYg2st gt 43.3) and (rswidsYg2st gt -1) and (rswidsYg2st lt 2))
if gtemp[0] eq -1 then gtemp = []
print,'Lum > 43.3, -1>C>+2, young: ',n_elements(gtemp)
gtemp = where((flumsOg2st gt 43.3) and (rswidsOg2st gt -1) and (rswidsOg2st lt 2))
if gtemp[0] eq -1 then gtemp = []
print,'Lum > 43.3, -1>C>+2, old: ',n_elements(gtemp)
gtemp = where((flumsYg2st lt 43.3) and (rswidsYg2st gt -6.1) and (rswidsYg2st lt -3))
if gtemp[0] eq -1 then gtemp = []
print,'Lum < 43.3, -6.1>C>-3, young: ',n_elements(gtemp)
gtemp = where((flumsOg2st lt 43.3) and (rswidsOg2st gt -6.1) and (rswidsOg2st lt -3))
if gtemp[0] eq -1 then gtemp = []
print,'Lum < 43.3, -6.1>C>-3, old: ',n_elements(gtemp)
gtemp = where((flumsYg2st lt 43.3) and (rswidsYg2st gt -3) and (rswidsYg2st lt -1))
if gtemp[0] eq -1 then gtemp = []
print,'Lum < 43.3, -3>C>-1, young: ',n_elements(gtemp)
gtemp = where((flumsOg2st lt 43.3) and (rswidsOg2st gt -3) and (rswidsOg2st lt -1))
if gtemp[0] eq -1 then gtemp = []
print,'Lum < 43.3, -3>C>-1, old: ',n_elements(gtemp)
gtemp = where((flumsYg2st lt 43.3) and (rswidsYg2st gt -1) and (rswidsYg2st lt 2))
if gtemp[0] eq -1 then gtemp = []
print,'Lum < 43.3, -1>C>+2, young: ',n_elements(gtemp)
gtemp = where((flumsOg2st lt 43.3) and (rswidsOg2st gt -1) and (rswidsOg2st lt 2))
if gtemp[0] eq -1 then gtemp = []
print,'Lum < 43.3, -1>C>+2, old: ',n_elements(gtemp)
print,'>3 sig'
gtemp = where((flumsYg3st gt 43.3) and (rswidsYg3st gt -6.1) and (rswidsYg3st lt -3))
if gtemp[0] eq -1 then gtemp = []
print,'Lum > 43.3, -6.1>C>-3, young: ',n_elements(gtemp)
gtemp = where((flumsOg3st gt 43.3) and (rswidsOg3st gt -6.1) and (rswidsOg3st lt -3))
if gtemp[0] eq -1 then gtemp = []
print,'Lum > 43.3, -6.1>C>-3, old: ',n_elements(gtemp)
gtemp = where((flumsYg3st gt 43.3) and (rswidsYg3st gt -3) and (rswidsYg3st lt -1))
if gtemp[0] eq -1 then gtemp = []
print,'Lum > 43.3, -3>C>-1, young: ',n_elements(gtemp)
gtemp = where((flumsOg3st gt 43.3) and (rswidsOg3st gt -3) and (rswidsOg3st lt -1))
if gtemp[0] eq -1 then gtemp = []
print,'Lum > 43.3, -3>C>-1, old: ',n_elements(gtemp)
gtemp = where((flumsYg3st gt 43.3) and (rswidsYg3st gt -1) and (rswidsYg3st lt 2))
if gtemp[0] eq -1 then gtemp = []
print,'Lum > 43.3, -1>C>+2, young: ',n_elements(gtemp)
gtemp = where((flumsOg3st gt 43.3) and (rswidsOg3st gt -1) and (rswidsOg3st lt 2))
if gtemp[0] eq -1 then gtemp = []
print,'Lum > 43.3, -1>C>+2, old: ',n_elements(gtemp)
gtemp = where((flumsYg3st lt 43.3) and (rswidsYg3st gt -6.1) and (rswidsYg3st lt -3))
if gtemp[0] eq -1 then gtemp = []
print,'Lum < 43.3, -6.1>C>-3, young: ',n_elements(gtemp)
gtemp = where((flumsOg3st lt 43.3) and (rswidsOg3st gt -6.1) and (rswidsOg3st lt -3))
if gtemp[0] eq -1 then gtemp = []
print,'Lum < 43.3, -6.1>C>-3, old: ',n_elements(gtemp)
gtemp = where((flumsYg3st lt 43.3) and (rswidsYg3st gt -3) and (rswidsYg3st lt -1))
if gtemp[0] eq -1 then gtemp = []
print,'Lum < 43.3, -3>C>-1, young: ',n_elements(gtemp)
gtemp = where((flumsOg3st lt 43.3) and (rswidsOg3st gt -3) and (rswidsOg3st lt -1))
if gtemp[0] eq -1 then gtemp = []
print,'Lum < 43.3, -3>C>-1, old: ',n_elements(gtemp)
gtemp = where((flumsYg3st lt 43.3) and (rswidsYg3st gt -1) and (rswidsYg3st lt 2))
if gtemp[0] eq -1 then gtemp = []
print,'Lum < 43.3, -1>C>+2, young: ',n_elements(gtemp)
gtemp = where((flumsOg3st lt 43.3) and (rswidsOg3st gt -1) and (rswidsOg3st lt 2))
if gtemp[0] eq -1 then gtemp = []
print,'Lum < 43.3, -1>C>+2, old: ',n_elements(gtemp)
