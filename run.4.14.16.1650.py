...
for i in range(0,len(cr['OII'])): plt.text(cr['OII'][i]-xrng/50.,cr['Hd'][i],cr['field'][i],color='b')
...
xlim=plt.xlim()
xrng=xlim[1]-xlim[0]
for i in range(0,len(cr['D4000'])): plt.text(cr['D4000'][i]+xrng/50.,cr['Hd'][i],cr['field'][i],color='b')
plt.xlabel('D(4000)')
plt.ylabel(r'EW(H$\delta$) (angstroms)')
...
xrng=xlim[1]-xlim[0]
plt.xlim(xlim[1],xlim[0])
for i in range(0,len(cr['OII'])): plt.text(cr['OII'][i]-xrng/50.,cr['Hdcorr'][i],cr['field'][i],color='b')
plt.axvline(-4,lw=2,color='k',ls='dashed')
plt.xlabel('EW(OII) (angstroms)')
plt.ylabel(r'EW(H$\delta$) (angstroms)')
...
xlim=plt.xlim()
xrng=xlim[1]-xlim[0]
for i in range(0,len(cr['D4000'])): plt.text(cr['D4000'][i]+xrng/50.,cr['Hdcorr'][i],cr['field'][i],color='b')
plt.xlabel('D(4000)')
plt.ylabel(r'EW(H$\delta$) (angstroms)')
