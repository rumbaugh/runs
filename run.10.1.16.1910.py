...
plt.scatter(RSO[gf],np.log10(crn['lum_full'][gAGN][gf]),color='blue',marker='s',label='SG0023+SC1604',s=64)
...
plt.savefig('/home/rumbaugh/Chandra/plots/RSoffset_vs_Lum.10.1.16.png')
