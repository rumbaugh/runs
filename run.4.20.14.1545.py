...
def runtemplate(base,rung):
    ...
    seasonbounds = np.sort(np.append(0,np.append(gsb,len(ltime)-1)))
    ...
    FILE = open('/mnt/data2/rumbaugh/TDC/tdc1/rung%i/emcee/%s.emcee_output_full_chain.%s.dat'%(rung,pair,date),'w')
