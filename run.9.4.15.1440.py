...
def reviewresults(pair,suffix,ldate='9.4.15',ddate='8.19.15',cbase='/home/rumbaugh/Fermi/TimeBombs/output/',showresults=False,ntrials=10000,testplot=False,errstd=np.sqrt(2)*7.5,T='ACFT',showfullsample=False):
    if pair <= 10: ldate='9.3.15'
