...
oplot,zprime[g],rsoffset[g],PSYM=2,THICK=1.8,SYMSIZE=0.2,color=250
g = where((0.856 ge z) and (z ge 0.82))
rsfit = 0.967-0.015*zB
rsoffset = iB-zB-rsfit
oplot,zB[g],rsoffset[g],PSYM=6,THICK=3,SYMSIZE=1,color=180
...
rsfit = 0.6042-0.00178*zprime
rsoffset = iprime-zprime-rsfit
oplot,zprime[g],rsoffset[g],PSYM=2,SYMSIZE=0.2,THICK=1.8,color=250
