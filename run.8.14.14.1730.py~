...
#find time delays
    ...
    if lens == '1938':
        ...
        maxtimestep = 105.
    ttmp,mtmp,BA_disp = calc_disp_delay(Aflux[g],Bflux[g],ltime[g],ltime[g],Aerr[g],Berr[g],maxtimestep,timestep,minmu,maxmu,mustep,'D_4_2',delta,output=2,outfile='/home/rumbaugh/EVLA/light_curves/Dispersions/Disp_grid_out.%s.delta_10.5_5.22.14.dat'%lens)
