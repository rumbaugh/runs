...
sigma = np.array([1127,893,892,917,677,717,812,776,945])
sigerr = np.array([75,139,124,118,141,133,77,141,191])
...
pylab.savefig('/home/rumbaugh/LxT.plot.bol.3.27.12.png')
pylab.close('all')
...
for i in range(0,len(Temps)): 
    if i == 0: 
        ...
        pylab.text(sigma[i]+10,lumbol[i]+0.05,names[i],color='black',weight='extra bold')
pylab.savefig('/home/rumbaugh/sigLx.plot.3.27.12.png')
pylab.close('all')
...
for i in range(0,len(Temps)): 
    if i == 0: 
        ...
        pylab.text(Temps[i]+0.05,sigma[i]+10,names[i],color='black',weight='extra bold')
pylab.savefig('/home/rumbaugh/sigT.plot.3.27.12.png')
pylab.close('all')
