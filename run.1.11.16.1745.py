...
crn=np.loadtxt('/home/rumbaugh/X-ray_lum_comb_cat.1.5.16.dat',dtype=indict)
...
for i in range(0,len(crn['RA'])):
    ...
    if len(gas)>0:
        gas=gas[0]
        print '%10s %2i - %02i:%02i:%05.2f %02i:%02i:%05.2f  z: %.3f\nSoft Band Lum. - New: %6.3f Old: %6.3f P.D.: %8.3f\nSoft Band Flux. - New: %7.3f Old: %7.3f P.D.: %8.3f\nSoft Band NCnts. - New: %6.2f Old: %6.2f P.D.: %8.3f\nHard Band Lum. - New: %6.3f Old: %6.3f P.D.: %8.3f\nHard Band Flux. - New: %7.3f Old: %7.3f P.D.: %8.3f\nHard Band NCnts. - New: %6.2f Old: %6.2f P.D.: %8.3f\nFull Band Lum. - New: %6.3f Old: %6.3f P.D.: %8.3f\nFull Band Flux. - New: %7.3f Old: %7.3f P.D.: %8.3f\nFull Band NCnts. - New: %6.2f Old: %6.2f P.D.: %8.3f\n'%(cro['field'][gas],cro['num'][gas],cro['RAH'][gas],cro['RAM'][gas],cro['RAS'][gas],cro['DecD'][gas],cro['DecM'][gas],cro['DecS'][gas],crn['redshift'][i],1E-42*crn['lum_soft'][i],cro['soft_lum'][gas],(1E-42*crn['lum_soft'][i]-cro['soft_lum'][gas])*100./cro['soft_lum'][gas],1E14*crn['lum_soft'][i],cro['soft_lum'][gas],(1E14*crn['lum_soft'][i]-cro['soft_lum'][gas])*100./cro['soft_lum'][gas],
