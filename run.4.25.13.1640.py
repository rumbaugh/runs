...
'red': {'arc': 48, 'flat': 45, 'flat_array': np.array([3,42,43,44,45]), 'images': np.array([48,49,50,51,52,53])}, \
...
for mask in ['M0417_B']: 
    lris_reduce_multislit(indir,outdir,files_dict[mask]['prefix'],files_dict[mask],colors='red',sides=['top','bottom'])
