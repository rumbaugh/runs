...
#files_dict = {'1131m3': {'blue': {'arc': 264, 'flat': 263, 'images': np.array([261,262,265,266,267])}, 'red': {'arc': 257, 'flat': 256, 'images': np.array([254,255,258,259,260])}}, '1131m4': {'blue': {'arc': 273, 'flat': 272, 'images': np.array([270,271,274,275,276])}, 'red': {'arc': 264, 'flat': 263, 'images': np.array([261,262,265,266,267])}}}
files_dict = {'1131m3': {'blue': {'arc': 264, 'flat': 260, 'images': np.array([261,262,265,266,267])}, 'red': {'arc': 257, 'flat': 256, 'images': np.array([254,255,258,259,260])}}, '1131m4': {'blue': {'arc': 273, 'flat': 272, 'images': np.array([270,271,274,275,276])}, 'red': {'arc': 264, 'flat': 263, 'images': np.array([261,262,265,266,267])}}}
