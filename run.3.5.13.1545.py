...
for i in range(0,3):
    ...
    py.savefig('/home/rumbaugh/B1938+666_files/B1608.emcee_output_2D.B%s_delay.3.5.13.ps'%lens2_names[i])
    py.close()
    ...
    py.savefig('/home/rumbaugh/B1938+666_files/B1608.emcee_output_hist_tau.B%s_delay.3.5.13.ps'%lens2_names[i])
    py.close()
    py.plot(sampler.flatchain[:,0])
    py.savefig('/home/rumbaugh/B1938+666_files/B1608.emcee_output_chain_plot_tau.B%s_delay.3.5.13.ps'%lens2_names[i])
    py.close()
