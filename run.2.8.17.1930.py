...
psfpdf=bpdf.PdfPages('/home/rumbaugh/var_database/plots/test_lightcurves.2.7.17.pdf')
...
crf=np.loadtxt('/home/rumbaugh/var_database/CLQ_candidate_flags.dat',dtype={'names':('DatabaseID','Flag'),'formats':('|S64','i8')},skiprows=1)
...
good_dbids=np.array(['SDSSPOSS-29351'])
