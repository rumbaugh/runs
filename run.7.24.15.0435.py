...
for tau,it in zip(np.array([5,10,15,20]),np.array([0,1,2,3])):
    ...
    for i,pair in zip(pairs-1,pairs):
        ...
        os.system('cp %s /home/rumbaugh/Fermi/TimeBombs/plots/galleryfiles/Run2_tau_%i_pair%i_corner_plt.png'%(cfile,tau,pair))
        os.system('cp %s /home/rumbaugh/Fermi/TimeBombs/plots/galleryfiles/Run2_tau_%i_pair%i_Atestlightcurve.png'%(dfile,tau,pair))
os.chdir('/home/rumbaugh/git/scriptutils/perl')
os.sys('perl gallery.pl -o /home/rumbaugh/Fermi/TimeBombs/plots/galleryfiles/TimeBombs_corner_plots.7.24.15.pdf /home/rumbaugh/Fermi/TimeBombs/plots/galleryfiles/Run2*pair*png -pdf -x 1')
